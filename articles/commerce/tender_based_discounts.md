...
description: Denne artikkelen gir en oversikt over funksjoner som gjør det mulig for forhandlerne å konfigurere rabatter for bestemte betalingsmidler.
author: bebeale
ms.date: 10/30/2019
ms.topic: article
ms.prod: ''
