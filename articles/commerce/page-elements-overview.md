...
description: Denne artikkelen beskriver de ulike elementene som brukes på sidene på et område for Microsoft Dynamics 365 Commerce.
author: phinneyridge
ms.date: 10/09/2020
ms.topic: article
ms.prod: ''
...
Denne artikkelen beskriver de ulike elementene som brukes på sidene på et område for Microsoft Dynamics 365 Commerce.
