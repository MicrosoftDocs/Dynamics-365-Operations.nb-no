...
ms.locfileid: "6743990"
---
# <a name="manage-product-categories-and-products"></a>Administrere produktkategorier og produkter

[!include [banner](./includes/banner.md)]

Dette emnet beskriver en utvidet måte å administrere produktkategorier og produkter i Dynamics 365 Commerce. Forbedringene lar forhandleransvarlige se en struktur av produktegenskaper som deles mellom hierarkiet for produkt og detaljer om frigitt produkt.
