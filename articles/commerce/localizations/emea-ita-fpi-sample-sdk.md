...
4. Start MSBuild Command Prompt for Visual Studio-verktøyet, og kjør deretter **msbuild** under Retail SDK-mappen for å opprette distribuerbare pakker.
