...
description: Dette emnet inneholder retningslinjer for distribusjon av eksemplet på integrering av bilagsskriver for Tsjekkia fra Microsoft Dynamics 365 Commerce Retail Software Development Kit (SDK).
...
Utvidelsen for maskinvarestasjon er **HardwareIdent.Extension.EFRSample**. Utvidelsen for maskinvarestasjon bruker HTTP-protokollen til å sende dokumenter som CRT-utvidelsen genererer til regnskapsregistreringstjenesten. Den håndterer også svarene som mottas fra regnskapsregistreringstjenesten.
