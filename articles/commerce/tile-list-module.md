...
description: Denne artikkelen dekker flislistemoduler og beskriver hvordan du legger dem til på områdesider i Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8905404"
---
# <a name="tile-list-module"></a>Flislistemodul

[!include [banner](includes/banner.md)]

Denne artikkelen dekker flislistemoduler og beskriver hvordan du legger dem til på områdesider i Microsoft Dynamics 365 Commerce.
...
1. I dialogboksen **Velg moduler** velger du **Flisliste**-modulen, og deretter velger du **OK**.
...
1. Velg ellipseknappen (**...**) i **Flisliste**-sporet, og velg deretter **Legg til modul**.
1. I dialogboksen **Velg moduler** velger du **Flislistemodul**-modulen, og deretter velger du **OK**.
