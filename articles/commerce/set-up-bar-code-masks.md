...
description: Denne artikkelen beskriver hvordan du definerer tegn for strekkodemaske, strekkodemasker og hvordan du kan tilordne strekkodemasker til strekkoder.
author: BrianShook
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8853718"
---
# <a name="set-up-bar-code-masks"></a>Definere strekkodemasker

[!include [banner](includes/banner.md)]

Denne artikkelen beskriver hvordan du definerer tegn for strekkodemaske, strekkodemasker og hvordan du kan tilordne strekkodemasker til strekkoder.
