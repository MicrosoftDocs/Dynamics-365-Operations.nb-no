...
Før du aktiverer, må du være oppmerksom på at produktanbefalinger bare støttes for Commerce-kunder som har migrert lagringen til å bruke Azure Data Lake Storage (ADLS). 

Følgende konfigurasjoner må aktiveres i Back Office før aktivering av anbefalinger:

1. Kontroller at ADLS er kjøpt og korrekt verifisert i miljøet. For mer informasjon, se [Kontroller at ADLS er kjøpt og korrekt verifisert i miljøet](enable-ADLS-environment.md).
