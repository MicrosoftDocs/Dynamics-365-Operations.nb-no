...
description: Denne artikkelen beskriver hvordan du bruker attributter til å beskrive et produkt og egenskapene ved hjelp av brukerdefinerte felt.
author: ashishmsft
ms.date: 04/28/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8876670"
---
# <a name="manage-attributes-and-attribute-groups"></a>Administere attributter og attributtgrupper

[!include [banner](includes/banner.md)]

*Attributter* gir en metode for å beskrive et produkt og dets egenskaper ved hjelp av brukerdefinerte felt (som **Minnestørrelse**, **Harddiskkapasitet**, **Is Energy star-kompatibel** og så videre). Attributter kan knyttes til forskjellige Commerce-enheter, for eksempel produktkategorier og kanaler, og du kan angi standardverdier for dem. Produkter arver attributtene og standardverdiene når de blir knyttet til produktkategoriene eller kanaler. Standardverdiene kan overstyres på nivået for det individuelle produktet, på kanalnivået, eller i en katalog.
...
1. Logge på Back Office-klienten som en varehandelsleder.
...
Med filterinnstillingene for attributter kan du definere hvordan filtrene for attributter skal vises på salgsstedet. For å få tilgang til filterinnstillingene for et attributt på **Attributter**-siden, merker du attributtet, og i handlingsruten velger du **Filterinnstillinger**.
...
- **Terskelverdi** – denne innstillingen kreves hvis du har valgt **Område** som kontrolltype for visningen. Du kan definere verdier med et semikolon (;) som skilletegn.
    ...
    For **posevolume**, for eksempel, kan terskelverdien være **10. 20, 50; 100; 200; 500; 1000. 5000**. Salgsstedet viser i så fall følgende områder. Alle områder som ikke har noen produkter i resultatsettet vises nedtonet.
...
Etter at attributtene er definert, kan de tilordnes attributtgrupper. En *attributtgruppe* brukes til å gruppere de individuelle attributtene for en komponent eller delkomponent i en produktkonfigurasjonsmodell. Et attributt kan inkluderes i én eller flere attributtgrupper. Attributtgrupper kan hjelpe brukere med å konfigurere produkter, fordi de forskjellige valgene er ordnet i en bestemt kontekst. Attributtgrupper kan tilordnes til kategorier eller kanaler.
...
1. Logge på Back Office-klienten som en varehandelsleder.
2. Gå til **Retail og Commerce** &gt; **Kategori- og produktstyring** &gt; **Hierarki for Commerce-produkt**.
...
>
> - Retail og Commerce &gt; Kategori- og produktstyring &gt; Navigasjonskategorier for kanal
> - Retail og Commerce &gt; Kategori- og produktstyring &gt; Ekstra produktkategorier

### <a name="assign-attribute-groups-to-stores"></a>Tilordne attributtgrupper til butikker

Én eller flere attributtgrupper kan knyttes til én eller flere butikker i hierarkiet for butikker. Når varene er supplert for spesifikke butikker, arver de attributtene som er inkludert i attributtgruppene.

1. Logge på Back Office-klienten som en varehandelsleder.
2. Gå til **Retail og Commerce** &gt; **Kanaloppsett** &gt; **Kanalkategorier og produktattributter**.
...
Standardverdiene for attributter kan overstyres for enkeltprodukter på produktnivå. Standardverdiene kan også overstyres for individuelle produkter i bestemte kataloger som er rettet mot bestemte kanaler.

### <a name="override-the-attribute-values-of-an-individual-product"></a>Overstyre attributtverdier for et enkelt produkt

1. Logge på Back Office-klienten som en varehandelsleder.
2. Gå til **Retail og Commerce** &gt; **Kategori- og produktstyring** &gt; **Utgitte produkter etter kategori**.
...
1. Logge på Back Office-klienten som en varehandelsleder.
2. Gå til **Retail og Commerce** &gt; **Katalogadministrasjon** &gt; **Alle kataloger**.
