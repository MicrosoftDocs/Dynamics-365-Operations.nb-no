...
description: Denne artikkelen beskriver hvordan du arbeider med sperringer på ordrer ved hjelp av Dynamics 365 Commerce.
author: josaw1
ms.date: 05/14/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8860143"
---
# <a name="configure-and-work-with-call-center-order-holds"></a>Konfigurere og arbeide med telefonsenterordresperringer

[!include [banner](includes/banner.md)]

Denne artikkelen beskriver ordresperrefunksjonene som Dynamics 365 Commerce har for telefonsenterordrer.
