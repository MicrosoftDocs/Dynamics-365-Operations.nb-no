...
description: Denne artikkelen beskriver de grunnleggende begrepene for sortimentstyring i Dynamics 365 Commerce, og gir informasjon om implementering av prosjekt.
author: josaw1
ms.date: 03/12/2018
ms.topic: article
ms.prod: ''
