---
title: Visuelle konfigurasjoner av brukergrensesnittet for salgssted
description: Denne artikkelen inneholder informasjon om skjermoppsett for Dynamics 365 Commerce POS-opplevelser.
author: boycezhu
ms.date: 09/22/2020
ms.topic: article
ms.prod: ''
...
Brukergrensesnittet for Microsoft Dynamics 365 Commerce salgssted (POS) kan konfigureres ved hjelp av en kombinasjon av visuelle profiler og skjermoppsett, tilordnet til butikker, kasser og/eller brukere. Denne artikkelen gir informasjon om disse konfigurasjonsalternativene.
