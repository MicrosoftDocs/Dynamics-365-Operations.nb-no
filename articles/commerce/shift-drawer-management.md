...
description: Denne artikkelen beskriver hvordan du definerer og bruker skift på salgssteder i Commerce.
author: josaw1
ms.date: 05/10/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9287464"
---
# <a name="shift-and-cash-drawer-management"></a>Behandling av skift og kassaskuff

[!include [banner](includes/banner.md)]

Denne artikkelen beskriver hvordan du definerer og bruker skift på salgssteder i Commerce.
