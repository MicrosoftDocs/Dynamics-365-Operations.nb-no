...
Dynamics 365 Commerce bruker Microsoft Azure Cognitive Service til å automatisk moderere vurderingstekst ved å fjerne upassende ord. Dessuten kan moderatorer bruke sensurverktøyet for vurderinger og omtale til følgende manuelle oppgaver:
...
Følg denne fremgangsmåten for å svare på en omtale.
...
Følg denne fremgangsmåten for å fjerne en omtale.

1. Gå til **Hjem \> Omtaler \> Sensur**.
1. Finn og velg gjennomgangen som må fjernes.
1. Velg en årsak til fjerningen i egenskapsruten til høyre, og velg **Fjern**.
...
Følg denne fremgangsmåten for å finne og slette kundedata.

1. Gå til **Hjem \> Omtaler \> Slett**.
1. I feltet **Søk etter brukere etter e-postadresse** angir du kundens e-postadresse, og deretter velger du **Søk**.
...
Følg denne fremgangsmåten for å vise trender for vurderinger og omtaler.
