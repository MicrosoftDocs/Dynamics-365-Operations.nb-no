---
title: Legge til en side for personvernpolicy
description: Denne artikkelen beskriver hvordan du legger til en side med personvernpolicy på området ditt i Microsoft Dynamics 365 Commerce.
author: v-chgri
ms.date: 08/31/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9272078"
---
# <a name="add-a-privacy-policy-page"></a>Legge til en side for personvernpolicy

[!include [banner](includes/banner.md)]

Denne artikkelen beskriver hvordan du legger til en side med personvernpolicy på området ditt i Microsoft Dynamics 365 Commerce.
