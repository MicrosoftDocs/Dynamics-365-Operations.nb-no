...
Du finner konfigurasjon for **Avgift basert på destinasjon for detaljhandel** i delen **Avgiftsmodul > Indirekte avgifter > Utgående merverdiavgift > Mva-grupper** .
