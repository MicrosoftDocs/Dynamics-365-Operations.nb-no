...
1. I **Profil**-feltet angir du en ID for profilen ("FN006" i eksempelbildet nedenfor).
1. I **Beskrivelse**-feltet skriver du inn en verdi ("Adventure Works-profil" i eksempelbildet nedenfor).
1. I **Generelt**-delen velger du et land for den nasjonale **ISO**-innstillingen.
1. I **Generelt**-delen endrer du andre innstillinger etter behov.
1. I **Generelt**-delen velger du en **Kvitteringsprofil-ID** for e-postkvitteringer.
1. I **Funksjoner**-delen endrer du innstillinger etter behov.
1. I **Beløp**-delen endrer du innstillinger etter behov.
...
[Opprette ny adressebok](new-address-book.md) 
