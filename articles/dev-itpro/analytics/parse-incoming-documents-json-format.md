...
Du må i tillegg fullføre oppgaveveiledningen [ER Opprette nødvendige konfigurasjoner for å importere data fra en ekstern fil for elektronisk rapportering](tasks/er-required-configurations-import-data.md) hvis du ikke allerede har fullført den. Last ned følgende file for å fullføre oppgaveveiledningen.
