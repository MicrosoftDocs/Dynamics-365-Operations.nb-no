...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing-for-electronic-reporting-er"></a>Bruke beregninger til å lage utdata for telling og summering for elektronisk rapportering (ER)
