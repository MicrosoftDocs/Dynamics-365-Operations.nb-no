--- 
title: "Konfigurere mål for utdata for elektronisk rapportering (ER)"
...
---
# <a name="configure-destinations-for-electronic-reporting-er-output"></a>Konfigurere mål for utdata for elektronisk rapportering (ER)
