...
Denne fremgangsmåten kan brukes av systemansvarlige til å importere et stort antall brukere fra Active Directory-Azure.


## <a name="run-as-a-batch-job"></a>Kjør som satsvis jobb
1. Gå til Systemadministrasjon > Brukere > Brukere.
2. Klikk Satsvis import.
3. Utvid Kjør i bakgrunnen.
4. Velg Ja i feltet Satsvis behandling.
5. Skriv inn en verdi i Oppgavebeskrivelse-feltet.
6. Angi eller velg en verdi i Parti-feltet.
    * Dette er et valgfritt trinn.  
7. Velg Ja i feltet Privat.
    * Dette er et valgfritt trinn.  
8. Velg Ja i feltet Kritisk jobb.
    * Dette er et valgfritt trinn.  
9. Velg et alternativ i Overvåkingskategori-feltet.
10. Klikk OK.

## <a name="run-in-a-sandbox-environment"></a>Kjøre i et sandkassemiljø
1. Klikk Satsvis import.
2. Klikk OK.
