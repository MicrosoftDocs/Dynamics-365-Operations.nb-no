...
description: Denne artikkelen gir informasjon om statistiske dimensjonsmedlemmer og maler for leverandør av statistisk måling.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
Statistiske målinger kan hentes fra mange typer datakilder. Dynamics 365 Finance er en flott kilde å trekke ut statistiske målinger fra. Du kan bruke en mal for leverandør av statistiske mål for enkelt å konfigurere de statistiske målinger som du vil hente ut.
