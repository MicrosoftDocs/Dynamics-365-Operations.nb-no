...
description: Denne artikkelen beskriver de viktigste begrepene som brukes i Kostnadsregnskap.
author: aprilolson
ms.date: 08/31/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8881940"
---
# <a name="cost-accounting-terminology"></a>Terminologi for kostnadsregnskap

[!include [banner](../includes/banner.md)]

Denne artikkelen beskriver de viktigste begrepene som brukes i Kostnadsregnskap.
...
-  Dynamics 365 Finance (forhåndskonfigurert)
...
|  **Datakilder** |  **Datakilder for importerte transaksjoner** | **Dynamics 365 Finance-datakobling**  | **Dynamics AX-datatilkobling**  |
|---|---|---|---|
