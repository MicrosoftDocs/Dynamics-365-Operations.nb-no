...
description: Denne artikkelen introduserer budsjettkontrollfunksjonen, og gir informasjon som hjelper deg med å konfigurere budsjettkontroll for å optimalisere administrasjon av organisasjonens finansressurser.
author: panolte
ms.date: 03/28/2022
ms.topic: overview
ms.prod: ''
...
Denne artikkelen introduserer budsjettkontrollfunksjonen, og gir informasjon som hjelper deg med å konfigurere budsjettkontroll for å optimalisere administrasjon av organisasjonens finansressurser.
