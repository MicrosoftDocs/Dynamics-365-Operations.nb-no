...
Dette mobile arbeidsområdet er ment å brukes med mobilappen Dynamics 365 Unified Ops.
...
- Ta et bilde av en kvittering og last den opp til Dynamics 365 Finance. Du kan deretter knytte bildet til en reiseregningsrapport senere.
...
Forutsetningene varierer avhengig av hvilken versjon som er distribuert i organisasjonen.

### <a name="prerequisites-if-you-use-dynamics-365-finance"></a>Forutsetninger hvis du bruker Dynamics 365 Finance 
Hvis Finance er innført i organisasjonen din, må systemadministrator publisere det mobile arbeidsområdet **Reiseregning**. Hvis du vil ha instruksjoner, kan du se [Publisere et mobilt arbeidsområde](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).

### <a name="prerequisites-if-you-use-version-1611-with-platform-update-3-or-later"></a>Forutsetninger hvis du bruker versjon 1611 med plattformoppdatering 3 eller nyere
Hvis versjon 1611 med plattformoppdatering 3 eller nyere er distribuert i organisasjonen, må systemansvarlig oppfylle følgende forutsetninger. 
...
Last ned og installer mobilappen Dynamics 365 Unified Ops:
