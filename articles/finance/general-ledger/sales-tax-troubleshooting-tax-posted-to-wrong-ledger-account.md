...
description: Denne artikkelen gir feilsøkingsinformasjon som kan hjelpe når skatt posteres til feil finanskonto i bilaget.
author: qire
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8846748"
---
# <a name="tax-is-posted-to-the-wrong-ledger-account-in-the-voucher"></a>Avgift posteres til feil finanskonto i bilaget

[!include [banner](../includes/banner.md)]

Under postering kan avgift posteres til feil finanskonto i bilaget. Hvis du vil feilsøke dette problemet, følger du trinnene i de følgende delene etter behov. Eksemplene i denne artikkelen bruker en salgsordre som forretningsdokument.
