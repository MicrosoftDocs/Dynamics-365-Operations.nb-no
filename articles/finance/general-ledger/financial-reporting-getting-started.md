...
ms.locfileid: "7486976"
---
# <a name="get-started-with-financial-reporting"></a>Kom i gang med finansrapportering 

[!include [banner](../includes/banner.md)]

Dette emnet beskriver hvor du kan få tilgang til Financial Reporting, og hvordan du bruker finansrapporteringsfunksjonene. Det inneholder også en beskrivelse av de økonomiske standardrapportene som tilbys.
