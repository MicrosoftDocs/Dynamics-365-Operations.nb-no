...
description: Denne artikkelen gir detaljert informasjon om importformatet som brukes når du konsoliderer økonomiske data fra flere juridiske enheter.
author: jinniew
ms.date: 10/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8871311"
---
# <a name="import-format-for-consolidation"></a>Importformat for konsolidering

[!include [banner](../includes/banner.md)]

Denne artikkelen gir detaljert informasjon om importformatet som brukes når du konsoliderer økonomiske data fra flere juridiske enheter. Importformatet må lagres som en tekstfil (.txt).
