...
description: Denne artikkelen forklarer hvordan du konfigurerer informasjon om TDS-gruppe (Tax Deducted at Source), permanent kontonummer (PAN) og TAN (Tax Account Number) for leverandører og kunder.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Denne artikkelen forklarer hvordan du konfigurerer informasjon om TDS-gruppe (Tax Deducted at Source), permanent kontonummer (PAN) og TAN (Tax Account Number) for leverandører og kunder.
