...
description: Denne artikkelen viser fremgangsmåten for beregning av TDS (Tax Deducted at Source) for journaler.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863040"
---
# <a name="calculate-tds-on-invoices-using-journals"></a>Beregne TDS for fakturaer ved hjelp av journaler

[!include [banner](../includes/banner.md)]

Denne artikkelen viser fremgangsmåten for beregning av TDS (Tax Deducted at Source) for journaler.
