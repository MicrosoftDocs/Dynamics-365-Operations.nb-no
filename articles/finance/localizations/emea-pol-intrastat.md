...
description: Dette emnet inneholder informasjon om Intrastat-rapportering i Polen.
author: andosip
ms.date: 11/09/2021
ms.topic: article
...
16. Velg **OK** og gå gjennom rapporten i XML-format som genereres. Tabellen nedenfor viser verdiene i eksempelrapporten.
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informasjon om dokumentet</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informasjon om selskapet</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informasjon om varen</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Kontaktinformasjon</strong></p>
    </td>
    </tr>
    <tr>
    <td>
