...
description: Denne artikkelen forklarer hvordan du konfigurerer komponenter for kildeskatt for TDS-avgiftstypen (Tax Deducted at Source). Det forklarer også hvordan du definerer terskelgrensen som skal brukes til å beregne TDS for hver TDS-komponent.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
