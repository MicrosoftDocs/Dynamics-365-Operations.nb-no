...
description: Dette emnet gir informasjon om hvordan du registrerer deg for og installerer tjenesten for elektronisk fakturering.
author: dkalyuzh
ms.date: 02/07/2022
ms.topic: article
ms.prod: ''
...
Dette emnet gir informasjon om hvordan du registrerer deg for og installerer tjenesten for elektronisk fakturering. Denne prosessen består av fire trinn. Trinn 1 til og med 3 er nødvendig, og trinn 4 er valgfritt.
