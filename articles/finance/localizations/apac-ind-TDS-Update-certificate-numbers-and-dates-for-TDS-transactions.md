...
description: Denne artikkelen forklarer hvordan du oppdaterer numrene og datoene for fradragsberettigede sertifikater som ble registrert for leverandør-, kunde- og finanskontoer for TDS (Tax Deducted at Source).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
