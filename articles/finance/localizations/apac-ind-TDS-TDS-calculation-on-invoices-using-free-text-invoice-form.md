...
description: Denne artikkelen forklarer hvordan du beregner TDS (Tax Deducted at Source) for fakturaer ved hjelp av siden Fritekstfaktura.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Denne artikkelen forklarer hvordan du beregner TDS (Tax Deducted at Source) for fakturaer ved hjelp av siden **Fritekstfaktura**.
