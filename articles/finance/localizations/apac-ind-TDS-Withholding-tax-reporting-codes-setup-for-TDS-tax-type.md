...
description: Kildeskattrapporteringskoder brukes til å generere From 26Q- og Form 27Q-oppgavene for avgift fratrukket i kilde (TDS). Denne artikkelen beskriver hvordan du konfigurerer rapporteringskodetrinn for kildeskatt, slik at du kan definere TDS-rapporteringskoder.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Kildeskattrapporteringskoder brukes til å generere From 26Q- og Form 27Q-oppgavene for avgift fratrukket i kilde (TDS). Denne artikkelen beskriver hvordan du konfigurerer rapporteringskodetrinn for kildeskatt, slik at du kan definere TDS-rapporteringskoder.
