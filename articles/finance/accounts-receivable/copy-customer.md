---
title: Kopier kunder ved hjelp av delte nummerserier
description: Denne artikkelen forklarer hvordan du bruker delte nummerserier til å kopiere en kunde til en annen juridisk enhet og samtidig beholde samme kunde-ID.
author: abruer
ms.date: 08/31/2018
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "8899992"
---
# <a name="copy-customers-by-using-shared-number-sequences"></a>Kopier kunder ved hjelp av delte nummerserier
