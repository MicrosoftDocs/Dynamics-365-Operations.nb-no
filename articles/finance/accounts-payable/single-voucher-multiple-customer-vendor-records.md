...
To vanlige scenarier som bruker ett bilag som inneholder flere kunder eller leverandører, inkluderer saldooverføringer fra én kunde/leverandør til en annen kunde/leverandør, og motregning for en kunde og leverandør som er den samme organisasjonen. Eksemplene nedenfor illustrerer den foretrukne metoden for å angi disse scenariene som et alternativ til å skrive dem inn i ett bilag. 
...
Deretter overfører brukeren den forfalte saldoen fra ACME til forsikringsselskapet i ett bilag i betalingsjournalen for kunder. Forsikringsselskapet defineres som forsikringskunde.
