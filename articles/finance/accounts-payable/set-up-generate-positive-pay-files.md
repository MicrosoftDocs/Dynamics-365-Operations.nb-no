...
ms.locfileid: "9070732"
---
# <a name="set-up-and-generate-positive-pay-files"></a>Definer og generer positive betalingsfiler

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Denne funksjonaliteten blir avskrevet i september 2022, og nye brukere må bruke elektronisk rapportering. Hvis du vil ha mer informasjon, kan du se [Definer positive betalingsfiler ved hjelp av elektronisk rapportering](set-up-positive-pay-er.md).
