...
description: Denne artikkelen beskriver hvordan du konfigurerer arbeidsområdet som er relatert til leverandørfakturaer, og som viser informasjonen som er tilgjengelig via Microsoft Power BI.
author: abruer
ms.date: 02/14/2022
ms.topic: article
ms.prod: ''
