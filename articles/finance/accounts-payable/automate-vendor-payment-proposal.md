...
description: Denne artikkelen beskriver hvordan organisasjoner som betaler leverandører i henhold til en regelmessig plan, kan automatisere prosessen med å generere betalingsforslag for leverandører.
author: kweekley
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
