...
Du kan opprette seks typer prosjekter i Finance. Hver prosjekttype er satt opp forskjellig for kostnader og inntektsføring. Prosjekttypen du velger er avhengig av formålet med prosjektet. Tabellen nedenfor beskriver den vanlige bruken av hver prosjekttype.
...
Finance reduserer ikke prognoseberegnede estimater automatisk. Det er derfor en god idé å opprettholde en original prognosemodell i fastprisprosjektet for å opprette et utgangspunkt for sammenligning når prosjektet er fullført. 
...
:::row:::
    :::column:::
        #### <a name="cash-flow-page"></a>Kontantstrøm-siden
        - Kontant innflyt 
        - Kontant utflyt
        - Netto kontantstrøm
    :::column-end:::
    :::column:::
        #### <a name="project-statements-page"></a>Prosjektoppgaver-siden
        - Omsetning
        - Total kostnad
        - Bruttofortjeneste
    :::column-end:::
