...
-   <span data-ttu-id="6c7e8-109">Leie</span><span class="sxs-lookup"><span data-stu-id="6c7e8-109">Rent</span></span>
...
<span data-ttu-id="6c7e8-131">[![Beregning av indirekte kostnader](./media/period-cost-calculation.png)](./media/period-cost-calculation.png)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-131">[![Overhead calculation](./media/period-cost-calculation.png)](./media/period-cost-calculation.png)</span></span>
...
### <a name="step-1-process-the-cost-behavior-calculation"></a><span data-ttu-id="6c7e8-148">Trinn 1: Behandle beregning av kostnadsatferd</span><span class="sxs-lookup"><span data-stu-id="6c7e8-148">Step 1: Process the cost behavior calculation</span></span>
...
<td><span data-ttu-id="6c7e8-167">2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-167">2017</span></span></td>
...
##### <a name="cost-entries"></a><span data-ttu-id="6c7e8-183">Kostnadsoppføringer</span><span class="sxs-lookup"><span data-stu-id="6c7e8-183">Cost entries</span></span>
...
<td><span data-ttu-id="6c7e8-208">1 000,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-208">1,000.00</span></span></td>
...
<td><span data-ttu-id="6c7e8-282">(0 ÷ 2) × 1 000,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-282">(0 ÷ 2) × 1,000.00</span></span></td>
...
<td><span data-ttu-id="6c7e8-324">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-324">Electricity</span></span></td>
...
<td><span data-ttu-id="6c7e8-352">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-352">Electricity</span></span></td>
...
<td><span data-ttu-id="6c7e8-388">1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-388">1</span></span></td>
...
##### <a name="journal"></a><span data-ttu-id="6c7e8-408">Journalen</span><span class="sxs-lookup"><span data-stu-id="6c7e8-408">Journal</span></span>
...
<td><span data-ttu-id="6c7e8-426">3,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-426">3.00</span></span></td>
</tr>
<tr>
...
<td><span data-ttu-id="6c7e8-449">30,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-449">30.00</span></span></td>
...
<td><span data-ttu-id="6c7e8-530">35</span><span class="sxs-lookup"><span data-stu-id="6c7e8-530">35</span></span></td>
<td><span data-ttu-id="6c7e8-531">(35 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-531">(35 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="6c7e8-532">175.00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-532">175.00</span></span></td>
<td><span data-ttu-id="6c7e8-533">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-533">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-534">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-534">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-535">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-535">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-536">55</span><span class="sxs-lookup"><span data-stu-id="6c7e8-536">55</span></span></td>
<td><span data-ttu-id="6c7e8-537">(55 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-537">(55 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="6c7e8-538">275.00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-538">275.00</span></span></td>
<td><span data-ttu-id="6c7e8-539">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-539">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-540">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-540">CC004</span></span></td>
<td><span data-ttu-id="6c7e8-541">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-541">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-542">10</span><span class="sxs-lookup"><span data-stu-id="6c7e8-542">10</span></span></td>
<td><span data-ttu-id="6c7e8-543">(10 ÷ 100) × 500,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-543">(10 ÷ 100) × 500.00</span></span></td>
<td><span data-ttu-id="6c7e8-544">50,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-544">50.00</span></span></td>
<td><span data-ttu-id="6c7e8-545">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-545">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-546">CC002</span><span class="sxs-lookup"><span data-stu-id="6c7e8-546">CC002</span></span></td>
<td><span data-ttu-id="6c7e8-547">Finans</span><span class="sxs-lookup"><span data-stu-id="6c7e8-547">Finance</span></span></td>
<td><span data-ttu-id="6c7e8-548">35</span><span class="sxs-lookup"><span data-stu-id="6c7e8-548">35</span></span></td>
<td><span data-ttu-id="6c7e8-549">(35 ÷ 100) × 1 245,71</span><span class="sxs-lookup"><span data-stu-id="6c7e8-549">(35 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="6c7e8-550">436.00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-550">436.00</span></span></td>
<td><span data-ttu-id="6c7e8-551">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-551">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-552">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-552">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-553">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-553">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-554">55</span><span class="sxs-lookup"><span data-stu-id="6c7e8-554">55</span></span></td>
<td><span data-ttu-id="6c7e8-555">(55 ÷ 100) × 1 245,71</span><span class="sxs-lookup"><span data-stu-id="6c7e8-555">(55 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="6c7e8-556">685.14</span><span class="sxs-lookup"><span data-stu-id="6c7e8-556">685.14</span></span></td>
<td><span data-ttu-id="6c7e8-557">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-557">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-558">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-558">CC004</span></span></td>
<td><span data-ttu-id="6c7e8-559">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-559">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-560">10</span><span class="sxs-lookup"><span data-stu-id="6c7e8-560">10</span></span></td>
<td><span data-ttu-id="6c7e8-561">(10 ÷ 100) × 1 245,71</span><span class="sxs-lookup"><span data-stu-id="6c7e8-561">(10 ÷ 100) × 1,245.71</span></span></td>
<td><span data-ttu-id="6c7e8-562">124.57</span><span class="sxs-lookup"><span data-stu-id="6c7e8-562">124.57</span></span></td>
<td><span data-ttu-id="6c7e8-563">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-563">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="6c7e8-564">Tabellen nedenfor viser resultatet når finanstjenestene brukes som tildelingsgrunnlag for totale kostnader (faste kostnader og variable kostnader).</span><span class="sxs-lookup"><span data-stu-id="6c7e8-564">The following table shows the result when the Finance services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="6c7e8-565">Kostnadsobjekt</span><span class="sxs-lookup"><span data-stu-id="6c7e8-565">Cost object</span></span></th>
<th><span data-ttu-id="6c7e8-566">Størrelse</span><span class="sxs-lookup"><span data-stu-id="6c7e8-566">Magnitude</span></span></th>
<th><span data-ttu-id="6c7e8-567">Tildelingsfaktor</span><span class="sxs-lookup"><span data-stu-id="6c7e8-567">Allocation factor</span></span></th>
<th><span data-ttu-id="6c7e8-568">Beløp</span><span class="sxs-lookup"><span data-stu-id="6c7e8-568">Amount</span></span></th>
<th><span data-ttu-id="6c7e8-569">Kostnadsatferd</span><span class="sxs-lookup"><span data-stu-id="6c7e8-569">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="6c7e8-570">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-570">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-571">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-571">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-572">65</span><span class="sxs-lookup"><span data-stu-id="6c7e8-572">65</span></span></td>
<td><span data-ttu-id="6c7e8-573">(65 ÷ 100) × (500,00 + 175,00)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-573">(65 ÷ 100) × (500.00 + 175.00)</span></span></td>
<td><span data-ttu-id="6c7e8-574">438.75</span><span class="sxs-lookup"><span data-stu-id="6c7e8-574">438.75</span></span></td>
<td><span data-ttu-id="6c7e8-575">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-575">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-576">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-576">CC004</span></span></td>
<td><span data-ttu-id="6c7e8-577">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-577">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-578">35</span><span class="sxs-lookup"><span data-stu-id="6c7e8-578">35</span></span></td>
<td><span data-ttu-id="6c7e8-579">(35 ÷ 100) × (500,00 + 175,00)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-579">(35 ÷ 100) × (500.00 + 175.00)</span></span></td>
<td><span data-ttu-id="6c7e8-580">236.25</span><span class="sxs-lookup"><span data-stu-id="6c7e8-580">236.25</span></span></td>
<td><span data-ttu-id="6c7e8-581">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-581">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-582">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-582">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-583">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-583">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-584">65</span><span class="sxs-lookup"><span data-stu-id="6c7e8-584">65</span></span></td>
<td><span data-ttu-id="6c7e8-585">(65 ÷ 100) × (7 714,29 + 436,00)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-585">(65 ÷ 100) × (7,714.29 + 436.00)</span></span></td>
<td><span data-ttu-id="6c7e8-586">5,297.69</span><span class="sxs-lookup"><span data-stu-id="6c7e8-586">5,297.69</span></span></td>
<td><span data-ttu-id="6c7e8-587">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-587">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-588">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-588">CC004</span></span></td>
<td><span data-ttu-id="6c7e8-589">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-589">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-590">35</span><span class="sxs-lookup"><span data-stu-id="6c7e8-590">35</span></span></td>
<td><span data-ttu-id="6c7e8-591">(35 ÷ 100) × (7 714,29 + 436,00)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-591">(35 ÷ 100) × (7,714.29 + 436.00)</span></span></td>
<td><span data-ttu-id="6c7e8-592">2,852.60</span><span class="sxs-lookup"><span data-stu-id="6c7e8-592">2,852.60</span></span></td>
<td><span data-ttu-id="6c7e8-593">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-593">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="6c7e8-594">Tabellen nedenfor viser resultatet når monteringstjenestene brukes som tildelingsgrunnlag for totale kostnader (faste kostnader og variable kostnader).</span><span class="sxs-lookup"><span data-stu-id="6c7e8-594">The following table shows the result when the Assembly services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="6c7e8-595">Kostnadsobjekt</span><span class="sxs-lookup"><span data-stu-id="6c7e8-595">Cost object</span></span></th>
<th><span data-ttu-id="6c7e8-596">Størrelse</span><span class="sxs-lookup"><span data-stu-id="6c7e8-596">Magnitude</span></span></th>
<th><span data-ttu-id="6c7e8-597">Tildelingsfaktor</span><span class="sxs-lookup"><span data-stu-id="6c7e8-597">Allocation factor</span></span></th>
<th><span data-ttu-id="6c7e8-598">Beløp</span><span class="sxs-lookup"><span data-stu-id="6c7e8-598">Amount</span></span></th>
<th><span data-ttu-id="6c7e8-599">Kostnadsatferd</span><span class="sxs-lookup"><span data-stu-id="6c7e8-599">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="6c7e8-600">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-600">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-601">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-601">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-602">60</span><span class="sxs-lookup"><span data-stu-id="6c7e8-602">60</span></span></td>
<td><span data-ttu-id="6c7e8-603">(60 ÷ 80) × (275,00 + 438,75)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-603">(60 ÷ 80) × (275.00 + 438.75)</span></span></td>
<td><span data-ttu-id="6c7e8-604">535.31</span><span class="sxs-lookup"><span data-stu-id="6c7e8-604">535.31</span></span></td>
<td><span data-ttu-id="6c7e8-605">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-605">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-606">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-606">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-607">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-607">Product 2</span></span></td>
<td><span data-ttu-id="6c7e8-608">20</span><span class="sxs-lookup"><span data-stu-id="6c7e8-608">20</span></span></td>
<td><span data-ttu-id="6c7e8-609">(20 ÷ 80) × (275,00 + 438,75)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-609">(20 ÷ 80) × (275.00 + 438.75)</span></span></td>
<td><span data-ttu-id="6c7e8-610">178.44</span><span class="sxs-lookup"><span data-stu-id="6c7e8-610">178.44</span></span></td>
<td><span data-ttu-id="6c7e8-611">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-611">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-612">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-612">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-613">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-613">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-614">60</span><span class="sxs-lookup"><span data-stu-id="6c7e8-614">60</span></span></td>
<td><span data-ttu-id="6c7e8-615">(60 ÷ 80) × (5 297,69 + 685,14)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-615">(60 ÷ 80) × (5,297.69 + 685.14)</span></span></td>
<td><span data-ttu-id="6c7e8-616">4,487.12</span><span class="sxs-lookup"><span data-stu-id="6c7e8-616">4,487.12</span></span></td>
<td><span data-ttu-id="6c7e8-617">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-617">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-618">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-618">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-619">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-619">Product 2</span></span></td>
<td><span data-ttu-id="6c7e8-620">20</span><span class="sxs-lookup"><span data-stu-id="6c7e8-620">20</span></span></td>
<td><span data-ttu-id="6c7e8-621">(20 ÷ 80) × (5 297,69 + 685,14)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-621">(20 ÷ 80) × (5,297.69 + 685.14)</span></span></td>
<td><span data-ttu-id="6c7e8-622">1,495.71</span><span class="sxs-lookup"><span data-stu-id="6c7e8-622">1,495.71</span></span></td>
<td><span data-ttu-id="6c7e8-623">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-623">Variable cost</span></span></td>
</tr>
</tbody>
</table>

<span data-ttu-id="6c7e8-624">Tabellen nedenfor viser resultatet når emballasjetjenestene brukes som tildelingsgrunnlag for totale kostnader (faste kostnader og variable kostnader).</span><span class="sxs-lookup"><span data-stu-id="6c7e8-624">The following table shows the result when the Packaging services are applied as an allocation base for total cost (fixed cost and variable cost).</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="6c7e8-625">Kostnadsobjekt</span><span class="sxs-lookup"><span data-stu-id="6c7e8-625">Cost object</span></span></th>
<th><span data-ttu-id="6c7e8-626">Størrelse</span><span class="sxs-lookup"><span data-stu-id="6c7e8-626">Magnitude</span></span></th>
<th><span data-ttu-id="6c7e8-627">Tildelingsfaktor</span><span class="sxs-lookup"><span data-stu-id="6c7e8-627">Allocation factor</span></span></th>
<th><span data-ttu-id="6c7e8-628">Beløp</span><span class="sxs-lookup"><span data-stu-id="6c7e8-628">Amount</span></span></th>
<th><span data-ttu-id="6c7e8-629">Kostnadsatferd</span><span class="sxs-lookup"><span data-stu-id="6c7e8-629">Cost behavior</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="6c7e8-630">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-630">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-631">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-631">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-632">80</span><span class="sxs-lookup"><span data-stu-id="6c7e8-632">80</span></span></td>
<td><span data-ttu-id="6c7e8-633">(80 ÷ 95) × (50,00 + 236,25)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-633">(80 ÷ 95) × (50.00 + 236.25)</span></span></td>
<td><span data-ttu-id="6c7e8-634">241.05</span><span class="sxs-lookup"><span data-stu-id="6c7e8-634">241.05</span></span></td>
<td><span data-ttu-id="6c7e8-635">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-635">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-636">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-636">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-637">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-637">Product 2</span></span></td>
<td><span data-ttu-id="6c7e8-638">15</span><span class="sxs-lookup"><span data-stu-id="6c7e8-638">15</span></span></td>
<td><span data-ttu-id="6c7e8-639">(15 ÷ 95) × (50,00 + 236,25)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-639">(15 ÷ 95) × (50.00 + 236.25)</span></span></td>
<td><span data-ttu-id="6c7e8-640">45.20</span><span class="sxs-lookup"><span data-stu-id="6c7e8-640">45.20</span></span></td>
<td><span data-ttu-id="6c7e8-641">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-641">Fixed cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-642">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-642">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-643">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-643">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-644">80</span><span class="sxs-lookup"><span data-stu-id="6c7e8-644">80</span></span></td>
<td><span data-ttu-id="6c7e8-645">(80 ÷ 95) × (2 852,60 + 124,57)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-645">(80 ÷ 95) × (2,852.60 + 124.57)</span></span></td>
<td><span data-ttu-id="6c7e8-646">2,507.09</span><span class="sxs-lookup"><span data-stu-id="6c7e8-646">2,507.09</span></span></td>
<td><span data-ttu-id="6c7e8-647">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-647">Variable cost</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-648">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-648">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-649">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-649">Product 2</span></span></td>
<td><span data-ttu-id="6c7e8-650">15</span><span class="sxs-lookup"><span data-stu-id="6c7e8-650">15</span></span></td>
<td><span data-ttu-id="6c7e8-651">(15 ÷ 95) × (2 852,60 + 124,57)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-651">(15 ÷ 95) × (2,852.60 + 124.57)</span></span></td>
<td><span data-ttu-id="6c7e8-652">470.08</span><span class="sxs-lookup"><span data-stu-id="6c7e8-652">470.08</span></span></td>
<td><span data-ttu-id="6c7e8-653">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-653">Variable cost</span></span></td>
</tr>
</tbody>
</table>

##### <a name="journal-entries-cost-object-balance-journal-entries"></a><span data-ttu-id="6c7e8-654">Journaloppføringer (journaloppføringer for saldo for kostnadsobjekt)</span><span class="sxs-lookup"><span data-stu-id="6c7e8-654">Journal entries (cost object balance journal entries)</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="6c7e8-655">Journalen</span><span class="sxs-lookup"><span data-stu-id="6c7e8-655">Journal</span></span></th>
<th><span data-ttu-id="6c7e8-656">Journaltype</span><span class="sxs-lookup"><span data-stu-id="6c7e8-656">Journal type</span></span></th>
<th colspan="3"><span data-ttu-id="6c7e8-657">Økonomisk kalenderperiode</span><span class="sxs-lookup"><span data-stu-id="6c7e8-657">Fiscal calendar period</span></span></th>
<th><span data-ttu-id="6c7e8-658">Versjon</span><span class="sxs-lookup"><span data-stu-id="6c7e8-658">Version</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="6c7e8-659">00004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-659">00004</span></span></td>
<td><span data-ttu-id="6c7e8-660">Kostfordelingsjournal</span><span class="sxs-lookup"><span data-stu-id="6c7e8-660">Cost allocation journal</span></span></td>
<td><span data-ttu-id="6c7e8-661">Skattemessig</span><span class="sxs-lookup"><span data-stu-id="6c7e8-661">Fiscal</span></span></td>
<td><span data-ttu-id="6c7e8-662">2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-662">2017</span></span></td>
<td><span data-ttu-id="6c7e8-663">Periode 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-663">Period 1</span></span></td>
<td><span data-ttu-id="6c7e8-664">Beregning av indirekte kostnader / 02.01.2017 23.51.00 / Finans /2017 / Periode 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-664">Overhead calculation / 01-02-2017 11:51:00 PM / Ledger /2017 / Period 1</span></span></td>
</tr>
</tbody>
</table>

##### <a name="journal-lines"></a><span data-ttu-id="6c7e8-665">Journallinjer</span><span class="sxs-lookup"><span data-stu-id="6c7e8-665">Journal lines</span></span>

<table>
<thead>
<tr>
<th><span data-ttu-id="6c7e8-666">Regnskapsdato</span><span class="sxs-lookup"><span data-stu-id="6c7e8-666">Accounting date</span></span></th>
<th colspan="2"><span data-ttu-id="6c7e8-667">Kostnadsobjekt</span><span class="sxs-lookup"><span data-stu-id="6c7e8-667">Cost object</span></span></th>
<th colspan="2"><span data-ttu-id="6c7e8-668">Kostnadselement</span><span class="sxs-lookup"><span data-stu-id="6c7e8-668">Cost element</span></span></th>
<th><span data-ttu-id="6c7e8-669">Kostnadsatferd</span><span class="sxs-lookup"><span data-stu-id="6c7e8-669">Cost behavior</span></span></th>
<th><span data-ttu-id="6c7e8-670">Beløp</span><span class="sxs-lookup"><span data-stu-id="6c7e8-670">Amount</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="6c7e8-671">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-671">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-672">CC001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-672">CC001</span></span></td>
<td><span data-ttu-id="6c7e8-673">Personale</span><span class="sxs-lookup"><span data-stu-id="6c7e8-673">HR</span></span></td>
<td><span data-ttu-id="6c7e8-674">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-674">10001</span></span></td>
<td><span data-ttu-id="6c7e8-675">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-675">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-676">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-676">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-677">500,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-677">500.00</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-678">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-678">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-679">CC001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-679">CC001</span></span></td>
<td><span data-ttu-id="6c7e8-680">Personale</span><span class="sxs-lookup"><span data-stu-id="6c7e8-680">HR</span></span></td>
<td><span data-ttu-id="6c7e8-681">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-681">10001</span></span></td>
<td><span data-ttu-id="6c7e8-682">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-682">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-683">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-683">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-684">1,245.71</span><span class="sxs-lookup"><span data-stu-id="6c7e8-684">1,245.71</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-685">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-685">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-686">CC002</span><span class="sxs-lookup"><span data-stu-id="6c7e8-686">CC002</span></span></td>
<td><span data-ttu-id="6c7e8-687">Finans</span><span class="sxs-lookup"><span data-stu-id="6c7e8-687">Finance</span></span></td>
<td><span data-ttu-id="6c7e8-688">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-688">10001</span></span></td>
<td><span data-ttu-id="6c7e8-689">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-689">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-690">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-690">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-691">675.00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-691">675.00</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-692">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-692">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-693">CC002</span><span class="sxs-lookup"><span data-stu-id="6c7e8-693">CC002</span></span></td>
<td><span data-ttu-id="6c7e8-694">Finans</span><span class="sxs-lookup"><span data-stu-id="6c7e8-694">Finance</span></span></td>
<td><span data-ttu-id="6c7e8-695">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-695">10001</span></span></td>
<td><span data-ttu-id="6c7e8-696">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-696">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-697">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-697">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-698">8,150.29</span><span class="sxs-lookup"><span data-stu-id="6c7e8-698">8,150.29</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-699">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-699">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-700">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-700">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-701">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-701">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-702">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-702">10001</span></span></td>
<td><span data-ttu-id="6c7e8-703">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-703">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-704">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-704">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-705">713.75</span><span class="sxs-lookup"><span data-stu-id="6c7e8-705">713.75</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-706">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-706">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-707">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-707">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-708">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-708">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-709">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-709">10001</span></span></td>
<td><span data-ttu-id="6c7e8-710">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-710">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-711">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-711">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-712">5,982.83</span><span class="sxs-lookup"><span data-stu-id="6c7e8-712">5,982.83</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-713">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-713">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-714">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-714">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-715">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-715">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-716">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-716">10001</span></span></td>
<td><span data-ttu-id="6c7e8-717">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-717">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-718">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-718">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-719">286.25</span><span class="sxs-lookup"><span data-stu-id="6c7e8-719">286.25</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-720">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-720">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-721">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-721">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-722">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-722">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-723">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-723">10001</span></span></td>
<td><span data-ttu-id="6c7e8-724">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-724">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-725">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-725">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-726">2,977.17</span><span class="sxs-lookup"><span data-stu-id="6c7e8-726">2,977.17</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-727">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-727">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-728">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-728">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-729">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-729">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-730">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-730">10001</span></span></td>
<td><span data-ttu-id="6c7e8-731">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-731">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-732">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-732">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-733">776.36</span><span class="sxs-lookup"><span data-stu-id="6c7e8-733">776.36</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-734">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-734">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-735">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-735">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-736">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-736">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-737">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-737">10001</span></span></td>
<td><span data-ttu-id="6c7e8-738">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-738">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-739">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-739">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-740">6,994.21</span><span class="sxs-lookup"><span data-stu-id="6c7e8-740">6,994.21</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-741">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-741">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-742">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-742">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-743">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-743">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-744">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-744">10001</span></span></td>
<td><span data-ttu-id="6c7e8-745">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-745">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-746">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-746">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-747">223.64</span><span class="sxs-lookup"><span data-stu-id="6c7e8-747">223.64</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-748">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-748">January 31, 2017</span></span></td>
<td><span data-ttu-id="6c7e8-749">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-749">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-750">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-750">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-751">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-751">10001</span></span></td>
<td><span data-ttu-id="6c7e8-752">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-752">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-753">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-753">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-754">1,965.79</span><span class="sxs-lookup"><span data-stu-id="6c7e8-754">1,965.79</span></span></td>
</tr>
</tbody>
</table>

##### <a name="cost-entries"></a><span data-ttu-id="6c7e8-755">Kostnadsoppføringer</span><span class="sxs-lookup"><span data-stu-id="6c7e8-755">Cost entries</span></span>

<table>
<thead>
<tr>
<th colspan="2"><span data-ttu-id="6c7e8-756">Kostnadsobjekt</span><span class="sxs-lookup"><span data-stu-id="6c7e8-756">Cost object</span></span></th>
<th colspan="2"><span data-ttu-id="6c7e8-757">Kostnadselement</span><span class="sxs-lookup"><span data-stu-id="6c7e8-757">Cost element</span></span></th>
<th><span data-ttu-id="6c7e8-758">Kostnadsatferd</span><span class="sxs-lookup"><span data-stu-id="6c7e8-758">Cost behavior</span></span></th>
<th><span data-ttu-id="6c7e8-759">Beløp</span><span class="sxs-lookup"><span data-stu-id="6c7e8-759">Amount</span></span></th>
<th><span data-ttu-id="6c7e8-760">Regnskapsdato</span><span class="sxs-lookup"><span data-stu-id="6c7e8-760">Accounting date</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td><span data-ttu-id="6c7e8-761">CC001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-761">CC001</span></span></td>
<td><span data-ttu-id="6c7e8-762">Personale</span><span class="sxs-lookup"><span data-stu-id="6c7e8-762">HR</span></span></td>
<td><span data-ttu-id="6c7e8-763">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-763">10001</span></span></td>
<td><span data-ttu-id="6c7e8-764">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-764">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-765">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-765">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-766">-500,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-766">-500.00</span></span></td>
<td><span data-ttu-id="6c7e8-767">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-767">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-768">CC002</span><span class="sxs-lookup"><span data-stu-id="6c7e8-768">CC002</span></span></td>
<td><span data-ttu-id="6c7e8-769">Finans</span><span class="sxs-lookup"><span data-stu-id="6c7e8-769">Finance</span></span></td>
<td><span data-ttu-id="6c7e8-770">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-770">10001</span></span></td>
<td><span data-ttu-id="6c7e8-771">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-771">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-772">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-772">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-773">175.00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-773">175.00</span></span></td>
<td><span data-ttu-id="6c7e8-774">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-774">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-775">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-775">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-776">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-776">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-777">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-777">10001</span></span></td>
<td><span data-ttu-id="6c7e8-778">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-778">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-779">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-779">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-780">275.00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-780">275.00</span></span></td>
<td><span data-ttu-id="6c7e8-781">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-781">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-782">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-782">CC004</span></span></td>
<td><span data-ttu-id="6c7e8-783">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-783">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-784">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-784">10001</span></span></td>
<td><span data-ttu-id="6c7e8-785">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-785">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-786">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-786">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-787">50,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-787">50,00</span></span></td>
<td><span data-ttu-id="6c7e8-788">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-788">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-789">CC001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-789">CC001</span></span></td>
<td><span data-ttu-id="6c7e8-790">Personale</span><span class="sxs-lookup"><span data-stu-id="6c7e8-790">HR</span></span></td>
<td><span data-ttu-id="6c7e8-791">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-791">10001</span></span></td>
<td><span data-ttu-id="6c7e8-792">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-792">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-793">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-793">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-794">-1 245,71</span><span class="sxs-lookup"><span data-stu-id="6c7e8-794">-1,245.71</span></span></td>
<td><span data-ttu-id="6c7e8-795">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-795">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-796">CC002</span><span class="sxs-lookup"><span data-stu-id="6c7e8-796">CC002</span></span></td>
<td><span data-ttu-id="6c7e8-797">Finans</span><span class="sxs-lookup"><span data-stu-id="6c7e8-797">Finance</span></span></td>
<td><span data-ttu-id="6c7e8-798">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-798">10001</span></span></td>
<td><span data-ttu-id="6c7e8-799">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-799">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-800">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-800">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-801">436.00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-801">436.00</span></span></td>
<td><span data-ttu-id="6c7e8-802">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-802">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-803">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-803">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-804">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-804">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-805">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-805">10001</span></span></td>
<td><span data-ttu-id="6c7e8-806">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-806">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-807">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-807">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-808">685.14</span><span class="sxs-lookup"><span data-stu-id="6c7e8-808">685.14</span></span></td>
<td><span data-ttu-id="6c7e8-809">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-809">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-810">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-810">CC004</span></span></td>
<td><span data-ttu-id="6c7e8-811">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-811">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-812">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-812">10001</span></span></td>
<td><span data-ttu-id="6c7e8-813">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-813">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-814">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-814">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-815">124.57</span><span class="sxs-lookup"><span data-stu-id="6c7e8-815">124.57</span></span></td>
<td><span data-ttu-id="6c7e8-816">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-816">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-817">CC002</span><span class="sxs-lookup"><span data-stu-id="6c7e8-817">CC002</span></span></td>
<td><span data-ttu-id="6c7e8-818">Finans</span><span class="sxs-lookup"><span data-stu-id="6c7e8-818">Finance</span></span></td>
<td><span data-ttu-id="6c7e8-819">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-819">10001</span></span></td>
<td><span data-ttu-id="6c7e8-820">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-820">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-821">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-821">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-822">-675,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-822">-675.00</span></span></td>
<td><span data-ttu-id="6c7e8-823">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-823">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-824">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-824">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-825">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-825">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-826">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-826">10001</span></span></td>
<td><span data-ttu-id="6c7e8-827">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-827">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-828">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-828">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-829">438.75</span><span class="sxs-lookup"><span data-stu-id="6c7e8-829">438.75</span></span></td>
<td><span data-ttu-id="6c7e8-830">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-830">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-831">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-831">CC004</span></span></td>
<td><span data-ttu-id="6c7e8-832">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-832">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-833">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-833">10001</span></span></td>
<td><span data-ttu-id="6c7e8-834">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-834">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-835">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-835">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-836">236.25</span><span class="sxs-lookup"><span data-stu-id="6c7e8-836">236.25</span></span></td>
<td><span data-ttu-id="6c7e8-837">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-837">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-838">CC002</span><span class="sxs-lookup"><span data-stu-id="6c7e8-838">CC002</span></span></td>
<td><span data-ttu-id="6c7e8-839">Finans</span><span class="sxs-lookup"><span data-stu-id="6c7e8-839">Finance</span></span></td>
<td><span data-ttu-id="6c7e8-840">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-840">10001</span></span></td>
<td><span data-ttu-id="6c7e8-841">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-841">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-842">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-842">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-843">-8 150,29</span><span class="sxs-lookup"><span data-stu-id="6c7e8-843">-8,150.29</span></span></td>
<td><span data-ttu-id="6c7e8-844">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-844">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-845">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-845">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-846">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-846">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-847">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-847">10001</span></span></td>
<td><span data-ttu-id="6c7e8-848">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-848">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-849">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-849">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-850">5,297.69</span><span class="sxs-lookup"><span data-stu-id="6c7e8-850">5,297.69</span></span></td>
<td><span data-ttu-id="6c7e8-851">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-851">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-852">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-852">CC004</span></span></td>
<td><span data-ttu-id="6c7e8-853">Innpakning</span><span class="sxs-lookup"><span data-stu-id="6c7e8-853">Packaging</span></span></td>
<td><span data-ttu-id="6c7e8-854">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-854">10001</span></span></td>
<td><span data-ttu-id="6c7e8-855">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-855">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-856">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-856">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-857">2,852.60</span><span class="sxs-lookup"><span data-stu-id="6c7e8-857">2,852.60</span></span></td>
<td><span data-ttu-id="6c7e8-858">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-858">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-859">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-859">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-860">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-860">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-861">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-861">10001</span></span></td>
<td><span data-ttu-id="6c7e8-862">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-862">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-863">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-863">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-864">-713,75</span><span class="sxs-lookup"><span data-stu-id="6c7e8-864">-713.75</span></span></td>
<td><span data-ttu-id="6c7e8-865">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-865">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-866">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-866">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-867">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-867">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-868">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-868">10001</span></span></td>
<td><span data-ttu-id="6c7e8-869">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-869">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-870">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-870">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-871">535.31</span><span class="sxs-lookup"><span data-stu-id="6c7e8-871">535.31</span></span></td>
<td><span data-ttu-id="6c7e8-872">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-872">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-873">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-873">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-874">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-874">Product 2</span></span></td>
<td><span data-ttu-id="6c7e8-875">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-875">10001</span></span></td>
<td><span data-ttu-id="6c7e8-876">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-876">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-877">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-877">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-878">178.44</span><span class="sxs-lookup"><span data-stu-id="6c7e8-878">178.44</span></span></td>
<td><span data-ttu-id="6c7e8-879">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-879">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-880">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-880">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-881">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-881">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-882">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-882">10001</span></span></td>
<td><span data-ttu-id="6c7e8-883">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-883">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-884">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-884">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-885">-5 982,83</span><span class="sxs-lookup"><span data-stu-id="6c7e8-885">-5,982.83</span></span></td>
<td><span data-ttu-id="6c7e8-886">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-886">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-887">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-887">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-888">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-888">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-889">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-889">10001</span></span></td>
<td><span data-ttu-id="6c7e8-890">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-890">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-891">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-891">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-892">4,487.12</span><span class="sxs-lookup"><span data-stu-id="6c7e8-892">4,487.12</span></span></td>
<td><span data-ttu-id="6c7e8-893">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-893">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-894">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-894">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-895">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-895">Product 2</span></span></td>
<td><span data-ttu-id="6c7e8-896">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-896">10001</span></span></td>
<td><span data-ttu-id="6c7e8-897">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-897">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-898">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-898">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-899">1,495.71</span><span class="sxs-lookup"><span data-stu-id="6c7e8-899">1,495.71</span></span></td>
<td><span data-ttu-id="6c7e8-900">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-900">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-901">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-901">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-902">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-902">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-903">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-903">10001</span></span></td>
<td><span data-ttu-id="6c7e8-904">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-904">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-905">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-905">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-906">-286,25</span><span class="sxs-lookup"><span data-stu-id="6c7e8-906">-286.25</span></span></td>
<td><span data-ttu-id="6c7e8-907">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-907">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-908">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-908">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-909">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-909">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-910">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-910">10001</span></span></td>
<td><span data-ttu-id="6c7e8-911">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-911">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-912">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-912">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-913">241.05</span><span class="sxs-lookup"><span data-stu-id="6c7e8-913">241.05</span></span></td>
<td><span data-ttu-id="6c7e8-914">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-914">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-915">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-915">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-916">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-916">Product 2</span></span></td>
<td><span data-ttu-id="6c7e8-917">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-917">10001</span></span></td>
<td><span data-ttu-id="6c7e8-918">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-918">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-919">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-919">Fixed cost</span></span></td>
<td><span data-ttu-id="6c7e8-920">45.20</span><span class="sxs-lookup"><span data-stu-id="6c7e8-920">45.20</span></span></td>
<td><span data-ttu-id="6c7e8-921">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-921">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-922">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-922">CC003</span></span></td>
<td><span data-ttu-id="6c7e8-923">Samling</span><span class="sxs-lookup"><span data-stu-id="6c7e8-923">Assembly</span></span></td>
<td><span data-ttu-id="6c7e8-924">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-924">10001</span></span></td>
<td><span data-ttu-id="6c7e8-925">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-925">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-926">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-926">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-927">-2 977,17</span><span class="sxs-lookup"><span data-stu-id="6c7e8-927">-2,977.17</span></span></td>
<td><span data-ttu-id="6c7e8-928">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-928">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-929">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-929">Prod 1</span></span></td>
<td><span data-ttu-id="6c7e8-930">Produkt 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-930">Product 1</span></span></td>
<td><span data-ttu-id="6c7e8-931">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-931">10001</span></span></td>
<td><span data-ttu-id="6c7e8-932">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-932">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-933">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-933">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-934">2,507.09</span><span class="sxs-lookup"><span data-stu-id="6c7e8-934">2,507.09</span></span></td>
<td><span data-ttu-id="6c7e8-935">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-935">January 31, 2017</span></span></td>
</tr>
<tr>
<td><span data-ttu-id="6c7e8-936">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-936">Prod 2</span></span></td>
<td><span data-ttu-id="6c7e8-937">Produkt 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-937">Product 2</span></span></td>
<td><span data-ttu-id="6c7e8-938">10001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-938">10001</span></span></td>
<td><span data-ttu-id="6c7e8-939">Elektrisitet</span><span class="sxs-lookup"><span data-stu-id="6c7e8-939">Electricity</span></span></td>
<td><span data-ttu-id="6c7e8-940">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-940">Variable cost</span></span></td>
<td><span data-ttu-id="6c7e8-941">470.08</span><span class="sxs-lookup"><span data-stu-id="6c7e8-941">470.08</span></span></td>
<td><span data-ttu-id="6c7e8-942">31. januar 2017</span><span class="sxs-lookup"><span data-stu-id="6c7e8-942">January 31, 2017</span></span></td>
</tr>
</tbody>
</table>

## <a name="conclusion"></a><span data-ttu-id="6c7e8-943">Konklusjon</span><span class="sxs-lookup"><span data-stu-id="6c7e8-943">Conclusion</span></span>
<span data-ttu-id="6c7e8-944">I finansbokføring blir en kostnad på 10 000,00 for strøm postert til en midlertidig kostnadssenter-ID.</span><span class="sxs-lookup"><span data-stu-id="6c7e8-944">In Financial accounting, a cost of 10,000.00 for Electricity is posted to a dummy cost center ID.</span></span> <span data-ttu-id="6c7e8-945">Derfor vet regnskapsførere at denne kostnaden må tildeles.</span><span class="sxs-lookup"><span data-stu-id="6c7e8-945">Therefore, cost accountants will know that this cost must be allocated.</span></span> <span data-ttu-id="6c7e8-946">I kostnadsregnskap flyter kostnadene på tvers av organisasjonsenheter og -nivåer, basert på policyene og reglene som brukes.</span><span class="sxs-lookup"><span data-stu-id="6c7e8-946">In Cost accounting, the costs flow across organizational units and levels, based on the policies and rules that are applied.</span></span> <span data-ttu-id="6c7e8-947">Hver kostnad er tilknyttet et tildelingsgrunnlag som gir best mulig vurdering for kostnadsfordelingen.</span><span class="sxs-lookup"><span data-stu-id="6c7e8-947">Each cost has been associated with an allocation base that provides the best assessment for the allocation of costs.</span></span>

<table>
<thead>
<tr>
<th colspan="2" rowspan="2"><span data-ttu-id="6c7e8-948">Kostnadselement</span><span class="sxs-lookup"><span data-stu-id="6c7e8-948">Cost element</span></span></th>
<th colspan="9"><span data-ttu-id="6c7e8-949">Kostnadsobjekt</span><span class="sxs-lookup"><span data-stu-id="6c7e8-949">Cost object</span></span></th>
<th rowspan="2"><span data-ttu-id="6c7e8-950">Sum</span><span class="sxs-lookup"><span data-stu-id="6c7e8-950">Total</span></span></th>
</tr>
<tr>
<th><span data-ttu-id="6c7e8-951">CC099</span><span class="sxs-lookup"><span data-stu-id="6c7e8-951">CC099</span></span></th>
<th><span data-ttu-id="6c7e8-952">CC001</span><span class="sxs-lookup"><span data-stu-id="6c7e8-952">CC001</span></span></th>
<th><span data-ttu-id="6c7e8-953">CC002</span><span class="sxs-lookup"><span data-stu-id="6c7e8-953">CC002</span></span></th>
<th><span data-ttu-id="6c7e8-954">CC003</span><span class="sxs-lookup"><span data-stu-id="6c7e8-954">CC003</span></span></th>
<th><span data-ttu-id="6c7e8-955">CC004</span><span class="sxs-lookup"><span data-stu-id="6c7e8-955">CC004</span></span></th>
<th><span data-ttu-id="6c7e8-956">Prosj 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-956">Proj 1</span></span></th>
<th><span data-ttu-id="6c7e8-957">Prosj 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-957">Proj 2</span></span></th>
<th><span data-ttu-id="6c7e8-958">Prod 1</span><span class="sxs-lookup"><span data-stu-id="6c7e8-958">Prod 1</span></span></th>
<th><span data-ttu-id="6c7e8-959">Prod 2</span><span class="sxs-lookup"><span data-stu-id="6c7e8-959">Prod 2</span></span></th>
</tr>
</thead>
<tbody>
<tr>
<td colspan="2"><span data-ttu-id="6c7e8-960">10001 Strøm</span><span class="sxs-lookup"><span data-stu-id="6c7e8-960">10001 Electricity</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-961"><strong>0,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-961"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-962"><strong>0,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-962"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-963"><strong>0,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-963"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-964"><strong>0,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-964"><strong>0.00</strong></span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-965"><strong>30,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-965"><strong>30.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-966"><strong>10,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-966"><strong>10.00</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-967"><strong>7.770,57</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-967"><strong>7,770.57</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-968"><strong>2.189,43</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-968"><strong>2,189.43</strong></span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-969"><strong>10.000,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-969"><strong>10,000.00</strong></span></span></td>
</tr>
<tr>
<td></td>
<td style="text-align: left;"><span data-ttu-id="6c7e8-970">Uklassifisert</span><span class="sxs-lookup"><span data-stu-id="6c7e8-970">Unclassified</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-971">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-971">0.00</span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
...
<tr>
<td style="text-align: right;"></td>
<td style="text-align: left;"><span data-ttu-id="6c7e8-972">Fast kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-972">Fixed cost</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-973">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-973">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-974">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-974">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-975">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-975">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-976">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-976">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-977">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-977">0.00</span></span></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-978">776.36</span><span class="sxs-lookup"><span data-stu-id="6c7e8-978">776.36</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-979">223.64</span><span class="sxs-lookup"><span data-stu-id="6c7e8-979">223.64</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-980"><strong>1.000,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-980"><strong>1,000.00</strong></span></span></td>
</tr>
<tr>
<td style="text-align: right;"></td>
<td style="text-align: left;"><span data-ttu-id="6c7e8-981">Variabel kostnad</span><span class="sxs-lookup"><span data-stu-id="6c7e8-981">Variable cost</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-982">000</span><span class="sxs-lookup"><span data-stu-id="6c7e8-982">000</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-983">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-983">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-984">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-984">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-985">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-985">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-986">0,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-986">0.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-987">30,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-987">30.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-988">10,00</span><span class="sxs-lookup"><span data-stu-id="6c7e8-988">10.00</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-989">6,994.21</span><span class="sxs-lookup"><span data-stu-id="6c7e8-989">6,994.21</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-990">1,965.79</span><span class="sxs-lookup"><span data-stu-id="6c7e8-990">1,965.79</span></span></td>
<td style="text-align: right;"><span data-ttu-id="6c7e8-991"><strong>9.000,00</strong></span><span class="sxs-lookup"><span data-stu-id="6c7e8-991"><strong>9,000.00</strong></span></span></td>
</tr>
</tbody>
</table>

> [!NOTE]
> <span data-ttu-id="6c7e8-992">Dette emnet beskriver hvordan et primærkostnadselementet, 10001 Strøm, flyter gjennom kostnadsobjektene.</span><span class="sxs-lookup"><span data-stu-id="6c7e8-992">This topic shows how a primary cost element, 10001 Electricity, flows through the cost objects.</span></span> <span data-ttu-id="6c7e8-993">Denne indirekte kostnaden tildeles derfor til det laveste nivået i organisasjonen.</span><span class="sxs-lookup"><span data-stu-id="6c7e8-993">Therefore, this overhead cost is allocated to the lowest level in the organization.</span></span> <span data-ttu-id="6c7e8-994">Med andre ord vil kostnadsobjektene på laveste nivå bære kostnaden.</span><span class="sxs-lookup"><span data-stu-id="6c7e8-994">In other words, the cost objects at the lowest level bear the cost.</span></span> <span data-ttu-id="6c7e8-995">Hvis du trenger en visuell flyt for kostnaden mellom kostnadsobjektene, kan du bruke policyreglene for kostnadsakkumulering til å visualisere kostnadsflyten.</span><span class="sxs-lookup"><span data-stu-id="6c7e8-995">If you require a visual flow of the cost between the cost objects, you can use the cost roll-up policy rules to visualize the flow of the cost.</span></span> <span data-ttu-id="6c7e8-996">Hvis du vil ha mer informasjon, kan du se [Kostnadsopprulling](cost-rollup.md).</span><span class="sxs-lookup"><span data-stu-id="6c7e8-996">For more information, see [Cost roll-up](cost-rollup.md).</span></span>
