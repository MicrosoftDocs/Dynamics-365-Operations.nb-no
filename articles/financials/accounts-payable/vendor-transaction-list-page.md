...
# <a name="vendor-transaction-list-page"></a>Listeside for leverandørtransaksjoner
...
2. Velg en leverandør som har transaksjoner, og velg deretter **Leverandør \> Transaksjoner**.
3. Velg en transaksjonen du vil undersøke.
4. Velg kategorien **Vis utligninger** i handlingsruten.

    Dialogboksen **Vis utligninger** åpnes og viser den valgte transaksjonen og alle dokumenter som er utlignet mot den. Denne dialogboksen ligner på utligningsloggvisningen, men den inneholder alle relaterte dokumenter.
