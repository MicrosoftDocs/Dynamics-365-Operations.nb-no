...
2. Klikk på **Ny** for å angi en ny timeregistrering.
...
7. Klikk på rullegardinknappen i **Prosjekt**-feltet for å åpne oppslaget.
8. Finn og velg ønsket post i listen.
9. Klikk på koblingen i den valgte raden i listen.
10. Klikk på rullegardinknappen i feltet **Aktivitetsnummer** for å åpne oppslaget.
11. Finn og velg ønsket post i listen.
12. Klikk på koblingen i den valgte raden i listen.
13. Klikk på rullegardinknappen i **Kategori**-feltet for å åpne oppslaget.
