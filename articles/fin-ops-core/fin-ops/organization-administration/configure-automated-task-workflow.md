...
description: Denne artikkelen forklarer hvordan du konfigurerer egenskapene for en automatisert oppgave.
author: ChrisGarty
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Denne artikkelen forklarer hvordan du konfigurerer egenskapene for en automatisert oppgave.
