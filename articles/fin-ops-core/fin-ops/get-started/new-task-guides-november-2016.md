...
description: Denne artikkelen viser nye eller oppdaterte oppgaveveiledninger som ble utgitt til Microsoft (november 2016 – alle språk) APQC Unified Library for Microsoft Dynamics 365 for Operations. Det ble ikke utgitt nytt bibliotek for Komme i gang.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8886592"
---
# <a name="new-or-updated-task-guides-november-2016"></a>Nye eller oppdaterte oppgaveveiledninger (november 2016)

[!include [banner](../includes/banner.md)]

Denne artikkelen viser nye eller oppdaterte oppgaveveiledninger som ble utgitt til Microsoft (november 2016 – alle språk) APQC Unified Library for Microsoft Dynamics 365 for Operations. Det ble ikke utgitt nytt bibliotek for Komme i gang.
...
| \*Definere grunnleggende avgiftsintegreringsprofil for Kina                                                                                 | Kina                             |
...
| \*Opprette en ny etterfyllingsordre for forsendelse                                 | Globalt         |
...
| Vis utgående planlagt konsernintern etterspørsel | Globalt         |

### <a name="performance-management"></a>Ytelsesstyring

| BPM-linje                                                     | Land/område |
|--------------------------------------------------------------|----------------|
| \*Legge til i ytelsesjournal og sende ros til noen | Globalt         |
...
| \*Opprette en produktnummerterminologi for forhåndsdefinerte produktvarianter | Globalt         |
| \*Opprette en produktnummerterminologi for konfigurerte produktvarianter | Globalt         |
...
| \*Konfigurere maskinlæringsbaserte produktanbefalinger   | Globalt         |
...
| \*Opprette et nytt menyelement for en mobilenhet for nummerskiltkonsolidering          | Globalt         |
...
| \*Definere ny tildeling av vare for plukking med mangler                                    | Globalt         |
