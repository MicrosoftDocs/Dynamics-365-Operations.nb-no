...
description: Denne artikkelen viser hvilke funksjoner som støttes i skyen og lokalt.
author: sericks007
ms.date: 01/14/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9644148"
---
# <a name="comparison-of-cloud-and-on-premises-features"></a>Sammenligning av skyfunksjoner og lokale funksjoner

[!include [banner](../includes/banner.md)]

Denne artikkelen viser en sammenligning av funksjoner som er tilgjengelige i skyen, sammenlignet med følgende programmer:
