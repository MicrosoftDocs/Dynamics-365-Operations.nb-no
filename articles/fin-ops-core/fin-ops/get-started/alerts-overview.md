...
description: Denne artikkelen gir generell informasjon om varsler. Du kan bruke varsler til å holde deg informert om hendelser som du vil spore i løpet av arbeidsdagen.
author: RichdiMSFT
ms.date: 09/04/2019
ms.topic: overview
ms.prod: ''
...
Videoen [Slik bruker du varsler til å overvåke filtrerte data](https://youtu.be/ZYKMcv6kl9s) (vises oven) er inkludert i [spillelisten for økonomi og drift](https://www.youtube.com/playlist?list=PLcakwueIHoT_SYfIaPGoOhloFoCXiUSyW) som er tilgjengelig på YouTube.

### <a name="alert-rule-options"></a>Alternativer for varslingsregel

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE3E4PV]

Videoen [Alternativer for varslingsregler](https://youtu.be/cpzimwOjicM) (vises over) er inkludert i [spillelisten for økonomi og drift](https://www.youtube.com/playlist?list=PLcakwueIHoT_SYfIaPGoOhloFoCXiUSyW) som er tilgjengelig på YouTube.
