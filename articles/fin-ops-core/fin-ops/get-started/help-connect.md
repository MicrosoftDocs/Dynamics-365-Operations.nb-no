...
Dette emnet beskriver komponentene i hjelpesystemet for Finance and Operations-apper, for eksempel Dynamics 365 Finance, Supply Chain Management, Commerce og Human Resources. Det gir en oversikt over hvordan du kobler disse komponentene og et sammendrag av hvordan du oppretter egendefinert hjelp.
...
> [!NOTE]
> Kategorien **Oppgaveveiledninger** er ikke tilgjengelig for øyeblikket i Dynamics 365 Human Resources eller Handel. Vi arbeider for å aktivere denne funksjonaliteten i fremtidige utgaver. Oppgaveveiledningene i Kom i gang-delen i Human Resources vil fortsatt være tilgjengelig for å dekke grunnleggende funksjonalitet. Prosedyrehjelp er også tilgjengelig på nettstedet docs.microsoft.com for Human Resources og Commerce.
...
Etter at du har fullført disse trinnene, kan du åpne **Hjelp**-ruten og klikke på **Oppgaveveiledninger**-fanen. Du ser nå oppgaveveiledningene som gjelder for siden du er på i Finance and Operations-apper. Hvis det ikke finneds noen oppgaveveiledninger, kan du angi nøkkelord for å presisere søket.
...
Du kan opprette egendefinert hjelp for Supply Chain Management og for Handel ved å opprette oppgaveregistreringer som gjenspeiler implementeringen, og lagre dem i et bibliotek for LCS-forretningsprosess. Du kan ikke opprette tilpassede oppgaveveiledninger for Human Resources.
...
- [Opprette tilpasset hjelp for Finance and Operations-apper (hvitbok)](https://go.microsoft.com/fwlink/?linkid=2041185)
