...
description: Denne artikkelen viser kravene til størrelsesangivelse for maskinvare for et lokalt miljø.
author: sericks007
ms.date: 06/02/2021
ms.topic: article
...
- **Rapportering og analyse** – Disse faktorene omfatter vanligvis kjøring av tunge spørringer mot de forskjellige databasene i databasesystemene i systemet. Forstå og redusere hyppigheten når kostbar rapporter kjøres, hjelper deg med å forstå virkningen av dem..
...
## <a name="sizing-your-environment"></a>Endre størrelse på miljøet
...
> [!NOTE]
> Generelt skaleres beregningslagene ut, og må defineres på en N+1-måte, noe som betyr at hvis du beregner tre AOS, må du legge til et fjerde AOS. Databaselaget må være definert i et alltid lett tilgjengelig oppsett.
