...
- [Fjernede eller utgåtte funksjoner i Lifecycle Services (LCS)](../../dev-itpro/lifecycle-services/removed-deprecated-features.md)
- [Fjernede eller avskrevne funksjoner i tidligere versjoner](../../dev-itpro/migration-upgrade/deprecated-features.md)

## <a name="deprecations-in-the-microsoft-power-platform"></a>Avskrivninger i Microsoft Power Platform
Følgende emner gir informasjon om avskrivninger i Microsoft Power Platform:

- [Viktige endringer (avskrivninger) som kommer Power Apps, Power Automate og Customer Engagement-apper](/power-platform/important-changes-coming)