...
Dette emnet forklarer hvordan du løser ytelsesproblemer i ER-[konfigurasjoner](general-electronic-reporting.md#Configuration) ([elektronisk rapportering](general-electronic-reporting.md)).
