...
| Vis rapport                       | Åpne den nyeste versjonen av den genererte rapporten. Denne kommandoen er tilgjengelig fra en rapportdefinisjon hvis du har generert minst én rapport. |
...
| Kommando | Beskrivelse                                                              |
|---------|--------------------------------------------------------------------------|
| Hjelp    | Åpne emnesiden for hjelp for finansrapportering. |
|         |                                                                          |
