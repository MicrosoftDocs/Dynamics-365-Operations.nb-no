...
description: Denne artikkelen beskriver hvordan en ER-formatreferanse kan settes opp i ER-formatoppslaget når det påkrevde formatet er lagret i det globale repositoriet.
author: NickSelin
ms.date: 03/17/2020
ms.topic: article
ms.prod: ''
...
Du kan bruke rammeverket for [elektronisk rapportering](general-electronic-reporting.md) (ER) til å konfigurere formater for utgående dokumenter i samsvar med lovkravene i forskjellige land/områder. Du kan også bruke ER-rammeverket for å konfigurere formater for analyse av inngående dokumenter og bruke informasjonen fra disse dokumentene til å legge til eller oppdatere applikasjonsdata. Hvert av disse formatene kan brukes i Dynamics 365 Finance-forekomsten for håndtering av inngående eller utgående forretningsdokumenter som en del av en bestemt forretningsprosess.
