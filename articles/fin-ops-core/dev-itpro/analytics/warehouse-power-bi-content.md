...
description: Denne artikkelen beskriver hva som er inkludert i Lagerytelse-innhold for Power BI.
author: Mirzaab
ms.date: 12/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9289854"
---
# <a name="warehouse-performance-power-bi-content"></a>Lagerytelse-innhold for Power BI

[!include [banner](../includes/banner.md)]

leverandørsamarbeidsfakturering beskriver hva som er inkludert i **Lagerytelse**-innhold for Microsoft Power BI. Det forklarer hvordan du kan få tilgang til Power BI-rapporter, og gir informasjon om datamodellen og enhetene som brukes til å bygge innholdet.
