...
description: Denne artikkelen inneholder informasjon om de primitive datatypene som støttes i formler i elektronisk rapportering (ER).
author: kfend
ms.date: 06/02/2021
...
Denne artikkelen inneholder informasjon om de primitive datatypene som støttes i uttrykk i [Elektronisk rapportering (ER)](general-electronic-reporting.md). Her er en liste over de primitive datatypene:
