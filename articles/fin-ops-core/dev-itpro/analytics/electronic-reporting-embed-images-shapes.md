...
description: Denne artikkelen beskriver hvordan du bruker verktøyet for elektronisk rapportering til å generere forretningsdokumenter som har innebygde bilder og figurer.
author: kfend
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
