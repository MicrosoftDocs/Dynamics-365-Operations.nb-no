...
> [!NOTE]
> En SMTP-server (Simple Mail Transfer Protocol) må være konfigurert og tilgjengelig. Du kan angi SMTP-serveren i under **Systemadministrasjon** &gt; **Oppsett** &gt; **E-post** &gt; **E-postparametere**.
...
> [!NOTE]
> Du kan velge en dokumenttype for jobbarkivet på **Organisasjonsstyring** &gt; **Arbeidsområder** &gt; **Elektronisk rapportering** &gt; **Parametere for elektronisk rapportering**.
