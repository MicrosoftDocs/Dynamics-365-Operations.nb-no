...
Listefunksjoner for elektronisk rapportering (ER) kan brukes til å trekke ut informasjon fra, og utføre operasjoner på, datakilder for datatypene *Postliste* *og Container (post)*. Denne artikkelen inneholder et sammendrag av disse funksjonene.
