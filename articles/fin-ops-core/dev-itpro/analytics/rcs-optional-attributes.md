...
description: Denne artikkelen inneholder informasjon om utforming av ER-formater som angir XML-attributter for å analysere innkommende elektroniske dokumenter i XML-format.
author: kfend
ms.date: 07/03/2019
ms.topic: article
ms.prod: ''
