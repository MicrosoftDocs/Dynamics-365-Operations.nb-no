...
description: Denne artikkelen beskriver hvordan du konfigurerer et ER-format (Electronic reporting) til å generere rapporter som Microsoft Word-filer der innholdskontroller skjules.
author: kfend
ms.date: 02/11/2021
