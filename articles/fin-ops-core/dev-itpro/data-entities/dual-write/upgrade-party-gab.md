...
> [!Note]
> Malen gjør det enklere å oppgradere bare **Part**-dataene. I en fremtidig versjon blir postadresser og elektroniske adresser inkludert.

## <a name="prerequisites"></a>Forutsetninger

Disse forutsetningene kreves:

+ [Azure-abonnement](https://portal.azure.com/)
+ [Tilgang til malen](https://aka.ms/dual-write-gab-adf)
+ Du er en eksisterende kunde med dobbel skriving.

## <a name="prepare-for-the-upgrade"></a>Forberede for oppgraderingen

+ **Fullstendig synkronisert**: Begge miljøene er fullstending synkronisert for **Konto (kunde)**, **Kontakt** og **Leverandør**.
...
1. Stopp dobbel skriving for **Konto**, **Kontakt** og **Leverandør** ved å bruke Finance and Operations-appen.
...
4. Hvis tabellene nedenfor i Finance and Operations-appen inneholder data, kjører du deretter **innledende synkronisering** for dem.
...
Du kan finne kommentarer til malen i [readme.md](https://github.com/microsoft/Dynamics-365-FastTrack-Implementation-Assets/blob/master/Dual-write/Upgrade%20data%20to%20dual-write%20Party-GAB%20schema/readme.md)-filen.