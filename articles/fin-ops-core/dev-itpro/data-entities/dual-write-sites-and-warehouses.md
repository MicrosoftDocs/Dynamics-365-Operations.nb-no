...
## <a name="operational-sites"></a>Driftssteder

Driftsstedene er tilgjengelige i Common Data Service ved bruk av følgende tilordninger:
...
## <a name="warehouses"></a>Lagre

Lagrene er tilgjengelige ved bruk av følgende tilordninger:
