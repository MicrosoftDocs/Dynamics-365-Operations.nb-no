...
> [!TIP]
> <P>Hvis du vil flytte en tilknyttet stykkliste til et annet serviceobjekt eller slette den tilknyttede stykklisten, går du til skjemaet <STRONG>Serviceobjekter</STRONG> og klikker på <STRONG>Funksjoner</STRONG> og deretter på <STRONG>Flytt servicestykkliste</STRONG> eller på <STRONG>Slett servicestykkliste</STRONG>..</P>
