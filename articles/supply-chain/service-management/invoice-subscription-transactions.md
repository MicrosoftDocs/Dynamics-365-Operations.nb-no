...
3.  Klikk på **Analyser** \> **Gebyrtransaksjoner**.
...
5.  Klikk på **Opprett faktura**, og angi de aktuelle parameterne i skjemaet **Opprett faktura**

6.  Klikk på **OK** for å opprette fakturaforslaget i skjemaet **Fakturaforslag**.
