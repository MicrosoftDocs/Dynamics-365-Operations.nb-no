...
description: Denne artikkelen beskriver hvordan du definerer generell informasjon og konfigurasjonsinnstillinger som brukes i hele modulen Netto innkjøpspris for postering, statusoppdateringer, nummerserier og virkemåte.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
