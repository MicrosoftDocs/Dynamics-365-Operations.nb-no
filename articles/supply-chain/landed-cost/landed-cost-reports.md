...
description: Denne artikkelen beskriver hvordan du finner og bruker de ulike typene rapporter som er tilgjengelige for modulen Netto innkjøpspris.
author: Weijiesa
ms.date: 02/01/2021
ms.topic: article
ms.prod: ''
