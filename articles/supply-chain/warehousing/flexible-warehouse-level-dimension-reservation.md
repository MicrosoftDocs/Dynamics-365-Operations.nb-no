...
Når et hierarki for beholdningsreservasjon av *Parti-under\[plassering-typen\]* er assosiert med produkter, kan bedrifter som selger partisporede produkter og kjører logistikken som operasjoner som er aktivert for Warehouse Management-prosesser (WMS), ikke reservere spesifikke partier av disse produktene for kundesalgsordrer.
...
- [Plukk eldste parti på en mobilenhet](pick-oldest-batch.md)
