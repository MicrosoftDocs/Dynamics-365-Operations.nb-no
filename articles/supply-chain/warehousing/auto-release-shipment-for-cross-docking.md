...
|---|---|
| Element | Varn må aktiveres for lagerstyringsprosesser.<p>**Merk:** Faktisk vekt-aktiverte varer kan ikke inkluderes i direkteoverføringprosessene.</p> |
| Lager | Lageret må aktiveres for lagerstyringsprosesser. |
