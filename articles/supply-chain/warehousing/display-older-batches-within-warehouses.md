...
- <span data-ttu-id="fc1d1-110">Fortsette plukking fra gjeldende plassering – Hvis du fortsetter med befinner for arbeid, fortsetter antallet for linjen arbeid som skal plukkes fra den opprinnelige plasseringen.</span><span class="sxs-lookup"><span data-stu-id="fc1d1-110">Continue picking from the current location - If you continue with the current work line location, the quantities for the work line will continue to be picked from the original location.</span></span>

## <a name="where-it-applies"></a><span data-ttu-id="fc1d1-111">Der det er aktuelt</span><span class="sxs-lookup"><span data-stu-id="fc1d1-111">Where it applies</span></span>
<span data-ttu-id="fc1d1-112">Vis eldre lageret er konfigurert på mobil enhet, menyelementer og påvirker plukkingen for partiet under elementene.</span><span class="sxs-lookup"><span data-stu-id="fc1d1-112">Display older batches within warehouse is configured on mobile device menu items and affects the pick for batch below items.</span></span>

## <a name="set-up-display-older-batches-within-warehouse"></a><span data-ttu-id="fc1d1-113">Definere visning eldre bunker i lager</span><span class="sxs-lookup"><span data-stu-id="fc1d1-113">Set up Display older batches within warehouse</span></span>
<span data-ttu-id="fc1d1-114">Den **Vis eldre lagerpartier lageret** konfigurasjon er tilgjengelig på mobil enhet menyelementene når den **plukk eldste satsvis** er **varsel**.</span><span class="sxs-lookup"><span data-stu-id="fc1d1-114">The **Display older batches within warehouse** configuration is available on mobile device menu items when the **Pick oldest batch** option is set to **Warn**.</span></span>

- <span data-ttu-id="fc1d1-115">Under **Lagerstyring** > **oppsett** > **mobil enhet** > **mobiltelefon menyelementer**, setter **bruker eksisterende arbeid** til **Ja** for menyelementet, og velg **varsel** i den **plukk eldste satsvis** feltet.</span><span class="sxs-lookup"><span data-stu-id="fc1d1-115">Under **Warehouse management** > **Setup** > **Mobile device** > **Mobile device menu items**, set **Use existing work** to **Yes** for the menu item, and select **Warn** in the **Pick oldest batch** field.</span></span> 
