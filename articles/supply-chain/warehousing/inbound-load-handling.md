...
For å gå gjennom eksempelscenarioene som beskrives i denne delen, må du først kontrollere at alle de nødvendige funksjonene er aktivert for systemet. De nødvendige demodataene må også være tilgjengelige i systemet.
