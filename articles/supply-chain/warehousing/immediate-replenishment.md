...
description: Denne artikkelen beskriver hvordan du kan bruke umiddelbar etterfylling for å etterfylle beholdningen når et lokasjonsdirektiv ikke kan tilordne beholdning.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
