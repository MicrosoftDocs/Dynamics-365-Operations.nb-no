...
- <span data-ttu-id="133b9-125">Rydde opp i bølgeetikettloggen.</span><span class="sxs-lookup"><span data-stu-id="133b9-125">Clean up the wave label history.</span></span>
...
1. <span data-ttu-id="133b9-151">Gå til **Lagerstyring \> Oppsett \> Bølger \> Bølgemaler** .</span><span class="sxs-lookup"><span data-stu-id="133b9-151">Go to **Warehouse management \> Setup \> Waves \> Wave templates** .</span></span>
...
1. <span data-ttu-id="133b9-166">Legg til en rad som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-166">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="133b9-167">**Rad-ID:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="133b9-167">**Row Id:** *WaveLabel*</span></span>
...
<span data-ttu-id="133b9-200">Bølgeetiketttyper brukes til å koble bølgeetikettmaler til en enhet på enhetssekvensgruppelinjer.</span><span class="sxs-lookup"><span data-stu-id="133b9-200">Wave label types are used to link wave label templates to a unit on unit sequence group lines.</span></span>
...
1. <span data-ttu-id="133b9-218">I hurtigfanen **Generelt** angir du feltet **Bølgeetiketttype** -feltet til *Kartong* .</span><span class="sxs-lookup"><span data-stu-id="133b9-218">On the **General** FastTab, set the **Wave label type** field to *Carton* .</span></span>
...
1. <span data-ttu-id="133b9-238">Velg **OK** for å lukke dialogboksen for redigeringsprogrammet for spørring.</span><span class="sxs-lookup"><span data-stu-id="133b9-238">Select **OK** to close the query editor dialog box.</span></span>
...
1. <span data-ttu-id="133b9-251">Opprett en salgsordre med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-251">Create a sales order that has the following settings:</span></span>
    ...
    - <span data-ttu-id="133b9-252">**Kundekonto:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="133b9-252">**Customer account:** *US-001*</span></span>
...
1. <span data-ttu-id="133b9-270">Velg **Frigi til lager** i kategorien **Lager** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-270">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse** .</span></span>
    ...
    <span data-ttu-id="133b9-271">Følgende hendelser skjer:</span><span class="sxs-lookup"><span data-stu-id="133b9-271">The following events occur:</span></span>
...
<span data-ttu-id="133b9-288">Her er hovedforskjellen mellom dette scenariet og scenario 1:</span><span class="sxs-lookup"><span data-stu-id="133b9-288">Here are the main differences between this scenario and scenario 1:</span></span>
...
1. <span data-ttu-id="133b9-313">Opprett en post som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-313">Create a record that has the following settings:</span></span>
    ...
    - <span data-ttu-id="133b9-314">**Etikettoppsett-ID:** *Kartong*</span><span class="sxs-lookup"><span data-stu-id="133b9-314">**Label layout ID:** *Carton*</span></span>
...
1. <span data-ttu-id="133b9-333">Lukk siden.</span><span class="sxs-lookup"><span data-stu-id="133b9-333">Close the page.</span></span>
...
1. <span data-ttu-id="133b9-364">Velg **Lagre** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-364">On the Action Pane, select **Save** .</span></span>
...
1. <span data-ttu-id="133b9-379">Opprett en salgsordre med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-379">Create a sales order that has the following settings:</span></span>
    ...
    - <span data-ttu-id="133b9-380">**Kundekonto:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="133b9-380">**Customer account:** *US-001*</span></span>
...
1. <span data-ttu-id="133b9-404">Velg **Frigi til lager** i kategorien **Lager** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-404">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse** .</span></span>
...
1. <span data-ttu-id="133b9-431">Gå til **Lagerstyring \> Oppsett \> Bølger \> Bølgemaler** .</span><span class="sxs-lookup"><span data-stu-id="133b9-431">Go to **Warehouse management \> Setup \> Waves \> Wave templates** .</span></span>
...
6. <span data-ttu-id="133b9-437">I kolonnen **Valgte metoder** tilordner du en annen **Bølgetrinnkode** -verdi, for eksempel *Palle* , til den andre **Bølgeetikettutskrift** -metoden.</span><span class="sxs-lookup"><span data-stu-id="133b9-437">In the **Selected methods** column, assign a different **Wave step code** value, such as *Pallet* , to the second **Wave label printing** method.</span></span> <span data-ttu-id="133b9-438">For mer informasjon om bølgetrinnkoder, se [Bølgetrinnkoder](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="133b9-438">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>

### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="133b9-439">Opprette tre oppsett for bølgeetikett</span><span class="sxs-lookup"><span data-stu-id="133b9-439">Create three wave label layouts</span></span>

1. <span data-ttu-id="133b9-440">Gå til **Lagerstyring \> Oppsett \> Dokumentruting \> Bølgeetikettoppsett** .</span><span class="sxs-lookup"><span data-stu-id="133b9-440">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts** .</span></span>
1. <span data-ttu-id="133b9-441">Opprett en post som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-441">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="133b9-442">**Etikettoppsett-ID:** *Kartong*</span><span class="sxs-lookup"><span data-stu-id="133b9-442">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="133b9-443">**Beskrivelse:** *Kartong (SSCC)*</span><span class="sxs-lookup"><span data-stu-id="133b9-443">**Description:** *Carton (SSCC)*</span></span>

1. <span data-ttu-id="133b9-444">Velg **Lagre** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-444">On the Action Pane, select **Save** .</span></span>
1. <span data-ttu-id="133b9-445">I handlingsruten velger du alternativet for **Radinnstillinger for bølgeetikett** .</span><span class="sxs-lookup"><span data-stu-id="133b9-445">On the Action Pane, select **Wave label row settings** .</span></span>

    <span data-ttu-id="133b9-446">Siden for **Radinnstillinger for bølgeetikett** vises.</span><span class="sxs-lookup"><span data-stu-id="133b9-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="133b9-447">Her kan du konfigurere den dynamiske delen av etiketten.</span><span class="sxs-lookup"><span data-stu-id="133b9-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="133b9-448">Legg til en rad som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-449">**Rad-ID:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="133b9-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="133b9-450">**Navn på radtabell:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="133b9-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="133b9-451">**Startposisjon for rad:** *0*</span><span class="sxs-lookup"><span data-stu-id="133b9-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="133b9-452">Dette feltet angir den loddrette plasseringen der raden vil begynne på etiketten.</span><span class="sxs-lookup"><span data-stu-id="133b9-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="133b9-453">**Radhøyde:** *0*</span><span class="sxs-lookup"><span data-stu-id="133b9-453">**Row height:** *0*</span></span>

        <span data-ttu-id="133b9-454">Dette feltet definerer høyden på hver rad (i punkter) i henhold til ZPL-standarden.</span><span class="sxs-lookup"><span data-stu-id="133b9-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="133b9-455">Radhøyden er positiv for vannrette etiketter og negativ for loddrette etiketter.</span><span class="sxs-lookup"><span data-stu-id="133b9-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="133b9-456">Fordi det bare er én rad i dette eksemplet, kan du sette verdien til *0* (null).</span><span class="sxs-lookup"><span data-stu-id="133b9-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="133b9-457">**Rader per side:** *1*</span><span class="sxs-lookup"><span data-stu-id="133b9-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="133b9-458">Dette feltet definerer antallet rader som kan skrives ut på hver etikett.</span><span class="sxs-lookup"><span data-stu-id="133b9-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="133b9-459">Dette oppsettet vil føre til at det skrives ut en egen ZPL-etikett for hver post i bølgeetikettabellen.</span><span class="sxs-lookup"><span data-stu-id="133b9-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="133b9-460">Lukk siden.</span><span class="sxs-lookup"><span data-stu-id="133b9-460">Close the page.</span></span>
1. <span data-ttu-id="133b9-461">I handlingsruten velger du **Rediger spørring** .</span><span class="sxs-lookup"><span data-stu-id="133b9-461">On the Action Pane, select **Edit query** .</span></span>
1. <span data-ttu-id="133b9-462">I dialogboksen for redigeringsprogrammet, i tabellen **Område** , legger du til en rad med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-463">**Tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-464">**Avledet tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-465">**Felt:** *Arbeidstype*</span><span class="sxs-lookup"><span data-stu-id="133b9-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="133b9-466">**Kriterier:** *Plukk*</span><span class="sxs-lookup"><span data-stu-id="133b9-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="133b9-467">Denne spørringen sikrer at bare arbeidslinjer av plukktypen blir skrevet ut på etiketten, ikke plasser-arbeidslinjer.</span><span class="sxs-lookup"><span data-stu-id="133b9-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="133b9-468">Hvis du vil ha muligheten til å skrive ut fraktbrev-IDen, velger du kategorien **Sammenkoblinger** , velger tabellen **Arbeidslinjer** og kobler **Forsendelser** -tabellen til den.</span><span class="sxs-lookup"><span data-stu-id="133b9-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="133b9-469">Lukk dialogboksen for redigeringsprogram for spørring.</span><span class="sxs-lookup"><span data-stu-id="133b9-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="133b9-470">Hurtigfanen for **Skrivertekstoppsett** har tre inndelinger der du kan skrive skriverkode: **topptekstdelen** , **brødtekstdelen** og **bunntekstdelen** .</span><span class="sxs-lookup"><span data-stu-id="133b9-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section** , **Body section** , and **Footer section** .</span></span> <span data-ttu-id="133b9-471">I **topptekstdelen** i feltet for **etikettopptekst** angir du koden for den nødvendige toppteksten.</span><span class="sxs-lookup"><span data-stu-id="133b9-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="133b9-472">Hvis du for eksempel bruker Zebra-skrivere, kan du bruke følgende kode.</span><span class="sxs-lookup"><span data-stu-id="133b9-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="133b9-473">I **brødtekstdelen** i feltet for **etikettbrødtekst** angir du ZPL-kode for den nødvendige brødteksten.</span><span class="sxs-lookup"><span data-stu-id="133b9-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="133b9-474">Her er et eksempel:</span><span class="sxs-lookup"><span data-stu-id="133b9-474">Here is an example.</span></span>
...
1. <span data-ttu-id="133b9-475">I **brødtekstdelen** i feltet for **etikettbunntekst** angir du ZPL-kode for den nødvendige bunnteksten.</span><span class="sxs-lookup"><span data-stu-id="133b9-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="133b9-476">Her er et eksempel:</span><span class="sxs-lookup"><span data-stu-id="133b9-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="133b9-477">Dette oppsettet skriver bare ut én kopi av hver etikett.</span><span class="sxs-lookup"><span data-stu-id="133b9-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="133b9-478">Hvis du trenger flere kopier (for eksempel én kopi for hver side av pallen), setter du **n** -verdien for **\^PQn** -delen i bunnteskten til det nødvendige antallet eksemplarer.</span><span class="sxs-lookup"><span data-stu-id="133b9-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="133b9-479">Hvis du for eksempel vil skrive ut fire eksemplarer av hver etikett, angir du **\^PQ4** .</span><span class="sxs-lookup"><span data-stu-id="133b9-479">For example, to print four copies of each label, specify **\^PQ4** .</span></span>

1. <span data-ttu-id="133b9-480">Den første etiketten er nå klar til bruk.</span><span class="sxs-lookup"><span data-stu-id="133b9-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="133b9-481">Opprett en oppsettpost nummer to som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="133b9-482">**Etikettoppsett-ID:** *Pall*</span><span class="sxs-lookup"><span data-stu-id="133b9-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="133b9-483">**Beskrivelse:** *Pall*</span><span class="sxs-lookup"><span data-stu-id="133b9-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="133b9-484">Velg **Lagre** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-484">On the Action Pane, select **Save** .</span></span>
1. <span data-ttu-id="133b9-485">I handlingsruten velger du alternativet for **Radinnstillinger for bølgeetikett** .</span><span class="sxs-lookup"><span data-stu-id="133b9-485">On the Action Pane, select **Wave label row settings** .</span></span>

    <span data-ttu-id="133b9-486">Siden for **Radinnstillinger for bølgeetikett** vises.</span><span class="sxs-lookup"><span data-stu-id="133b9-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="133b9-487">Her kan du konfigurere den dynamiske delen av etiketten.</span><span class="sxs-lookup"><span data-stu-id="133b9-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="133b9-488">Legg til en rad som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-489">**Rad-ID:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="133b9-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="133b9-490">**Navn på radtabell:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="133b9-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="133b9-491">**Startposisjon for rad:** *0*</span><span class="sxs-lookup"><span data-stu-id="133b9-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="133b9-492">Dette feltet angir den loddrette plasseringen der raden vil begynne på etiketten.</span><span class="sxs-lookup"><span data-stu-id="133b9-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="133b9-493">**Radhøyde:** *0*</span><span class="sxs-lookup"><span data-stu-id="133b9-493">**Row height:** *0*</span></span>

        <span data-ttu-id="133b9-494">Dette feltet definerer høyden på hver rad (i punkter) i henhold til ZPL-standarden.</span><span class="sxs-lookup"><span data-stu-id="133b9-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="133b9-495">Radhøyden er positiv for vannrette etiketter og negativ for loddrette etiketter.</span><span class="sxs-lookup"><span data-stu-id="133b9-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="133b9-496">Fordi det bare er én rad i dette eksemplet, kan du sette verdien til *0* (null).</span><span class="sxs-lookup"><span data-stu-id="133b9-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="133b9-497">**Rader per side:** *1*</span><span class="sxs-lookup"><span data-stu-id="133b9-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="133b9-498">Dette feltet definerer antallet rader som kan skrives ut på hver etikett.</span><span class="sxs-lookup"><span data-stu-id="133b9-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="133b9-499">Dette oppsettet fører til at det skrives ut en egen ZPL-etikett for hver post i bølgeetikettabellen.</span><span class="sxs-lookup"><span data-stu-id="133b9-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="133b9-500">Lukk siden.</span><span class="sxs-lookup"><span data-stu-id="133b9-500">Close the page.</span></span>
1. <span data-ttu-id="133b9-501">I handlingsruten velger du **Rediger spørring** .</span><span class="sxs-lookup"><span data-stu-id="133b9-501">On the Action Pane, select **Edit query** .</span></span>
1. <span data-ttu-id="133b9-502">I dialogboksen for redigeringsprogrammet, i tabellen **Område** , legger du til en rad med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-503">**Tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-504">**Avledet tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-505">**Felt:** *Arbeidstype*</span><span class="sxs-lookup"><span data-stu-id="133b9-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="133b9-506">**Kriterier:** *Plukk*</span><span class="sxs-lookup"><span data-stu-id="133b9-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="133b9-507">Denne spørringen sikrer at bare arbeidslinjer av plukktypen blir skrevet ut på etiketten, ikke plasser-arbeidslinjer.</span><span class="sxs-lookup"><span data-stu-id="133b9-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="133b9-508">Hvis du vil ha muligheten til å skrive ut fraktbrev-IDen, velger du kategorien **Sammenkoblinger** , velger tabellen **Arbeidslinjer** og kobler **Forsendelser** -tabellen til den.</span><span class="sxs-lookup"><span data-stu-id="133b9-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="133b9-509">Lukk dialogboksen for redigeringsprogram for spørring.</span><span class="sxs-lookup"><span data-stu-id="133b9-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="133b9-510">Hurtigfanen for **Skrivertekstoppsett** har tre inndelinger der du kan skrive skriverkode: **topptekstdelen** , **brødtekstdelen** og **bunntekstdelen** .</span><span class="sxs-lookup"><span data-stu-id="133b9-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section** , **Body section** , and **Footer section** .</span></span> <span data-ttu-id="133b9-511">I **topptekstdelen** i feltet for **etikettopptekst** angir du koden for den nødvendige toppteksten.</span><span class="sxs-lookup"><span data-stu-id="133b9-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="133b9-512">Hvis du for eksempel bruker Zebra-skrivere, kan du bruke følgende kode.</span><span class="sxs-lookup"><span data-stu-id="133b9-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="133b9-513">I **brødtekstdelen** i feltet for **etikettbrødtekst** angir du ZPL-kode for den nødvendige brødteksten.</span><span class="sxs-lookup"><span data-stu-id="133b9-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="133b9-514">Her er et eksempel:</span><span class="sxs-lookup"><span data-stu-id="133b9-514">Here is an example.</span></span>
...
1. <span data-ttu-id="133b9-515">I **brødtekstdelen** i feltet for **etikettbunntekst** angir du ZPL-kode for den nødvendige bunnteksten.</span><span class="sxs-lookup"><span data-stu-id="133b9-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="133b9-516">Her er et eksempel:</span><span class="sxs-lookup"><span data-stu-id="133b9-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="133b9-517">Dette oppsettet skriver bare ut én kopi av hver etikett.</span><span class="sxs-lookup"><span data-stu-id="133b9-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="133b9-518">Hvis du trenger flere kopier (for eksempel én kopi for hver side av pallen), setter du **n** -verdien for **\^PQn** -delen i bunnteskten til det nødvendige antallet eksemplarer.</span><span class="sxs-lookup"><span data-stu-id="133b9-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="133b9-519">Hvis du for eksempel vil skrive ut fire eksemplarer av hver etikett, angir du **\^PQ4** .</span><span class="sxs-lookup"><span data-stu-id="133b9-519">For example, to print four copies of each label, specify **\^PQ4** .</span></span>

1. <span data-ttu-id="133b9-520">Den andre etiketten er nå klar til bruk.</span><span class="sxs-lookup"><span data-stu-id="133b9-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="133b9-521">Opprett en tredje oppsettpost som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="133b9-522">**Etikettoppsett-ID:** *Pause*</span><span class="sxs-lookup"><span data-stu-id="133b9-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="133b9-523">**Beskrivelse:** *Pauseetikett*</span><span class="sxs-lookup"><span data-stu-id="133b9-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="133b9-524">Velg **Lagre** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-524">On the Action Pane, select **Save** .</span></span>
1. <span data-ttu-id="133b9-525">Hurtigfanen for **Skrivertekstoppsett** har tre inndelinger der du kan skrive skriverkode: **topptekstdelen** , **brødtekstdelen** og **bunntekstdelen** .</span><span class="sxs-lookup"><span data-stu-id="133b9-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section** , **Body section** , and **Footer section** .</span></span> <span data-ttu-id="133b9-526">I **topptekstdelen** i feltet for **etikettopptekst** angir du ZPL-koden for den nødvendige toppteksten.</span><span class="sxs-lookup"><span data-stu-id="133b9-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="133b9-527">Her er et eksempel:</span><span class="sxs-lookup"><span data-stu-id="133b9-527">Here is an example.</span></span>
...
1. <span data-ttu-id="133b9-528">Denne gangen er ikke brødtekst nødvendig.</span><span class="sxs-lookup"><span data-stu-id="133b9-528">This time, no body is required.</span></span> <span data-ttu-id="133b9-529">Skriv derfor bare inn den påkrevde teksten i **bunntekstdelen** .</span><span class="sxs-lookup"><span data-stu-id="133b9-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="133b9-530">Her er et eksempel:</span><span class="sxs-lookup"><span data-stu-id="133b9-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="133b9-531">Den tredje etiketten er nå klar til bruk.</span><span class="sxs-lookup"><span data-stu-id="133b9-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="133b9-532">Denne tredje etiketten er en pauseetikett som vil bli brukt som skille mellom etiketter.</span><span class="sxs-lookup"><span data-stu-id="133b9-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="133b9-533">Opprette to bølgeetikettyper</span><span class="sxs-lookup"><span data-stu-id="133b9-533">Create two wave label types</span></span>

1. <span data-ttu-id="133b9-534">Gå til **Lagerstyring \> Oppsett \> Dokumentruting \> Bølgeetiketttyper** .</span><span class="sxs-lookup"><span data-stu-id="133b9-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types** .</span></span>
1. <span data-ttu-id="133b9-535">Opprett en post som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="133b9-536">**Etikettype:** *Kartong*</span><span class="sxs-lookup"><span data-stu-id="133b9-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="133b9-537">**Beskrivelse:** *Kartong*</span><span class="sxs-lookup"><span data-stu-id="133b9-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="133b9-538">Opprett en post nummer to som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="133b9-539">**Etikettype:** *Pall*</span><span class="sxs-lookup"><span data-stu-id="133b9-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="133b9-540">**Beskrivelse:** *Pall*</span><span class="sxs-lookup"><span data-stu-id="133b9-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="133b9-541">Konfigurer sekvensgrupper for enheter</span><span class="sxs-lookup"><span data-stu-id="133b9-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="133b9-542">Gå til **Lagerstyring \> Oppsett \> Lager \> Sekvensgrupper for enhet** .</span><span class="sxs-lookup"><span data-stu-id="133b9-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups** .</span></span>
1. <span data-ttu-id="133b9-543">Velg eller opprett en **EA Box pl** -gruppe.</span><span class="sxs-lookup"><span data-stu-id="133b9-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="133b9-544">For **Boks** angir du feltet **Bølgenivåtype** til *Kartong* .</span><span class="sxs-lookup"><span data-stu-id="133b9-544">For the **Box** line, set the **Wave level type** field to *Carton* .</span></span>
1. <span data-ttu-id="133b9-545">For **PL** -linjen angir du feltet **Bølgenivåtype** til *Pall* .</span><span class="sxs-lookup"><span data-stu-id="133b9-545">For the **PL** line, set the **Wave level type** field to *Pallet* .</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="133b9-546">Opprette maler for bølgeetikett</span><span class="sxs-lookup"><span data-stu-id="133b9-546">Create wave label templates</span></span>

1. <span data-ttu-id="133b9-547">Gå til **Lagerstyring \> Oppsett \> Dokumentruting \> Maler for bølgeetiketter** .</span><span class="sxs-lookup"><span data-stu-id="133b9-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates** .</span></span>
1. <span data-ttu-id="133b9-548">Opprett en etikettmal som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="133b9-549">**Etikettmalnavn:** *Kartongetiketter*</span><span class="sxs-lookup"><span data-stu-id="133b9-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="133b9-550">**Beskrivelse:** *Kartongetiketter*</span><span class="sxs-lookup"><span data-stu-id="133b9-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="133b9-551">**Bølgetrinnkode:** *Kartong*</span><span class="sxs-lookup"><span data-stu-id="133b9-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="133b9-552">**Lager:** *62*</span><span class="sxs-lookup"><span data-stu-id="133b9-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="133b9-553">På hurtigfanen **Generelt** , i feltet **Bølgeetiketttype** , velger du en verdi, for eksempel *Kartong* .</span><span class="sxs-lookup"><span data-stu-id="133b9-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton* .</span></span>
1. <span data-ttu-id="133b9-554">I hurtigfanen for **Maldetaljer for bølgeetikett** legger du til en rad med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-555">**Etikettoppsett-ID:** *Kartong*</span><span class="sxs-lookup"><span data-stu-id="133b9-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="133b9-556">**Skrivernavn:** Velg en passende ZPL-skriver.</span><span class="sxs-lookup"><span data-stu-id="133b9-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="133b9-557">**Kjør spørring:** *Ja* (Denne innstillingen er valgfri, men anbefales for optimal ytelse.)</span><span class="sxs-lookup"><span data-stu-id="133b9-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="133b9-558">Velg **Lagre** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-558">On the Action Pane, select **Save** .</span></span>
1. <span data-ttu-id="133b9-559">Valgfritt: Hvis du definerer en kundespesifikk etikettutforming, må du opprette en spørring for å finne kundens konto.</span><span class="sxs-lookup"><span data-stu-id="133b9-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="133b9-560">På hurtigfanen **Maldetaljer for bølgeetikett** velger du **Rediger spørring** .</span><span class="sxs-lookup"><span data-stu-id="133b9-560">On the **Wave label template details** FastTab, select **Edit query** .</span></span> <span data-ttu-id="133b9-561">Deretter, i dialoglogboksen for redigeringsprogrammet, i tabellen **Område** , legger du til en rad med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-562">**Tabell:** *Forsendelser*</span><span class="sxs-lookup"><span data-stu-id="133b9-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="133b9-563">**Avledet tabell:** *Forsendelser*</span><span class="sxs-lookup"><span data-stu-id="133b9-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="133b9-564">**Felt:** *Kontonummer*</span><span class="sxs-lookup"><span data-stu-id="133b9-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="133b9-565">**Kriterier:** Angi det aktuelle kundekontonummeret.</span><span class="sxs-lookup"><span data-stu-id="133b9-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="133b9-566">Når du er ferdig, velger du **OK** for å lukke dialogboksen redigeringsprogrammet for spørring.</span><span class="sxs-lookup"><span data-stu-id="133b9-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="133b9-567">I handlingsruten velger du **Rediger spørring** for å åpne dialogboksen for redigeringsprogrammet for spørringen for hele etikettmalen.</span><span class="sxs-lookup"><span data-stu-id="133b9-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="133b9-568">I dialogboksen for redigeringsprogrammet, i tabellen **Sortering** , legger du til en rad med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-569">**Tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-570">**Avledet tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-571">**Felt:** *Linje-ID for referanselast (post-ID)*</span><span class="sxs-lookup"><span data-stu-id="133b9-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="133b9-572">**Søkeretning:** *Stigende*</span><span class="sxs-lookup"><span data-stu-id="133b9-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="133b9-573">Legg til en rad nummer to som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-574">**Tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-575">**Avledet tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-576">**Felt:** *Leverings-ID*</span><span class="sxs-lookup"><span data-stu-id="133b9-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="133b9-577">**Søkeretning:** *Stigende*</span><span class="sxs-lookup"><span data-stu-id="133b9-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="133b9-578">Velg **OK** for å lukke dialogboksen for redigeringsprogrammet for spørring.</span><span class="sxs-lookup"><span data-stu-id="133b9-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="133b9-579">En meldingsboks ber deg bekrefte gjenopprettingsoperasjonen for gruppering.</span><span class="sxs-lookup"><span data-stu-id="133b9-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="133b9-580">Klikk **Ja** for å fortsette.</span><span class="sxs-lookup"><span data-stu-id="133b9-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="133b9-581">Velg **Malgruppe for bølgeetikett** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-581">On the Action Pane, select **Wave label template group** .</span></span>
1. <span data-ttu-id="133b9-582">I dialogboksen for **Malgruppe for bølgeetikett** , for raden der feltet **Referansefeltnavn** er satt til *Forsendelses-ID* , angir du følgende verdier:</span><span class="sxs-lookup"><span data-stu-id="133b9-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID* , set the following values:</span></span>

    - <span data-ttu-id="133b9-583">**Skriv ut pauseetikett:** Merk av i denne avmerkingsboksen.</span><span class="sxs-lookup"><span data-stu-id="133b9-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="133b9-584">**Etikettoppsett-ID:** Velg en pauseetikett.</span><span class="sxs-lookup"><span data-stu-id="133b9-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="133b9-585">(Merk for eksempel av for *Pause* -etikettoppsettet som du opprettet tidligere i dette scenariet.)</span><span class="sxs-lookup"><span data-stu-id="133b9-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="133b9-586">**Skrivernavn:** Velg skriveren for pauseetiketten.</span><span class="sxs-lookup"><span data-stu-id="133b9-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="133b9-587">(Vanligvis må du velge den samme skriveren som er valgt i hurtigfanen **Maldetaljer for bølgeetikett** , for å skille mellom etiketter.</span><span class="sxs-lookup"><span data-stu-id="133b9-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="133b9-588">Det er imidlertid mulig å bruke andre scenarier.)</span><span class="sxs-lookup"><span data-stu-id="133b9-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="133b9-589">For raden der feltet **Referansefeltnavn** er satt til *Linje-ID for referanselast* , merker du av for **Etikettversjons-ID** .</span><span class="sxs-lookup"><span data-stu-id="133b9-589">For the row where the **Reference field name** field is set to *Reference load line id* , select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="133b9-590">Dette oppsettet vil opprette én etikettsekvens ("Kartong 1 av X") per lastlinje gjennom bølgen, uansett oppsett for arbeidsgruppering.</span><span class="sxs-lookup"><span data-stu-id="133b9-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="133b9-591">Denne etikettsekvensen kan skrives ut på et etikettoppsettet.</span><span class="sxs-lookup"><span data-stu-id="133b9-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="133b9-592">I tillegg vil etiketter for forskjellige forsendelser skilles med den valgte pauseetiketten.</span><span class="sxs-lookup"><span data-stu-id="133b9-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="133b9-593">Velg **OK** for å lukke dialogboksen **Malgruppe for bølgeetikett** .</span><span class="sxs-lookup"><span data-stu-id="133b9-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="133b9-594">Opprett en etikettmal nummer to som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="133b9-595">**Etikettmalnavn:** *Palletiketter*</span><span class="sxs-lookup"><span data-stu-id="133b9-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="133b9-596">**Beskrivelse:** *Palletiketter*</span><span class="sxs-lookup"><span data-stu-id="133b9-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="133b9-597">**Bølgetrinnkode:** *Pall*</span><span class="sxs-lookup"><span data-stu-id="133b9-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="133b9-598">**Lager:** *62*</span><span class="sxs-lookup"><span data-stu-id="133b9-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="133b9-599">På hurtigfanen **Generelt** , i feltet **Bølgeetiketttype** , velger du en verdi, for eksempel *Pall* .</span><span class="sxs-lookup"><span data-stu-id="133b9-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet* .</span></span>
1. <span data-ttu-id="133b9-600">I hurtigfanen for **Maldetaljer for bølgeetikett** legger du til en rad med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-601">**Etikettoppsett-ID:** *Pall*</span><span class="sxs-lookup"><span data-stu-id="133b9-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="133b9-602">**Skrivernavn:** Velg en passende ZPL-skriver.</span><span class="sxs-lookup"><span data-stu-id="133b9-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="133b9-603">**Kjør spørring:** *Ja* (Denne innstillingen er valgfri, men anbefales for optimal ytelse.)</span><span class="sxs-lookup"><span data-stu-id="133b9-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="133b9-604">Velg **Lagre** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-604">On the Action Pane, select **Save** .</span></span>
1. <span data-ttu-id="133b9-605">Valgfritt: Hvis du definerer en kundespesifikk etikettutforming, må du opprette en spørring for å finne kundens konto.</span><span class="sxs-lookup"><span data-stu-id="133b9-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="133b9-606">På hurtigfanen **Maldetaljer for bølgeetikett** velger du **Rediger spørring** .</span><span class="sxs-lookup"><span data-stu-id="133b9-606">On the **Wave label template details** FastTab, select **Edit query** .</span></span> <span data-ttu-id="133b9-607">Deretter, i dialoglogboksen for redigeringsprogrammet, i tabellen **Område** , legger du til en rad med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-608">**Tabell:** *Forsendelser*</span><span class="sxs-lookup"><span data-stu-id="133b9-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="133b9-609">**Avledet tabell:** *Forsendelser*</span><span class="sxs-lookup"><span data-stu-id="133b9-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="133b9-610">**Felt:** *Kontonummer*</span><span class="sxs-lookup"><span data-stu-id="133b9-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="133b9-611">**Kriterier:** Angi det aktuelle kundekontonummeret.</span><span class="sxs-lookup"><span data-stu-id="133b9-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="133b9-612">Når du er ferdig, velger du **OK** for å lukke dialogboksen redigeringsprogrammet for spørring.</span><span class="sxs-lookup"><span data-stu-id="133b9-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="133b9-613">I handlingsruten velger du **Rediger spørring** for å åpne dialogboksen for redigeringsprogrammet for spørringen for hele etikettmalen.</span><span class="sxs-lookup"><span data-stu-id="133b9-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="133b9-614">I dialogboksen for redigeringsprogrammet, i tabellen **Sortering** , legger du til en rad med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-615">**Tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-616">**Avledet tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-617">**Felt:** *Linje-ID for referanselast (post-ID)*</span><span class="sxs-lookup"><span data-stu-id="133b9-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="133b9-618">**Søkeretning:** *Stigende*</span><span class="sxs-lookup"><span data-stu-id="133b9-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="133b9-619">Legg til en rad nummer to som har følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="133b9-620">**Tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-621">**Avledet tabell:** *Arbeidslinjer*</span><span class="sxs-lookup"><span data-stu-id="133b9-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="133b9-622">**Felt:** *Leverings-ID*</span><span class="sxs-lookup"><span data-stu-id="133b9-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="133b9-623">**Søkeretning:** *Stigende*</span><span class="sxs-lookup"><span data-stu-id="133b9-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="133b9-624">Velg **OK** for å lukke dialogboksen for redigeringsprogrammet for spørring.</span><span class="sxs-lookup"><span data-stu-id="133b9-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="133b9-625">En meldingsboks ber deg bekrefte gjenopprettingsoperasjonen for gruppering.</span><span class="sxs-lookup"><span data-stu-id="133b9-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="133b9-626">Klikk **Ja** for å fortsette.</span><span class="sxs-lookup"><span data-stu-id="133b9-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="133b9-627">Velg **Malgruppe for bølgeetikett** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-627">On the Action Pane, select **Wave label template group** .</span></span>
1. <span data-ttu-id="133b9-628">I dialogboksen for **Malgruppe for bølgeetikett** , for raden der feltet **Referansefeltnavn** er satt til *Forsendelses-ID* , angir du følgende verdier:</span><span class="sxs-lookup"><span data-stu-id="133b9-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID* , set the following values:</span></span>

    - <span data-ttu-id="133b9-629">**Skriv ut pauseetikett:** Merk av i denne avmerkingsboksen.</span><span class="sxs-lookup"><span data-stu-id="133b9-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="133b9-630">**Etikettoppsett-ID:** Velg en pauseetikett.</span><span class="sxs-lookup"><span data-stu-id="133b9-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="133b9-631">(Merk for eksempel av for *Pause* -etikettoppsettet som du opprettet tidligere i dette scenariet.)</span><span class="sxs-lookup"><span data-stu-id="133b9-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="133b9-632">**Skrivernavn:** Velg skriveren for pauseetiketten.</span><span class="sxs-lookup"><span data-stu-id="133b9-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="133b9-633">(Vanligvis må du velge den samme skriveren som er valgt i hurtigfanen **Maldetaljer for bølgeetikett** , for å skille mellom etiketter.</span><span class="sxs-lookup"><span data-stu-id="133b9-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="133b9-634">Det er imidlertid mulig å bruke andre scenarier.)</span><span class="sxs-lookup"><span data-stu-id="133b9-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="133b9-635">For raden der feltet **Referansefeltnavn** er satt til *Linje-ID for referanselast* , merker du av for **Etikettversjons-ID** .</span><span class="sxs-lookup"><span data-stu-id="133b9-635">For the row where the **Reference field name** field is set to *Reference load line id* , select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="133b9-636">Dette oppsettet vil opprette én etikettsekvens ("Kartong 1 av X") per lastlinje gjennom bølgen, uansett oppsett for arbeidsgruppering.</span><span class="sxs-lookup"><span data-stu-id="133b9-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="133b9-637">Denne etikettsekvensen kan skrives ut på et etikettoppsettet.</span><span class="sxs-lookup"><span data-stu-id="133b9-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="133b9-638">I tillegg vil etiketter for forskjellige forsendelser skilles med den valgte pauseetiketten.</span><span class="sxs-lookup"><span data-stu-id="133b9-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="133b9-639">Konfigurere nummerserieutvidelser</span><span class="sxs-lookup"><span data-stu-id="133b9-639">Configure number sequence extensions</span></span>

<span data-ttu-id="133b9-640">Nummerserieutvidelser kontrollerer GS1-samsvar for bestemte nummerserier.</span><span class="sxs-lookup"><span data-stu-id="133b9-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="133b9-641">Denne konfigurasjonen er valgfri for det gjeldende scenariet.</span><span class="sxs-lookup"><span data-stu-id="133b9-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="133b9-642">Du finner mer informasjon og konfigurasjonsinstruksjoner under [Konfigurere nummerserieutvidelser](../warehousing/configure-number-sequence-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="133b9-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="133b9-643">Opprette en salgsordre og frigi den til lageret</span><span class="sxs-lookup"><span data-stu-id="133b9-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="133b9-644">Gå til **Salg og markedsføring \> Salgsordre \> Alle salgsordrer** .</span><span class="sxs-lookup"><span data-stu-id="133b9-644">Go to **Sales and marketing \> Sales order \> All sales orders** .</span></span>
1. <span data-ttu-id="133b9-645">Opprett en salgsordre med følgende innstillinger:</span><span class="sxs-lookup"><span data-stu-id="133b9-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="133b9-646">**Kundekonto:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="133b9-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="133b9-647">**Lager:** *62*</span><span class="sxs-lookup"><span data-stu-id="133b9-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="133b9-648">Legg til to salgsordrelinjer:</span><span class="sxs-lookup"><span data-stu-id="133b9-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="133b9-649">Salgsordrelinje 1:</span><span class="sxs-lookup"><span data-stu-id="133b9-649">Sales order line 1:</span></span>

        - <span data-ttu-id="133b9-650">**Varenummer:** *A0001*</span><span class="sxs-lookup"><span data-stu-id="133b9-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="133b9-651">**Antall:** *9024*</span><span class="sxs-lookup"><span data-stu-id="133b9-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="133b9-652">**Enhet:** *ea* (9024 ea = 376 Box = 47 PL)</span><span class="sxs-lookup"><span data-stu-id="133b9-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="133b9-653">Salgsordrelinje 2:</span><span class="sxs-lookup"><span data-stu-id="133b9-653">Sales order line 2:</span></span>

        - <span data-ttu-id="133b9-654">**Varenummer:** *A0002*</span><span class="sxs-lookup"><span data-stu-id="133b9-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="133b9-655">**Antall:** *9016*</span><span class="sxs-lookup"><span data-stu-id="133b9-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="133b9-656">**Enhet:** *ea* (9016 ea = 322 Box = 46 PL)</span><span class="sxs-lookup"><span data-stu-id="133b9-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="133b9-657">Varene og antallene som beskrives her, er bare eksempler.</span><span class="sxs-lookup"><span data-stu-id="133b9-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="133b9-658">De må bruke enhetsseriegruppen du definerte tidligere, riktige enhetskonverteringer fra *ea* til *Box* til *PL* må være definert for dem, og de må ha lager i lageret *62* .</span><span class="sxs-lookup"><span data-stu-id="133b9-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62* .</span></span> <span data-ttu-id="133b9-659">Hvis du vil ha mer informasjon, kan du se [Måleenhet og lagringspolicyer](unit-measure-stocking-policies.md).</span><span class="sxs-lookup"><span data-stu-id="133b9-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="133b9-660">Velg salgsordrelinjen 1.</span><span class="sxs-lookup"><span data-stu-id="133b9-660">Select sales order line 1.</span></span> <span data-ttu-id="133b9-661">Deretter, i delen **Salgsordrelinje** på menyen **Lager** , velger du **Reservasjoner** .</span><span class="sxs-lookup"><span data-stu-id="133b9-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations** .</span></span>
1. <span data-ttu-id="133b9-662">På **Reservasjon** -siden i handlingsruten velger du **Reserver parti** , og deretter lukker du siden.</span><span class="sxs-lookup"><span data-stu-id="133b9-662">On the **Reservation** page, on the Action Pane, select **Reserve lot** , and then close the page.</span></span>
1. <span data-ttu-id="133b9-663">Gjenta trinn 4 og 5 for salgsordrelinje 2.</span><span class="sxs-lookup"><span data-stu-id="133b9-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="133b9-664">Velg **Frigi til lager** i kategorien **Lager** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse** .</span></span>

    <span data-ttu-id="133b9-665">Følgende hendelser skjer:</span><span class="sxs-lookup"><span data-stu-id="133b9-665">The following events occur:</span></span> 

    - <span data-ttu-id="133b9-666">Systemet behandler den opprettede forsendelsen ved hjelp av malen som inneholder etikettutskriftstrinnet.</span><span class="sxs-lookup"><span data-stu-id="133b9-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="133b9-667">Etikettoppsettet blir brukt til å definere etikettens format, og resultatet blir en etikett som skrives ut på skriveren som er valgt i etikettmalen.</span><span class="sxs-lookup"><span data-stu-id="133b9-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="133b9-668">Bølgeetiketter genereres og skrives ut.</span><span class="sxs-lookup"><span data-stu-id="133b9-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="133b9-669">Antallet etiketter vil tilsvare antallet kartonger (i dette eksemplet er 376 Box-etiketter for linje 1, 322 Box-etiketter for linje 2, 47 PL-etiketter for linje 1, 47 PL-etiketter for linje 2 og to pauseetiketter som har forsendelses-IDen).</span><span class="sxs-lookup"><span data-stu-id="133b9-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="133b9-670">En ny fraktbrev-ID genereres for forsendelsene.</span><span class="sxs-lookup"><span data-stu-id="133b9-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="133b9-671">Hvis du konfigurerte nummerserieutvidelsene, vil bølgeetikett-IDene følge **SSCC-18** -nummerformatet.</span><span class="sxs-lookup"><span data-stu-id="133b9-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="133b9-672">Du kan vise og skrive ut bølgeetiketter på nytt fra følgende sider:</span><span class="sxs-lookup"><span data-stu-id="133b9-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="133b9-673">Alle forsendelser \> Forsendelsesdetaljer</span><span class="sxs-lookup"><span data-stu-id="133b9-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="133b9-674">Alle laster \> Lastdetaljer</span><span class="sxs-lookup"><span data-stu-id="133b9-674">All loads \> Load details</span></span>
- <span data-ttu-id="133b9-675">Alle bølger</span><span class="sxs-lookup"><span data-stu-id="133b9-675">All waves</span></span>
- <span data-ttu-id="133b9-676">Bølgeetiketter</span><span class="sxs-lookup"><span data-stu-id="133b9-676">Wave labels</span></span>
- <span data-ttu-id="133b9-677">Historikk for bølgeetikett</span><span class="sxs-lookup"><span data-stu-id="133b9-677">Wave label history</span></span>

<span data-ttu-id="133b9-678">For de fleste av disse sidene kan du finne den relevante funksjonen ved å velge **Bølgeetiketter** i **Relatert informasjon** -gruppen i kategorien **Forsendelser** i handlingsruten.</span><span class="sxs-lookup"><span data-stu-id="133b9-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>
