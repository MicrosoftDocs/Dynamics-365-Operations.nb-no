...
Før du kan bruke den nye mobilappen Warehouse Management, må du legge til støtte for den i systemet. Administratorer kan bruke innstillingene for [funksjonsbehandling](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) til å kontrollere funksjonsstatusen og aktivere den. I **Funksjonsadministrering**-arbeidsområdet er denne funksjonen oppført på følgende måte:
...
1. Angi følgende verdier i hurtigfanen **Lager**:
    ...
    - **Bruk lagerstyringsprosess:** *Ja* (Denne verdien aktiverer lageret for lagerstyringsprosesser.)
