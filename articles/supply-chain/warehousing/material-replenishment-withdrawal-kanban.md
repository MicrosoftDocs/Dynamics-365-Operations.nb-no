...
description: Denne artikkelen beskriver hvordan kanban for uttak brukes til etterfylling av materialer til produksjonsaktiviteter.
author: perlynne
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8863715"
---
# <a name="replenishment-with-withdrawal-kanbans"></a>Etterfylling med uttak – Kanbaner

[!include [banner](../includes/banner.md)]

Denne artikkelen beskriver hvordan kanban for uttak brukes til etterfylling av materialer til produksjonsaktiviteter.
