...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="b4ebf-123">Definere en bølgemal</span><span class="sxs-lookup"><span data-stu-id="b4ebf-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="b4ebf-139">I hurtigfanen **Brukere** velger du **Ny** for å opprette en konto for en mobilenhet, og angi følgende verdier for den:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="b4ebf-140">**Bruker-ID:** Angi en unik ID.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-140">**User ID:** Enter a unique ID.</span></span>
...
1. <span data-ttu-id="b4ebf-158">Gå til **Lagerstyring \> Oppsett \> Lagerstyringsparametere**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-158">Go to **Warehouse management \> Setup \> Warehouse management parameters**.</span></span>
...
1. <span data-ttu-id="b4ebf-174">Gå til **Lagerstyring \> Oppsett \> Lager \> Lokasjoner**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-174">Go to **Warehouse management \> Setup \> Warehouse \> Locations**.</span></span>
...
1. <span data-ttu-id="b4ebf-192">Angi følgende verdier i **Generelt** -hurtigfanen:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-192">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="b4ebf-210">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-210">Select **OK**.</span></span>
...
1. <span data-ttu-id="b4ebf-226">Angi følgende verdier i **Oversikt** -hurtigfanen:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-226">On the **Overview** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="b4ebf-227">**Lager:** *62*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-227">**Warehouse:** *62*</span></span>
...
<span data-ttu-id="b4ebf-245">Definer en arbeidsklasse som skal brukes sammen med sortering.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-245">Set up a work class that will be used together with sorting.</span></span>
...
1. <span data-ttu-id="b4ebf-262">Angi følgende verdier i **Generelt** -hurtigfanen:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-262">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="b4ebf-279">På hurtigfanen **Arbeidsklasser** velger du **Ny** , og angi deretter følgende verdier:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-279">On the **Work classes** FastTab, select **New** , and then set the following values:</span></span>
    ...
    - <span data-ttu-id="b4ebf-280">**Arbeidsklasse-ID:** *SORTER*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-280">**Work class ID:** *SORT*</span></span>
...
#### <a name="set-up-a-single-sku-directive"></a><span data-ttu-id="b4ebf-296">Definere et enkelt-SKU-direktiv</span><span class="sxs-lookup"><span data-stu-id="b4ebf-296">Set up a single-SKU directive</span></span>
...
1. <span data-ttu-id="b4ebf-315">På hurtigfanen **Handlinger for lokasjonsdirektiv** velger du **Ny** , og angi deretter følgende verdier på den nye linjen:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-315">On the **Location Directive Actions** FastTab, select **New** , and then set the following values on the new line.</span></span> <span data-ttu-id="b4ebf-316">Godta standardverdiene for alle de andre feltene.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-316">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="b4ebf-317">**Sekvens:** *1*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-317">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="b4ebf-336">Velg **Lagre** for å gjøre verktøylinjen på **Linjer** -hurtigfanen tilgjengelig.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-336">Select **Save** to make the toolbar on the **Lines** FastTab available.</span></span>
...
1. <span data-ttu-id="b4ebf-353">Gå til **Lagerstyring \> Oppsett \> Arbeid \> Arbeidsmaler**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-353">Go to **Warehouse management \> Setup \> Work \> Work templates**.</span></span>
...
### <a name="create-sales-orders-and-picking-work"></a><span data-ttu-id="b4ebf-371">Opprette salgsordrer og plukkarbeid</span><span class="sxs-lookup"><span data-stu-id="b4ebf-371">Create sales orders and picking work</span></span>
...
1. <span data-ttu-id="b4ebf-407">På hurtigfanen **Linjedetaljer** , i kategorien **Levering** setter du feltet **Leveringsmåte** til *Flowe-STD*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-407">On the **Line details** FastTab, on the **Delivery** tab, set the **Mode of delivery** field to *Flowe-STD*.</span></span>
...
#### <a name="get-the-work-ids-from-the-work-details"></a><span data-ttu-id="b4ebf-423">Hente arbeids-IDene fra arbeidsdetaljene</span><span class="sxs-lookup"><span data-stu-id="b4ebf-423">Get the work IDs from the work details</span></span>
...
1. <span data-ttu-id="b4ebf-442">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-442">Select **OK**.</span></span>
...
1. <span data-ttu-id="b4ebf-481">Angi følgende verdier på **Varepakking** -hurtigfanen:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-481">On the **Item packing** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="b4ebf-482">**Antall:** *1*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-482">**Quantity:** *1*</span></span>
...
1. <span data-ttu-id="b4ebf-485">I dialogboksen **Lukk container** velger du **Hent systemvekt** for å få systemet til å oppdatere **Bruttovekt** -feltet.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-485">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="b4ebf-486">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-486">Select **OK**.</span></span> <span data-ttu-id="b4ebf-487">Containeren flyttes til *SORTER* -plasseringen og er klar til sortering.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-487">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="b4ebf-488">Opprett en andre container for å legge til den andre varen fra målnummerskiltet for salgsordre 1 i en ny container.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-488">Create a second container to add the second item from the LP for sales order 1 to a new container.</span></span>
1. <span data-ttu-id="b4ebf-489">I handlingsruten velger du **Ny container**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="b4ebf-490">Godta alle standardinnstillingene, og velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="b4ebf-491">Noter container-IDen.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="b4ebf-492">Angi følgende verdier på **Varepakking** -hurtigfanen:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="b4ebf-493">**Antall:** *1*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="b4ebf-494">**Identifikator:** Vare *A0001*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="b4ebf-495">I handlingsruten velger du **Lukk container**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="b4ebf-496">I dialogboksen **Lukk container** velger du **Hent systemvekt** for å få systemet til å oppdatere **Bruttovekt** -feltet.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="b4ebf-497">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-497">Select **OK**.</span></span> <span data-ttu-id="b4ebf-498">Containeren flyttes til *SORTER* -plasseringen og er klar til sortering.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="b4ebf-499">Pakkesalgsordre 2 i containere</span><span class="sxs-lookup"><span data-stu-id="b4ebf-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="b4ebf-500">På siden **Pakke** i feltet **Lisensplate eller forsendelse** angir du målnummerskiltet for linje 1 for salgsordre 2.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="b4ebf-501">Deretter velger du **Tab** - eller **Enter** -tasten på tastaturet for å gå ut av feltet.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="b4ebf-502">I handlingsruten velger du **Ny container**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="b4ebf-503">Godta alle standardinnstillingene, og velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="b4ebf-504">Noter container-IDen.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="b4ebf-505">Angi følgende verdier på **Varepakking** -hurtigfanen:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="b4ebf-506">**Antall:** *1*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="b4ebf-507">**Identifikator:** Vare *A0001*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="b4ebf-508">I handlingsruten velger du **Lukk container**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="b4ebf-509">I dialogboksen **Lukk container** velger du **Hent systemvekt** for å få systemet til å oppdatere **Bruttovekt** -feltet.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="b4ebf-510">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-510">Select **OK**.</span></span> <span data-ttu-id="b4ebf-511">Containeren flyttes til *SORTER* -plasseringen og er klar til sortering.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="b4ebf-512">I feltet **Lisensplate eller forsendelse** angir du målnummerskiltet for linje 2 for salgsordre 2.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="b4ebf-513">Deretter velger du **Tab** - eller **Enter** -tasten på tastaturet for å gå ut av feltet.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="b4ebf-514">I handlingsruten velger du **Ny container**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="b4ebf-515">Godta alle standardinnstillingene, og velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="b4ebf-516">Noter container-IDen.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="b4ebf-517">Angi følgende verdier på **Varepakking** -hurtigfanen:</span><span class="sxs-lookup"><span data-stu-id="b4ebf-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="b4ebf-518">**Antall:** *1*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="b4ebf-519">**Identifikator-felt:** Vare *A0002*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="b4ebf-520">I handlingsruten velger du **Lukk container**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="b4ebf-521">I dialogboksen **Lukk container** velger du **Hent systemvekt** for å få systemet til å oppdatere **Bruttovekt** -feltet.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="b4ebf-522">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-522">Select **OK**.</span></span> <span data-ttu-id="b4ebf-523">Containeren flyttes til *SORTER* -plasseringen og er klar til sortering.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="b4ebf-524">Hvis du vil vise containerdetaljene, går du til **Lagerstyring \> Pakking og containerbruk \> Containere** og søker etter container-IDene som ble opprettet under pakking.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers** , and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="b4ebf-525">Sortere containerne</span><span class="sxs-lookup"><span data-stu-id="b4ebf-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="b4ebf-526">Når du får tilgang til **Palleversjon** i menyelementet på mobilappen for å utføre utgående sortering, vil du se en knapp som er merket som **Full**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="b4ebf-527">*Ikke bruk **Full** -knappen til å sortere eller lukke posisjonen.*</span><span class="sxs-lookup"><span data-stu-id="b4ebf-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="b4ebf-528">**Full** -knappen er angitt som standard og kan ikke deaktiveres eller fjernes fra siden.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="b4ebf-529">Den brukes ikke for funksjonen *Utgående sortering*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="b4ebf-530">Sortere den første containeren</span><span class="sxs-lookup"><span data-stu-id="b4ebf-530">Sort the first container</span></span>

1. <span data-ttu-id="b4ebf-531">På den mobile enheten logger du på lager *62* ved hjelp av bruker-IDen du opprettet for dette scenariet (eller bruker-IDen for en eksisterende demodatabruker).</span><span class="sxs-lookup"><span data-stu-id="b4ebf-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="b4ebf-532">I hovedmenyen velger du **Utgående**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="b4ebf-533">I **Utgående** -menyen velger du **Palleversjon**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="b4ebf-534">I **LP/Con** -feltet angir du den første container-IDen som er tilknyttet salgsordre 1.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="b4ebf-535">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-535">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-536">Fordi det ikke finnes noen sorteringsposisjoner, må du angi en.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="b4ebf-537">I **Sporteringsposisjon-ID** -feltet angir du *SP01*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="b4ebf-538">Fordi ingen nummerskilt er knyttet til sorteringsposisjon *SP01* , må du angi et.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-538">Because no LP is currently associated with sort position *SP01* , you must specify one.</span></span> <span data-ttu-id="b4ebf-539">I feltet **Nummerskilt** angir du *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="b4ebf-540">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-540">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-541">Siden validering av sorteringsposisjon er slått på, må du angi ID for sorteringsposisjon på nytt.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="b4ebf-542">I **Sporteringsposisjon-ID** -feltet angir du *SP01*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="b4ebf-543">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-543">Select **OK**.</span></span>

    <span data-ttu-id="b4ebf-544">Du mottar en Arbeid fullført-melding.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="b4ebf-545">Hvis du vil vise sorteringsposisjonen og nummerskiltet i den, går du til **Lagerstyring \> Pakking og containerbruk \> Posisjonstilordninger for utgående sortering**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="b4ebf-546">Siden **Posisjonstilordninger for utgående sortering** viser alle sorteringsposisjonene som for øyeblikket er aktive.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="b4ebf-547">Feltet **Transaksjoner for sorteringsposisjon** viser nummerskiltet som er knyttet til hver sorteringsplassering, og containerne som finnes i sorteringsposisjonen.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="b4ebf-548">Legg merke til at det allerede finnes én sorteringsposisjon, og at hurtigfanen **Kriterier for sorteringsposisjon** viser et vilkår for **Forsendelse – Transportørtjeneste - Fly**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="b4ebf-549">Sortere de resterende containerne</span><span class="sxs-lookup"><span data-stu-id="b4ebf-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="b4ebf-550">På den mobile enheten logger du på lager *62* ved hjelp av bruker-IDen du opprettet for dette scenariet (eller bruker-IDen for en eksisterende demodatabruker).</span><span class="sxs-lookup"><span data-stu-id="b4ebf-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="b4ebf-551">I hovedmenyen velger du **Utgående**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="b4ebf-552">I **Utgående** -menyen velger du **Palleversjon**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="b4ebf-553">I **LP/Con** -feltet angir du den andre container-IDen som er tilknyttet salgsordre 1.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="b4ebf-554">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-554">Select **OK**.</span></span> <span data-ttu-id="b4ebf-555">Siden sorteringsmalen er satt opp til å sortere automatisk, og det allerede finnes en sorteringsposisjon som har samsvarende vilkår, blir du automatisk dirigert til riktig sorteringsposisjon.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="b4ebf-556">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-556">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-557">Bekreft sorteringsposisjons-IDen for å angi at lageret er på riktig sted.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="b4ebf-558">I **Sporteringsposisjon-ID** -feltet angir du *SP01*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="b4ebf-559">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-559">Select **OK**.</span></span>

    <span data-ttu-id="b4ebf-560">Arbeid er fullført på den andre containeren fra salgsordre 1.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="b4ebf-561">Du skal nå sortere de gjenstående containerne fra salgsordre 2.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="b4ebf-562">I **LP/Con** -feltet angir du container-IDen til containeren fra salgsordre 2 som inneholder vare *A0001*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="b4ebf-563">Fordi transportørtjenesten er forskjellig, blir du bedt om å angi en ny sorteringsposisjon og tilordne et nummerskilt til denne posisjonen.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="b4ebf-564">Bruk sorteringsposisjon *SP02* og nummerskilt *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="b4ebf-565">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-565">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-566">Bekreft sorteringsposisjonen ved å angi *SP02* i feltet **Sporteringsposisjon**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="b4ebf-567">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-567">Select **OK**.</span></span>

    <span data-ttu-id="b4ebf-568">Arbeidet er fullført på containeren.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="b4ebf-569">I **LP/Con** -feltet angir du container-IDen til den gjenværende containeren fra salgsordre 2 som inneholder vare *A0002*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="b4ebf-570">Fordi transportørtjenesten er den samme som transportørtjenesten for salgsordre 1, viser systemet den eksisterende sorteringsposisjonen som har samsvarende kriterier.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="b4ebf-571">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-571">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-572">Bekreft sorteringsposisjonen ved å angi *SP01* i feltet **Sporteringsposisjon**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="b4ebf-573">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-573">Select **OK**.</span></span>

    <span data-ttu-id="b4ebf-574">Arbeidet er fullført på containeren.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="b4ebf-575">Lukke den utgående sorteringsposisjonen</span><span class="sxs-lookup"><span data-stu-id="b4ebf-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="b4ebf-576">Når hele lageret er sortert, må posisjonen lukkes før arbeidet kan opprettes.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="b4ebf-577">Sortert lagerplukkingsarbeid vil bli opprettet for å ta lageret til rampedøren.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="b4ebf-578">Lukke en posisjon fra den mobile enheten</span><span class="sxs-lookup"><span data-stu-id="b4ebf-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="b4ebf-579">På den mobile enheten logger du på lager *62* ved hjelp av bruker-IDen du opprettet for dette scenariet (eller bruker-IDen for en eksisterende demodatabruker).</span><span class="sxs-lookup"><span data-stu-id="b4ebf-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="b4ebf-580">I hovedmenyen velger du **Utgående**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="b4ebf-581">I **Utgående** -menyen velger du **Palleversjon**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="b4ebf-582">I **LP/con** -feltet angir du en container-ID som ble sortert for å sortere posisjonen *SP01*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="b4ebf-583">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-583">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-584">Du får følgende melding: "Containeren er allerede sortert til posisjon SP01.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="b4ebf-585">Vil du lukke posisjonen?"</span><span class="sxs-lookup"><span data-stu-id="b4ebf-585">Close the position?"</span></span> <span data-ttu-id="b4ebf-586">Velg **Lukk**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-586">Select **Close**.</span></span>

    <span data-ttu-id="b4ebf-587">Arbeidet er fullført.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="b4ebf-588">Lukke en posisjon fra utgående sorteringsposisjonstilordninger</span><span class="sxs-lookup"><span data-stu-id="b4ebf-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="b4ebf-589">Gå til **Lagerstyring \> Pakking og containerbruk \> Posisjonstilordninger for utgående sortering**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="b4ebf-590">I venstre kolonne velger du **SP02**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="b4ebf-591">Denne utgående sorteringsposisjonsraden er den du vil lukke.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="b4ebf-592">I handlingsruten velger du **Lukk posisjon**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="b4ebf-593">Sorteringsposisjons posten er lukket og vises ikke lenger.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="b4ebf-594">Hvis du vil vise alle poster med lukkede posisjoner, merker du av for **Vis lukket**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="b4ebf-595">Sortert lagerhenting</span><span class="sxs-lookup"><span data-stu-id="b4ebf-595">Sorted inventory picking</span></span>

<span data-ttu-id="b4ebf-596">Du må fylle ut det sorterte lagerplukkingsarbeidet.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="b4ebf-597">Når det er fullført, blir lageret plukket lageret til salgsordren.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="b4ebf-598">På dette tidspunktet gjelder alle andre lagerprosesser.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="b4ebf-599">På den mobile enheten logger du på lager *62* ved hjelp av bruker-IDen du opprettet for dette scenariet (eller bruker-IDen for en eksisterende demodatabruker).</span><span class="sxs-lookup"><span data-stu-id="b4ebf-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="b4ebf-600">I hovedmenyen velger du **Utgående**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="b4ebf-601">På menyen **Utgående** velger du **Last fra sortering**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="b4ebf-602">Angi mål-IDen for nummerskilt fra den første sorteringsposisjonen, *SP01*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="b4ebf-603">Angi **ID** -feltet til *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="b4ebf-604">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-604">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-605">Siden **Sortert lagerplukking: Plukk** viser plukkarbeidet som må utføres.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="b4ebf-606">Plukk fra *SORTER* -lokasjonen og målnummerskiltet *PLP01* , som har flere varer og et antall på *3*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-606">Pick from the *SORT* location and target LP *PLP01* , which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="b4ebf-607">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-607">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-608">Siden **Sortert lagerplukking: Plasser** viser plasseringsarbeidet som må utføres.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="b4ebf-609">Plasser til *Rampedør* -lokasjonen og målnummerskilt *PLP01* , som har flere varer og et antall på *3*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-609">Put to the *Baydoor* location and target LP *PLP01* , which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="b4ebf-610">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-610">Select **OK**.</span></span>

    <span data-ttu-id="b4ebf-611">Arbeidet er fullført.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-611">Work is completed.</span></span>

1. <span data-ttu-id="b4ebf-612">Angi målnummerskilt-ID-en fra den andre sorteringsposisjonen, *SP02*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="b4ebf-613">Angi **ID** -feltet til *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="b4ebf-614">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-614">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-615">Siden **Sortert lagerplukking: Plukk** viser plukkarbeidet som må utføres.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="b4ebf-616">Plukk fra *SORTER* -lokasjonen og målnummerskiltet *PLP02* , som har flere varer og et antall på *1*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-616">Pick from the *SORT* location and target LP *PLP02* , which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="b4ebf-617">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-617">Select **OK**.</span></span>
1. <span data-ttu-id="b4ebf-618">Siden **Sortert lagerplukking: Plasser** viser plasseringsarbeidet som må utføres.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="b4ebf-619">Plasser til *Rampedør* -lokasjonen og målnummerskilt *PLP02* , som har flere varer og et antall på *1*.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-619">Put to the *Baydoor* location and target LP *PLP02* , which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="b4ebf-620">Velg **OK**.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-620">Select **OK**.</span></span>

    <span data-ttu-id="b4ebf-621">Arbeidet er fullført.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-621">Work is completed.</span></span>

<span data-ttu-id="b4ebf-622">På dette tidspunktet og fremover gjelder alle andre lagerprosesser.</span><span class="sxs-lookup"><span data-stu-id="b4ebf-622">From this point forward, all other warehouse processes apply.</span></span>
