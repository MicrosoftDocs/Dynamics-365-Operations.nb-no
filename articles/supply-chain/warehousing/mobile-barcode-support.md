...
<span data-ttu-id="feffe-108">Lagerappen for Microsoft Dynamics 365 for Finance and Operations og testet sammen med en rekke enheter som kjører Android for strekkodeskanning.</span><span class="sxs-lookup"><span data-stu-id="feffe-108">The Warehousing app for Microsoft Dynamics 365 for Finance and Operations has been tested with a selection of Android powered devices for bar code scanning.</span></span> <span data-ttu-id="feffe-109">Disse testene dekker bare et utvalg av enhetene som er tilgjengelige på markedet.</span><span class="sxs-lookup"><span data-stu-id="feffe-109">These tests only cover a sample of the devices that are available on the market.</span></span>

<span data-ttu-id="feffe-110">Som kunde anbefaler vi at du tester lagermobilappen for skanning på valgt maskinvare før du bestemmer deg for maskinvaren som du vil kjøpe.</span><span class="sxs-lookup"><span data-stu-id="feffe-110">As a customer, we recommend that you test the Warehouse mobile scanning app on selected hardware before you decide on the hardware that you want to buy.</span></span>
