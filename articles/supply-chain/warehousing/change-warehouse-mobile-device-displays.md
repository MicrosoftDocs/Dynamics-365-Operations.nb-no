...
ms.locfileid: "859765"
---
# <a name="warehouse-mobile-device-display-settings"></a>Innstillinger for visning av lagermobilenhet

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Denne funksjonen er foreldet. Hvis du vil ha mer informasjon, kan du se [Funksjoner som er fjernet eller avskrevet](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
