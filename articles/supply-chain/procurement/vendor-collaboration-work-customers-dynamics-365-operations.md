...
description: "Dette emnet beskriver hvordan du kan bruke leverandørsamarbeid i Microsoft Dynamics 365 for Finance and Operations, Enterprise edition, for å arbeide med bestillinger og overvåke forsendelseslager."
author: mkirknel
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
Dette emnet beskriver hvordan du kan bruke leverandørsamarbeid for å arbeide med kunder i Microsoft Dynamics 365 for Finance and Operations, Enterprise edition. Leverandører kan utføre en rekke forretningsprosesser fra følgende arbeidsområder:
...
- **Alle bekreftede bestillinger** – Denne siden inneholder alle bestillinger som er bekreftet. Bestillingene på denne siden omfatter bestillinger der produkter eller tjenester er mottatt. Du kan bruke denne listen til å overvåke bestillinger som du kan sende fakturaer for.
...
**Obs!** Denne funksjonaliteten er bare tilgjengelig hvis konfigurasjon for offentlig sektor er aktivert.

### <a name="bidding"></a>Legge inn bud

- Klikk på **Bud** for å by på en tilbudsforespørsel.
