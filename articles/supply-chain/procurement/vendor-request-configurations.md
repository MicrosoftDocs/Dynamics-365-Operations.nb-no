...
3. <span data-ttu-id="41001-114">Skjult (ikke synlige)</span><span class="sxs-lookup"><span data-stu-id="41001-114">Hidden (Not visible)</span></span>
4. <span data-ttu-id="41001-115">Vises (synlige, men ikke obligatoriske)</span><span class="sxs-lookup"><span data-stu-id="41001-115">Displayed (Visible but not mandatory)</span></span>
5. <span data-ttu-id="41001-116">Obligatorisk (synlig og obligatorisk)</span><span class="sxs-lookup"><span data-stu-id="41001-116">Required (Visible and mandatory)</span></span>
6. <span data-ttu-id="41001-117">Klikk på **Innhold**-fanen for å angi om teksten skal vises i veiviseren, og om det skal være en bekreftelse som den potensielle leverandørbrukeren må godta før neste trinn i veiviseren.</span><span class="sxs-lookup"><span data-stu-id="41001-117">Click the **Content** tab to specify if text is going to be shown on the wizard and if there should be an acknowledgement that the prospective vendor user must accept this before moving to the next step in the wizard.</span></span> <span data-ttu-id="41001-118">Det vil bli bedt om bekreftelse for alle vilkårene som brukeren må godta for å fortsette.</span><span class="sxs-lookup"><span data-stu-id="41001-118">The acknowledgement will be requested for any terms and conditions that the user must accept to continue.</span></span>
