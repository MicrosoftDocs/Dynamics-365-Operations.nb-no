...
1. Gå til **navigasjonsruten > Moduler > Innkjøp og leverandører > Forsendelse > Innkjøpskategorier**.
2. I handlingsruten velger du **Rediger kategorihierarki**. Gjeldende innkjøpskategorihierarki vises til venstre på siden. Du er i ferd med å endre hierarkiet.  
3. I handlingsruten velger du **Ny kategorinode**. Den øverste noden velges som standard. Hvis du bruker denne fremgangsmåten som oppgaveveiledning, kan du klikke knappen Lås opp og velge en annen overordnet node som du vil sette inn den ny noden i. Når det er gjort, låser du oppgaveveiledningen på nytt, og klikker deretter Ny kategorinode.  
4. Skriv inn en verdi i **Navn**-feltet.
5. Skriv inn en verdi i **Beskrivelse**-feltet.
6. Skriv inn en verdi i feltet **Egendefinert navn**. Det egendefinerte navnet er valgfritt. Det vises i kategorioppslag sammen med navnet på kategorien.  
7. Velg **Lagre**.

## <a name="add-products-to-your-new-procurement-category"></a>Legge til produkter i den nye innkjøpskategorien
1. Gå til **Innkjøp og leverandører > Forsendelse > Innkjøpskategorier**. Merk noden du nettopp la til. Hvis du kjører denne prosedyren som en oppgaveveiledning, må du kanskje låse opp i oppgaveveiledningen for å velge noden.  
2. Aktiver/deaktiver visning av delen **Produkter**.
3. Velg **Legg til** for å knytte produkter til innkjøpskategorien.
