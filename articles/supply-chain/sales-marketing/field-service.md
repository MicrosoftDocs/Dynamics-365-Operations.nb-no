...
description: Denne artikkelen inneholder en oversikt over integreringen med Microsoft Dynamics 365 Field Service.
author: Henrikan
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
- Dynamics 365 Finance and Operations versjon 8.1.2 (desember 2018) ble utgitt i desember 2018 og har programbuild-nummer 8.1.195 med plattformoppdatering 22 (7.0.5095). 
