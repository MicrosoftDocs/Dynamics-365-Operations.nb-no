...
description: Denne artikkelen drøfter maler og underliggende oppgaver som brukes til å kjøre synkronisering av salgsordrer direkte mellom Dynamics 365 Sales og Dynamics 365 Supply Chain Management.
author: Henrikan
ms.date: 05/09/2019
ms.topic: article
ms.prod: ''
...
Denne artikkelen drøfter maler og underliggende oppgaver som brukes til å kjøre synkronisering av salgsordrer direkte mellom Dynamics 365 Sales og Dynamics 365 Supply Chain Management.
...
[![Maltilordning i Dataintegrering, Salgsordrer (Supply Chain Management til Sales) - Direct: OrderHeader.](./media/sales-order-direct-template-mapping-data-integrator-1.png)](./media/sales-order-direct-template-mapping-data-integrator-1.png)
...
[![Maltilordning i Dataintegrering, Salgsordrer (Supply Chain Management til Sales) - Direct: OrderLine.](./media/sales-order-direct-template-mapping-data-integrator-2.png)](./media/sales-order-direct-template-mapping-data-integrator-2.png)
...
[![Maltilordning i Dataintegrering, Salgsordrer (Sales til Supply Chain Management) - Direct: OrderHeader.](./media/sales-order-direct-template-mapping-data-integrator-3.png)](./media/sales-order-direct-template-mapping-data-integrator-3.png)
...
[![Maltilordning i Dataintegrering, Salgsordrer (Sales til Supply Chain Management) - Direct: OrderLine.](./media/sales-order-direct-template-mapping-data-integrator-4.png)](./media/sales-order-direct-template-mapping-data-integrator-4.png)
