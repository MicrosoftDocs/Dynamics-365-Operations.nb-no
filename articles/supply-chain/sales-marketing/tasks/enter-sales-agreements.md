...
description: Denne artikkelen viser hvordan du oppretter en salgsavtale som forplikter en av kundene dine til å kjøpe et produkt til et avtalt beløp over tid, i bytte mot spesialrabatter.
author: Henrikan
ms.date: 08/08/2019
...
ms.locfileid: "8897494"
---
# <a name="enter-sales-agreements"></a>Angi salgsavtaler

[!include [banner](../../includes/banner.md)]

Denne artikkelen viser hvordan du oppretter en salgsavtale som forplikter en av kundene dine til å kjøpe et produkt til et avtalt beløp over tid, i bytte mot spesialrabatter. Du kan kjøre denne fremgangsmåten i demonstrasjonsselskapet USMF eller ved hjelp av dine egne data.
