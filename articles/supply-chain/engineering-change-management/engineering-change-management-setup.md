...
description: Denne artikkelen beskriver hvordan du kan opprette vanlige verdier som brukes for parametere i forskjellige deler av behandling av teknisk endring.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
