...
### <a name="enable-or-disable-readiness-checks-on-standard-products"></a>Aktivere eller deaktivere klargjøringskontroller for standardprodukter

Denne funksjonen krever at funksjonene *Behandling av teknisk endring* og *Produktklargjøringskontroller* er aktivert for systemet. Hvis du vil ha mer informasjon om hvordan du aktiverer eller deaktiverer disse funksjonene, kan du se [Oversikt over behandling av teknisk endring](product-engineering-overview.md).
