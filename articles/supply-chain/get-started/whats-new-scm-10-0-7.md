...
---
# <a name="whats-new-and-changed-in-dynamics-365-supply-chain-management-1007-january-2020"></a>Hva er nytt eller endret i Dynamics 365 Supply Chain Management 10.0.7 (januar 2020)

[!include [banner](../includes/banner.md)]


Dette emnet beskriver funksjoner som enten er nye eller endret i Microsoft Dynamics 365 Supply Chain Management 10.0.7. Denne versjonen har et build-nummer 10.0.283, og er tilgjengelig som følger:

- Forhåndsversjonen er i oktober 2019.
- Generell tilgjengelighet (selvopptatering) er i november 2019.
- Automatisk oppdatering er i januar 2020. 

Hvis du vil ha mer informasjon om versjon 10.0.7, se [Tilleggsressurser](whats-new-scm-10-0-7.md#additional-resources).
...
Microsoft Dynamics 365 Supply Chain Management 10.0.7 inkluderer plattformoppdatering 31. Hvis du vil vite mer om plattformoppdatering 31, se [Hva er nytt eller endret i plattformoppdatering 31](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-31.md).
