...
description: Denne artikkelen beskriver hvordan du kan bruke varesporing til å identifisere hvor varer eller råmaterialer er brukt, er i bruk, eller vil bli brukt i produksjon og salgsprosesser.
author: yufeihuang
ms.date: 11/02/2017
ms.topic: article
ms.prod: ''
...
Denne artikkelen beskriver hvordan du kan bruke varesporing til å identifisere hvor varer eller råmaterialer er brukt, er i bruk, eller vil bli brukt i produksjon og salgsprosesser.
