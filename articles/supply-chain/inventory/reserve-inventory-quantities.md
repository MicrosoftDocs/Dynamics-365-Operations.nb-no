...
description: Denne artikkelen beskriver de forskjellige alternativene som er tilgjengelige for reservering av lager.
author: yufeihuang
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Denne artikkelen beskriver de forskjellige alternativene som er tilgjengelige for reservering av lager.
