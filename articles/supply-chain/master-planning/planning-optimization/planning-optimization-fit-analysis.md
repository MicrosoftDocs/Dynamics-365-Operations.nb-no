...
| Prognose | Dekningsgrupper med "Ta med konserninterne ordrer" aktivert: _\#_ | Dette funksjonen venter. For øyeblikket inkluderer ikke hovedplanlegging nedstrøms planlagt behov når planleggingsoptimalisering er aktivert, uavhengig av denne innstillingen. Merk at frigitte/autoriserte ordrer fremdeles fungerer med den vanlige konserninterne funksjonaliteten, og vil dekke de fleste scenarier. | I forhåndsvisning |
