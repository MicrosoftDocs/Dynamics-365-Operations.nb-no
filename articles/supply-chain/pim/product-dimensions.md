...
Produktversjoner opprettes vanligvis for bestemte versjoner etter hvert som produktet utvikles i løpet av livssyklusen. Produktversjoner dekkes i detalj senere i dette emnet.
...
1. **Microsoft Dynamics 365 Commerce-funksjonalitet:** Når dette er aktivert, vil versjonsdimensjonen vises i hele den Commerce-spesifikke koden i Dynamics 365 Supply Chain Management. Versjonsdimensjonen støttes imidlertid ikke av Commerce-kanaldatabasen eller i salgsstedsapper (POS). Denne virkemåten ligner på den gjeldende virkemåten til konfigurasjonsdimensjonen i hele Commerce.
