...
Hvis du skriver inn "høyt 05", vil du ikke får noen treff. Dette skyldes at det søkes etter den fullstendige teksten som er angitt. Søket prøver ikke å finne "høyt" og deretter avgrense resultatene til de som inneholder "05".  
...
Eksempler på ID-er og dimensjoner for produkter og produktvarianter som du kan søke etter, er **Produktnavn, Varenummer**, **Visningsproduktnummer, Konfigurasjon, Farge, Størrelse, Stil, Søkenavn og så videre**.  
...
På siden **Søkekriterier** klikker du på knappen **Oppdater søkedata**. I dialogboksen **Oppdater søkedata** kontrollerer du at **Kilde** er satt til **Produkt** og klikker deretter på **OK**. Systemet vil slå sammen alle søkekriterier som er angitt i trinn 1, i én tabell. Hvis du har mange produkter og produktvarianter, kan denne operasjonen ta ganske lang tid, og du får kanskje en advarsel. Det anbefales at du planlegger utfylling av søketabellen på den satsvise serveren på et tidspunkt da serveren ikke er for opptatt.  
...
Du kan aktivere denne funksjonaliteten ved å gå til **Salg og markedsføring &gt; Oppsett &gt; Søk &gt; Søkeparametere** og sette **Aktiver oppslag for søk** til **Ja** i **Generelt**-fanen.  

For registrering av salgsordrelinje er standard virkemåte at siden **Produktsøk** åpnes når du begynner å skrive i feltet **Varenummer**, og du trykker deretter på **TAB**-tasten. Siden **Produktsøk** endrer konteksten under oppretting av ordrelinjer, og kan anses som unødvendig påtrengende. Hvis du foretrekker å få søkeresultatene i et oppslag og ikke miste kontekst under ordrelinjeregistrering, kan du i stedet bruke søkeoppslaget. Hvis du søker etter et produkt eller en produktvariant, men ikke velger noe i oppslaget og trykker på **TAB**-tasten, vises siden **Produktsøk**.
