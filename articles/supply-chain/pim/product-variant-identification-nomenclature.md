...
description: Denne artikkelen beskriver hvordan du kan definere en produktnummerterminologi for å erstatte det faste formatet [Produktstandardnummer - Konfigurasjon - Størrelse - Farge - Stil].
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
