...
**Eksempel 1 – tidsbasert vedlikeholdsplanlinje**: En smørejobb kan settes opp med et fast intervall, og skjer én gang i uken. For dette formålet kan du velge Gjentatt fra plandato i **Intervall type**-feltet, som vist i figuren nedenfor.

![Figur 2](media/02-preventive-maintenance.png)

**Eksempel 2 – tidsbasert vedlikeholdsplanlinje** : En inspeksjonsjobb kan defineres til å utføres omtrent én gang i uken. For dette formålet kan du velge Gjentatt fra siste arbeidsordre i **Intervall type**-feltet, som vist i figuren nedenfor.

![Figur 3](media/03-preventive-maintenance.png)

**Eksempel 3 – tellerbasert vedlikeholdsplanlinje** : En grafisk illustrasjon av en timeteller som det opprettes en ny vedlikeholdsplanlinje for hver gang det har gått 250 timer. Intervalltypen for denne tellerbaserte linjen er Gjentatt fra startdato. Startdatoen er startdatoen for de tilknyttede aktivaene i **Alle aktiva**-detaljvisningen > **Vedlikeholdsplaner for aktivum**-hurtigfanen > **Startdato**-feltet, eller i detaljvisningen **Arbeidssted** > **Vedlikeholdsplaner**-hurtigfanen > **Startdato**-feltet. Dette er et eksempel på en *forebyggende* vedlikeholdsplan fordi vedlikeholdsplanlinjen opprettes automatisk hver gang terskelen (+ 250) nås. Figuren nedenfor viser et grafisk eksempel.

![Figur 4](media/04-preventive-maintenance.png)


**Eksempel 4 – tellerbasert vedlikeholdsplanlinje** : En grafisk illustrasjon av en reduksjon i tellerverdi, som måler bremseklosslitasje. En vedlikeholdsplanlinje opprettes når en tellerregistrering under 20 mm opprettes for bremseklossen. Intervalltypen for denne tellerbaserte linjen er "Når nådd under" eller "Én gang fra siste startdato". Dette er et eksempel på en *reaktiv* vedlikeholdsplan fordi vedlikeholdsplanlinjen opprettes ikke før en måling under 20 mm registreres. Figuren nedenfor viser et grafisk eksempel.

![Figur 5](media/05-preventive-maintenance.png)


**Eksempel 5 – tellerbasert vedlikeholdsplanlinje** : En grafisk illustrasjon av en teller med en terskel på -18 ° Celsius. En vedlikeholdsplanlinje opprettes når det gjøres en tellerregistrering over -18 ° Celsius. Intervalltypen for denne tellerbaserte linjen er Når nådd over. Dette er et eksempel på en *reaktiv* vedlikeholdsplan fordi vedlikeholdsplanlinjen opprettes ikke før en måling høyere enn -18 ° Celsius registreres. Figuren nedenfor viser et grafisk eksempel.
