...
- En ny type vedlikeholdsplanintervall som kalles *Gjentatt for samlet verdi (bare teller)*. Denne typen utløser vedlikehold hver gang en aggregert teller når et multiplum av en bestemt verdi. Vedlikehold kan for eksempel utløses hver 10 000. time. Hvis du vil ha mer informasjon, kan du se delen [Oversikt over intervalltyper](#interval-types) tidligere i dette emnet.
...
- **Modul:** *Aktivastyring*
- **Funksjonsnavn:** *(Forhåndsversjon) Tellerbaserte vedlikeholdsforbedringer*
