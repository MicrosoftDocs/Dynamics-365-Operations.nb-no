...
description: Denne artikkelen beskriver oppgaver som må utføres før du kjører en standard kostnadskonvertering.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
Denne artikkelen beskriver oppgaver som må utføres før du kjører en standard kostnadskonvertering. 
