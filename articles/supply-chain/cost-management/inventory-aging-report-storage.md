...
description: Denne artikkelen beskriver funksjonaliteten som lar deg kjøre en rapport for aldersfordeling for lager, og gjør utdataene tilgjengelige som et skjema og et diagram.
author: JennySong-SH
ms.date: 11/11/2019
ms.topic: article
ms.prod: ''
