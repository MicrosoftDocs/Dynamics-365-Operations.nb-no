...
I illustrasjonen nedenfor (a) er stykklisten for produkt H og der F og G, og (b) er rutearket for produkt H-og del F.

![Eksempel på en stykklistestruktur i to nivåer.](media/product-H-part-F.png)
...
![Konstruksjonsstykklisten for produkt H.](media/product-H-part-B.png)
...
![Fantomlinjetypen som brukes i stykklistestrukturer med flere nivåer.](media/product-G-route-sheet-G.png)
...
![Eksempel på et rutenettverk som brukes i en stykkliste med flere nivåer.](media/product-G-part-F.png)

I illustrasjonen nedenfor (a) er stykklisten for produkt G og del F, og (b) er rutearket for produkt G-og del F.

![Stykklisten for produkt G og del F, og rutearket for produktet G og del F.](media/product-G-part-F-with-route-sheet.png)
