...
ms.locfileid: "6713596"
---
# <a name="time-and-attendance-registration-overview"></a>Oversikt over timeregistreringsarbeidere
...
| **Obs!**                                                                                                                                                                                                                      |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| En arbeider kan automatisk tilordnes tidsregistreringer som er gjort på en bestemt maskin på produksjonsgulvet, hvis arbeideren velger å arbeide som assistent for maskinen når vedkommende starter produksjonsjobben. |
