...
description: Denne artikkelen inneholder informasjon om integrering med data som administreres av Human Resources.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
...
Denne artikkelen inneholder informasjon for integrering med data som administreres av Dynamics 365 Human Resources. Den beskriver forskjellige typer integreringsteknologi som hjelper deg med å finne ut hvilke typer som passer best til dine behov.
