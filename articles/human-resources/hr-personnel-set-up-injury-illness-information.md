...
2. Klikk Ny.
3. Skriv inn en verdi i feltet Skade- eller sykdomstype.
    * Eksempel: Brudd  
4. Skriv inn en verdi i feltet Beskrivelse.
    * Eksempel: Beinbrudd  
5. Klikk kategorien Kroppsdeler.
6. Klikk Ny.
7. Skriv inn en verdi i Kroppsdeler-feltet.
    * Eksempel: Håndledd  
8. Skriv inn en verdi i feltet Beskrivelse.
    * Eksempel: Håndledd  
9. Klikk kategorien Behandlingstyper.
10. Klikk Ny.
11. Skriv inn en verdi i Behandlingstype-feltet.
    * Eksempel: Skinne  
12. Skriv inn en verdi i feltet Beskrivelse.
    * Eksempel: Legge på en skinne  
13. Klikk kategorien Kostnadstyper.
14. Klikk Ny.
15. Skriv inn en verdi i Kostnadstype-feltet.
    * Eksempel: Røntgenbilder  
16. Skriv inn en verdi i feltet Beskrivelse.
    * Eksempel: Røntgenbilder  
17. Klikk kategorien Utfallstyper.
18. Klikk Ny.
19. Skriv inn en verdi i Utfallstype-feltet.
    * Eksempel: Psykolog  
20. Skriv inn en verdi i feltet Beskrivelse.
    * Eksempel: Fysioterapi  
21. Klikk kategorien Alvorlighetsnivåer.
    * Det kan opprettes sikkerhetsnivåer som kan tilpasses. For eksempel: Alvorsgrad 1 betyr en mindre skade, der alvorsgrad 3 kan indikere en alvorlig skade.  
