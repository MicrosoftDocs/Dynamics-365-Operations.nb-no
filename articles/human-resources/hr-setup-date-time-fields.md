...
---
# <a name="understand-date-and-time-fields"></a>Forstå dato- og klokkeslettfelt

**Dato og klokkeslett**-felt er et grunnleggende begrep i Dynamics 365 Human Resources. Det er viktig å forstå hvordan du arbeider med **Dato og klokkeslett**-data i Dynamics 365 Human Resources-skjemaer, Common Data Service og eksterne kilder.
