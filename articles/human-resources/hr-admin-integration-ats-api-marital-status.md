...
ms.locfileid: "5467681"
---
# <a name="marital-status"></a>Sivilstand

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

I dette emnet beskrives alternativetsettet for Sivilstand for Dynamics 365 Human Resources.

Fysisk navn: mshr_dirpersonmaritalstatus

Denne opplistingen gir alternativsettet for sivilstand for personposter.

| Verdi | Etikett | beskrivelse |
| --- | --- | --- |
| 200000000 | None | Ingen verdi er valgt.
| 200000001 | Enslig | Enslig. |
| 200000002 | Gift | Gift. |
| 200000003 | Skilt | Skilt. |
| 200000004 | Enke/enkemann | Enke. |
