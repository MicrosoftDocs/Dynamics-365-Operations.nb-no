...
2. Bruk hurtigfilteret for å søke etter poster. Du kan for eksempel filtrere på verdien **000091** for **Stilling**-feltet.
3. Velg koblingen i den valgte raden i listen.
4. Utvid delen **Rapporterer til stilling**.
5. Velg **Ny** for å åpne dialogboksen med rullegardinliste.
6. Angi eller velg en verdi i feltet **Rapporter til**.
7. Velg **Opprett**.
8. Vis delen **Relasjoner**.
9. Velg **Legg til**.
10. Merk av i boksen til venstre i rutenettet.
11. Angi eller velg en verdi i feltet **Navn på hierarki** (for eksempel **Prosjekt**).
12. Angi eller velg en verdi i feltet **Rapporterer til stilling** (for eksempel: **000437**).
13. Velg **Lagre**.
