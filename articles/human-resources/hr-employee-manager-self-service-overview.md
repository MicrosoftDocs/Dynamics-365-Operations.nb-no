...
Hvis du vil knytte en bruker til en **Arbeider**-post, går du til **Brukere** og velger brukeren. Velg **Rediger** og legg til den tilsvarende arbeideren i feltet **Person** på siden, og velg **Lagre**. Du skal nå ha tilgang til **Ansattselvbetjening**.
...
Flisen **Avspaseringssaldoer** viser saldoene for eventuelle registrerte planer. Denne flisen forutsier saldoen basert på avsetningsmetoden. Du kan angi og sende fraværsforespørsler, som deretter vil gå gjennom en arbeidsflyt prosess for godkjenning. Hvis du vil ha mer informasjon om permisjons- og fraværsadministrasjon, kan du se [Oversikt over permisjon og fravær](hr-leave-and-absence-overview.md).

**Oppgaver**-flisen viser oppgaver som er tilordnet til deg, og lar deg vise og administrere dem.

**Neste registrerte kurs** viser det neste kurset du er registrert for. Du kan vise og registrere deg for alle åpne kurs. Alle kurs som er åpne for påmelding, har statusen **Startet**, og tillater at ansatte kan registrere seg selv. Avhengig av organisasjonens innstillinger kan kursregistreringen gå gjennom en godkjenningsprosess.

**Sertifikat**-flisen viser sertifikatet og utløpsdatoen for sertifikatet som utløper nærmest gjeldende dato. Du kan oppdatere, legge til eller fjerne sertifikater. Avhengig av organisasjonens innstillinger kan sertifikatoppdateringer gå gjennom en godkjenningsprosess.

**Neste planlagte gjennomgang** viser neste ytelsesvurdering. Du kan starte en ny gjennomgang fra denne flisen. Lederen eller HR-representanten kan også begynne gjennomganger. Avhengig av organisasjonens innstillinger vil du kanskje også kunne vise, oppdatere og sende inn avslutningsomtaler.

Du kan administrere målene med **Ytelsesmål**. Denne flisen viser hvor mange mål du har i hver status (**Ikke startet**, **I rute** og **Trenger forbedring**). Du kan opprette, oppdatere og fjerne mål, avhengig av din tilordnede rollebaserte sikkerhet. Hvis du vil, kan du legge til nye mål fra grupper eller maler. Ledere og HR-ansvarlige kan også opprette mål på vegne av ansatte og bestemme hvor detaljert hvert mål skal være. Ledere og ansatte kan samarbeide om mål, og oppdatere aktiviteter, målinger og status. Du kan også inkludere vedlegg.

Du kan vise dine eksisterende ferdigheter på **Total kompetanse**-flisen. Du kan oppdatere ferdigheter, legge til nye eller fjerne alle som ikke lenger er relevante. Avhengig av organisasjonens innstillinger kan kompetanseendringer gå gjennom en godkjenningsprosess.

Du kan vise gjeldende kompensasjon på **Kompensasjon**. Velg **Vis** for å vise årslønn og siste økningsbeløp. Hvis du er ansatt i flere enn ett firma, vises hvert enkelt årlige beløp. Hvis du vil vise den detaljerte kompensasjonsloggen, velger du det **årlige lønnsbeløpet** for å åpne siden **Fast og variabel kompentasjonslogg**. Fremtidig kompensasjon vises ikke på denne siden. Hvis du har mer enn ett ansettelsesforhold, kan du bytte mellom firmaer på denne siden for å vise kompensasjonsloggen uten å logge inn i hvert firma.

Vis og administrer dokumenter med **Vedlegg**-flisen. Du kan administrere alle **eksterne** vedlegg. Både HR og ansatte kan legge til vedlegg via siden **Ansattselvbetjening** eller **Arbeider**. Vedlegg er som standard satt til **Ekstern**.

### <a name="additional-information"></a>Tilleggsinformasjon

Denne delen inneholder koblinger til andre **Ansattselvbetjening**-områder, lik delen **Min karriereinformasjon**.
...
Du kan konfigurere brukerdefinerte koblinger i **Personalparametere**. Du kan for eksempel definere koblinger til lønnsoppgaver, årsavslutningsdokumentasjon eller eksterne løsninger. Disse koblingene vises nederst i denne delen, men du kan flytte dem ved hjelp av tilpassing.
...
Med informasjon om **mitt team** kan ledere vise og oppdatere direkte og utvidede rapporter. Hvis du vil ha tilgang til utvidede rapporter, velger du den ansatte som har direkterapporter, og deretter velger du **Vis team** på flisen. Alle de samme alternativene gjelder utvidede rapporter som direkte rapporter. 

#### <a name="summary-tab"></a>Fanen Sammendrag

Fanen **Sammendrag** gir en rask oversikt over dine direkte rapporter. Hvis en direkte underordnet også har arbeidere som rapporterer til dem, viser kortet antall direkte underordnede i den øvre delen, sammen med en **Vis team** -knapp. Alternativer over hver flis gjelder for den ansatte som er valgt. Hvis du for eksempel vil angi en permisjonsforespørsel på vegne av en ansatt, velger du den ansatte og velger deretter **Be om fritid**. 
...
Kategorien **Stilling** gir en sammendragsvisning av ansatte i deres primære stilling. Navn, flis og avdeling vises i overskriftsområdet for hver flis. Denne flisen inkluderer:

- **Ansiennitetsdato** - vises fra arbeidersammendrags-delen for **Arbeider**-siden.
...
Hvis du vil vise kompensasjonsloggen, velger du **lønnsbeløpet** for å åpne **Detaljer**-siden. Bare gjeldende og historiske, faste og variable kompensasjonsposter vises på **Kompensasjon**-siden. Hvis en ansatt har mer enn ett ansettelsesforhold, kan du bytte mellom firmaer for å vise kompensasjonslogg i hvert firma, eller aktivere kompensasjon på tvers av firmaer i **Delte parametere for personaladministrasjon** for å vise alle kompensasjonsplaner.
...
Kategorien **Permisjon og fravær** viser de øvre saldoene for ansatte som har aktivitet. Hvis du vil utføre en handling eller vise en fullstendig liste over aktiviteter, velger du **Detaljer** og deretter **Fridager**. På **Fridager**-siden kan du vise saldoer, forespørsler, godkjent fritid og prognosesaldoer for å hjelpe ansatte med å administrere tid bedre. Avhengig av organisasjonens innstillinger kan du også be om fritid for direkte rapporter og utvidede rapporter.
