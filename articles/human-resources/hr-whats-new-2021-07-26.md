...
description: Dette emnet beskriver funksjoner som enten er nye eller endret i Microsoft Dynamics 365 Human Resources for 26. juli 2021.
author: marcelbf
ms.date: 07/12/2021
ms.topic: article
ms.prod: ''
...
| --- | --- | --- |
| Plattform update 10.0.20 | -- | [Plattformoppdateringer for versjon 10.0.20 av Finance and Operations-apper (august 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-20) |
