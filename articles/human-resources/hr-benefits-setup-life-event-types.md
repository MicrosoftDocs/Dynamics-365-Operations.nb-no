...
| **Endring i ansettelsesstatus** |<br><ul><li>Arbeider > Ansettelse</li><li>Side med ansettelseslogg</li></ul> | Når det gjelder ansatte som har en eksisterende ansattdetalj, utløses en livshendelse hvis du oppretter en ny ansattdetalj med en annen ansettelsesstatus.  Hvis en eksisterende ansettelsesdetalj oppdateres med en annen ansettelsesstatus, utløses også en livshendelse.  |
| **Adresseendring for ansatt** |<br><ul><li>Arbeider > Profil > Adresser</li><li>Arbeider > Personlige opplysninger > Personlige kontakter > Adresse</li></ul> | Endring i adresse. Adressen må være **Primær** for å utløse en livshendelse. |
