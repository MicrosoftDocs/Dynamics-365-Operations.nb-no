...
description: Denne artikkelen inneholder svar på spørsmål du kan ha hvis organisasjonen bruker personalhandlinger.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
...
Denne artikkelen inneholder svar på spørsmål du kan ha hvis organisasjonen bruker personalhandlinger. Personalhandlinger er flere trinn du må fullføre når du utfører bestemte personalrelaterte oppgaver. 
