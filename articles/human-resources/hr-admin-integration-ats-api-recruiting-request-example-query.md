---
title: Eksempelspørring for rekrutteringsforespørsel
description: Dette emnet inneholder en eksempelspørring for rekrutteringsforespørselsenheten i Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "5789714"
---
# <a name="example-query-for-recruiting-request"></a><span data-ttu-id="104e6-103">Eksempelspørring for rekrutteringsforespørsel</span><span class="sxs-lookup"><span data-stu-id="104e6-103">Example query for Recruiting request</span></span>

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

<span data-ttu-id="104e6-104">Dette emnet inneholder en eksempelspørring for rekrutteringsforespørselsenheten i Dynamics 365 Human Resources.</span><span class="sxs-lookup"><span data-stu-id="104e6-104">This topic provides an example query for the Recruiting request entity in Dynamics 365 Human Resources.</span></span>

<span data-ttu-id="104e6-105">Følgende spørring viser hvordan du kan bruke $expand-spørringsalternativet i en GET-operasjon til å hente en angitt rekrutteringsforespørselspost og alle tilknyttede stillinger, nødvendige ferdigheter og krav til utdanning for den bestemte forespørselen.</span><span class="sxs-lookup"><span data-stu-id="104e6-105">The following query shows how you can use the $expand query option in a GET operation to retrieve a specified recruiting request record and all associated positions, required skills, and educational requirements for the specified request.</span></span> <span data-ttu-id="104e6-106">Eksempelsvaret viser en rekrutteringsforespørsel for to stillinger, og ønsket kompetanse og utdanning for de ønskede stillingene.</span><span class="sxs-lookup"><span data-stu-id="104e6-106">The example response shows a recruiting request for two positions, and the required skills and education for the requested positions.</span></span>

<span data-ttu-id="104e6-107">**Forespørsel**</span><span class="sxs-lookup"><span data-stu-id="104e6-107">**Request**</span></span>
...
<span data-ttu-id="104e6-108">**Svar**</span><span class="sxs-lookup"><span data-stu-id="104e6-108">**Response**</span></span>
...
## <a name="see-also"></a><span data-ttu-id="104e6-109">Se også</span><span class="sxs-lookup"><span data-stu-id="104e6-109">See also</span></span>

[<span data-ttu-id="104e6-110">Innføring i API for søkersporingssystemintegrering</span><span class="sxs-lookup"><span data-stu-id="104e6-110">Applicant Tracking System integration API introduction</span></span>](hr-admin-integration-ats-api-introduction.md)<br>
