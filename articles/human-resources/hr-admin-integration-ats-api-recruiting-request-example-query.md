...
description: Denne artikkelen inneholder en eksempelspørring for rekrutteringsforespørselsenheten i Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
Denne artikkelen inneholder en eksempelspørring for rekrutteringsforespørselsenheten i Dynamics 365 Human Resources.

Følgende spørring viser hvordan du kan bruke $expand-spørringsalternativet i en GET-operasjon til å hente en angitt rekrutteringsforespørselspost og alle tilknyttede stillinger, nødvendige ferdigheter og krav til utdanning for den bestemte forespørselen. Eksempelsvaret viser en rekrutteringsforespørsel for to stillinger, og ønsket kompetanse og utdanning for de ønskede stillingene.
