...
> [!IMPORTANT]
> Før en plantype kan vises i **Ansattselvbetjening** må den konfigureres. Hvis du vil ha mer informasjon, kan du se [Konfigurere ansattselvbetjening](/hr-benefits-setup-employee-self-service.md).
