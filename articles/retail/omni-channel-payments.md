...
Dette emnet gir en oversikt over omnikanalinnbetalinger i Microsoft Dynamics 365 for Retail. Det inneholder en omfattende liste over støttede scenarioer, informasjon om funksjonalitet, oppsett og feilsøking, og beskrivelser av enkelte vanlige problemer.
...
Alle scenarioene som beskrives i dette emnet, kan implementeres ved hjelp av standard SDK for betalinger som leveres med Retail. [Dynamics 365 Payment Connector for Adyen](https://docs.microsoft.com/dynamics365/unified-operations/retail/dev-itpro/adyen-connector?tabs=8-1-3) gir en enkel implementering av alle scenarioer som er beskrevet her. 
...
- **Omnikanalbetalingskonfigurasjon:** I back office gå til **Retail \> Hovedkvarteroppsett \> Parametere \> Delte parametere for detaljhandel**. I kategorien **Omnikanal-betalinger** setter du alternativet **Bruk betalinger for omnikanal** til **Ja**.
...
- Alternativet **Omnikanal-betalinger** på siden **Delte parametere for detaljhandel** er satt til **Sann**.
...
3. I Retail bruker du den satsvise jobben **Synkroniser ordrer** og **P-001**-distribusjonsplanen for å opprette ordrene i back office.
...
1. I Retail, på siden **Kundeservice**, angir du **Karin Berg** i søkefeltet, og deretter velger **Søk**. 
