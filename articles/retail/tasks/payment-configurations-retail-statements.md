...
---
# <a name="configure-payment-method-settings-that-affect-retail-statements"></a>Konfigurere innstillinger for betalingsmetode som påvirker detaljhandelsutdrag
