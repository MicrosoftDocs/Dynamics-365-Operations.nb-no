...
# <a name="improvements-to-statement-posting"></a>Forbedringer for utdragspostering
...
- Gå til **Systemadministrasjon** \> **Oppsett** \> **Lisenskonfigurasjon** og deretter, under **Detaljhandel**-noden fjerner du merket for **Detaljhandelsutdrag (eldre)** og merker av for **Detaljhandelsutdrag**.
...
- Brukeren har en fullstendig revisjonssporing, fra detaljhandelstransaksjoner, til salgsordrer til salgsfakturaer. Denne revisjonssporingen var ikke tilgjengelige i den eldre funksjonen for utdragspostering.
...
- Forekomsten av vranglås i transaksjonstabeller for detaljhandel reduseres ved å introdusere flere utvidelsestabeller og ved å gjøre innsettingsoperasjoner i stedet for oppdateringsoperasjoner i transaksjonstabellene for detaljhandel.
...
- Vi anbefaler at du bruker aggregering mens du beregner og posterer utdrag. Derfor anbefales følgende innstillinger for noen av aggregeringsparameterne:
    ...
    - Gå til **Detaljhandel** \> **Hovedkvarteroppsett** \> **Parametere** \> **Detaljhandelsparametere**. Deretter, på **Postering**-fanen på hurtigfanen **Lageroppdatering** i feltet **Detaljnivå**, velger du **Sammendrag**.
    - Gå til **Detaljhandel** \> **Hovedkvarteroppsett** \> **Parametere** \> **Detaljhandelsparametere**. Deretter, på **Postering**-fanen på hurtigfanen **Aggregering**, angir du **Bilagstransaksjoner** til **Ja**.
