...
7. I kategorien **Mottaker** bruker du følgende alternativer til å angi hvem som skal motta meldingene.
    ...
    <li>I <strong>Bruker</strong>-fanen inneholder <strong>Tilgjengelige brukere</strong>-listen alle Finance and Operations-brukere. Velg brukerne du vil sende varslinger til, og flytt disse brukerne til <strong>Valgte brukere</strong>-listen.</li>
    </ol>
    </td>
    </tr>
    </tbody>
