---
title: Videoer for Dynamics 365 for Finance and Operations
...
# <a name="videos-for-dynamics-365-for-finance-and-operations"></a>Videoer for Dynamics 365 for Finance and Operations

[!include [banner](../includes/banner.md)]

Denne siden viser Microsoft-opprettede "Slik gjør du det"- og "Teknisk tale"-videoer i forbindelse med Dynamics 365 for Finance and Operations som er tilgjengelige på YouTube og andre områder.

## <a name="dynamics-365-youtube-channel"></a>Dynamics 365 YouTube-kanal
På [Microsoft Dynamics 365 YouTube-kanalen](https://www.youtube.com/channel/UCJGCg4rB3QSs8y_1FquelBQ) kan du finne videoer som er opprettet av Microsoft, som viser en rekke forretningsløsninger for Dynamics 365-produkter. Denne delen viser "Slik gjør du det"-videoer for Dynamics 365 for Finance and Operations som ligger på kanalen.

Videoene er oppført etter funksjon, så rull nedover for å se hele listen over videoinnhold.  
...
- [Visual Studio Team Services-integrasjon med Lifecycle Services](https://www.youtube.com/watch?v=0QyyyUp1zHQ&t=1s)
...
- [Bygge inn PowerApps](https://www.youtube.com/watch?v=x3qyA1bH-NY)
...
- [Opprette en Excel-mal for hode- og linjemønstre i Dynamics 365 for Finance and Operations](https://www.youtube.com/watch?v=RTicLb-6dbI&feature=youtu.be)
...
[Tekniske samtaler om FastTrack for Dynamics 365](https://infopedia.eventbuilder.com/index?landingpageid=92tzhl) fokuserer på å tilby teknisk dybde og anbefalte fremgangsmåter som gir kunder og partnere detaljert kunnskap som er spesifikk for emneområdene. Den følgende delen viser innspillinger av tekniske samtaler om FastTrack som kan strømmes eller lastes ned. Du kan også laste ned en PDF-kopi av presentasjonen fra tekniske samtaler-området. 

#### <a name="data-management"></a>Databehandling
- [Kopiering til juridisk enhet (DYN383PAL)](https://infopedia.eventbuilder.com/event?eventid=q3h0m7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Databehandling (DYN445PAL2)](https://infopedia.eventbuilder.com/event?eventid=a7n1v0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Redusere tid for dataimport og -eksporter ved hjelp av konfigurasjoner (DYN315PAL)](https://infopedia.eventbuilder.com/event?eventid=s6v1q3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="demo-data"></a>Demonstrasjonsdata
...
- [Lokal distribusjon (DYN382PAL2)](https://infopedia.eventbuilder.com/event?eventid=m9i7a2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="develop-and-customize"></a>Utvikle og tilpasse
- [Azure Integration-verktøy for Dynamics 365 for Finance and Operations (DYN386PAL)](https://infopedia.eventbuilder.com/event?eventid=l7f2i9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Utvidelsesmuligheter (DYN384PAL2)](https://infopedia.eventbuilder.com/event?eventid=e0x4q5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Slik utvider eller lager du nye analytiske arbeidsområder (DYN321PAL)](https://infopedia.eventbuilder.com/event?eventid=r7z0f5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Fremgangsmåte for ytelsestesting (DYN449PAL2)](https://infopedia.eventbuilder.com/event?eventid=k6c6g9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Fremgangsmåte for ytelsestesting (DYN449PAL)](https://infopedia.eventbuilder.com/event?eventid=i1u5m9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="financial-reporting"></a>Finansrapportering
- [Finansrapportering (DYN305PAL)](https://infopedia.eventbuilder.com/event?eventid=s0d0n3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks) 
- [Rapporteringsalternativer i Dynamics 365 for Finance and Operations (VIR810PAL)](https://infopedia.eventbuilder.com/event?eventid=p8x0s5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
- [Integrasjon (VIR806PAL)](https://infopedia.eventbuilder.com/event?eventid=y0w0k9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Integrasjon mellom Dynamics 365 for Sales og Dynamics 365 for Finance & Operations via CDS (DYN340PAL)](https://infopedia.eventbuilder.com/event?eventid=d8s3b6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Integrasjonsrammeverk i Dynamics 365 for Finance & Operations (DYN385PAL)](https://infopedia.eventbuilder.com/event?eventid=y4y2v9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Rammeverk for oppgaveautomatisering for databehandling (DYN447PAL2)](https://youtu.be/KqnXjNpR4AY)

#### <a name="intelligence"></a>Intelligens
- [Alternativer for analyse og rapportering, utskrift og dokumentrutingsagenten (DYN442PAL)](https://infopedia.eventbuilder.com/event?eventid=r6d9a6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Introduksjon av analytiske arbeidsområder (DYN317PAL)](https://infopedia.eventbuilder.com/event?eventid=h6e1a7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="mobile"></a>Mobiltelefon
- [Mobilt arbeidsområde for utgifter og prosjekter (DYN379PAL2)](https://infopedia.eventbuilder.com/event?eventid=u0g9h5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Mobilrammeverk (VIR824PAL)](https://infopedia.eventbuilder.com/event?eventid=p2o7n7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
- [Konfigurasjon av Visual Studio Team Services (VSTS) (VIR782PAL)](https://infopedia.eventbuilder.com/event?eventid=g9f8g1&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="warehouse-management"></a>Lagerstyring
- [Tillegg til mottak av kombinerte nummerskilt (DYN331PAL)](https://infopedia.eventbuilder.com/event?eventid=e0u6t2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Behovsbasert etterfylling av råvareplukking (DYN333PAL2)](https://infopedia.eventbuilder.com/event?eventid=i5p9d2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Vare- og lageroverføringsprosess for å bruke avansert lagerstyring (DYN316PAL)](https://infopedia.eventbuilder.com/event?eventid=w0k4b4&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
