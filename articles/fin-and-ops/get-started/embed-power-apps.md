...
- **isPowerAppTabPersonalizationEnabled** – Hvis denne metoden returnerer USANN for en bestemt side, kan brukere ikke bygge inn PowerApps direkte på siden som en fane, hurtigfane eller panoramainndeling. Brukere vil fortsatt kunne bygge inn PowerApps med menyknappen PowerApps hvis innebygging er tillatt på siden.
