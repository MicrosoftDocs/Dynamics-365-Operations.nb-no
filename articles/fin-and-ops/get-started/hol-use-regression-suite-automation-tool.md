...
1. Åpne Regression Suite Automation Tool (RSAT), og velg begge testtilfellene du opprettet i [Installasjon og konfigurasjon av Regression Suite Automation Tool](./hol-set-up-regression-suite-automation-tool.md).
...
Denne funksjonen kan brukes til å validere om en handling er utført. Når en produksjonsordre for eksempel opprettes, estimeres og deretter startes, viser Microsoft Dynamics 365 for Finance and Operations meldingen "Produksjon – start" for å varsle deg om at produksjonsordren er startet.
...
Etter at testtilfellet er kjørt, sammenlignes meldingen i Excel-parameterfilen med meldingen som vises i Finance and Operations. Hvis meldingene ikke samsvarer, mislykkes testtilfellet.
