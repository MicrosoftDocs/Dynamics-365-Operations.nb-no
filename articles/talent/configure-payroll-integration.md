...
- <span data-ttu-id="7c6e9-110">Personaldata</span><span class="sxs-lookup"><span data-stu-id="7c6e9-110">Human resources data</span></span>
...
- <span data-ttu-id="7c6e9-145">Grensebeløp</span><span class="sxs-lookup"><span data-stu-id="7c6e9-145">Limit amount</span></span>
...
| <span data-ttu-id="7c6e9-165">Valg i Talent</span><span class="sxs-lookup"><span data-stu-id="7c6e9-165">Selection in Talent</span></span>        | <span data-ttu-id="7c6e9-166">Resultat i Dayforce</span><span class="sxs-lookup"><span data-stu-id="7c6e9-166">Result in Dayforce</span></span>                            |
|----------------------------|-----------------------------------------------|
...
<span data-ttu-id="7c6e9-187">Hvis du vil ha mer informasjon om kompensasjonsplaner, kan du se følgende emner:</span><span class="sxs-lookup"><span data-stu-id="7c6e9-187">For more information about compensation plans, see the following topics:</span></span>
...
<span data-ttu-id="7c6e9-205">Ha følgende data og konfigurasjon i bakhodet når du definerer stillinger:</span><span class="sxs-lookup"><span data-stu-id="7c6e9-205">Keep the following data and configuration in mind when you set up positions:</span></span>
...
<span data-ttu-id="7c6e9-226">Hvis du vil ha mer informasjon, se følgende emner:</span><span class="sxs-lookup"><span data-stu-id="7c6e9-226">For more information, see the following topics:</span></span>
...
- <span data-ttu-id="7c6e9-276">Primær (obligatorisk)</span><span class="sxs-lookup"><span data-stu-id="7c6e9-276">Primary (required)</span></span>
...
##### <a name="payroll-information"></a><span data-ttu-id="7c6e9-296">Lønnsinformasjon</span><span class="sxs-lookup"><span data-stu-id="7c6e9-296">Payroll information</span></span>
...
<span data-ttu-id="7c6e9-318">En ansatts nøkkeldatoer avledes ved å bruke følgende informasjon.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-318">An employee's key dates are derived by using the following information.</span></span>
...
#### <a name="identification-numbers"></a><span data-ttu-id="7c6e9-341">Identifikasjonsnumre</span><span class="sxs-lookup"><span data-stu-id="7c6e9-341">Identification numbers</span></span>
...
- <span data-ttu-id="7c6e9-379">Avdelinger må oppgis for stillinger.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-379">Departments are required on positions.</span></span>
...
<span data-ttu-id="7c6e9-399">Følgende jobbposisjonstyper og -beskrivelser er påkrevd.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-399">The following position types and descriptions are required.</span></span>
...
### <a name="marital-status"></a><span data-ttu-id="7c6e9-437">Sivilstand</span><span class="sxs-lookup"><span data-stu-id="7c6e9-437">Marital status</span></span>
...
<span data-ttu-id="7c6e9-468">Inntektskoder sørger for unik identifisering av alle typer inntekter som ansatte mottar.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-468">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="7c6e9-469">Kodene dekker flere parametere som er knyttet til inntekter, for eksempel regnskapsregler, skattelover, rapporteringkrav og bruttofunksjon.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-469">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="7c6e9-470">Hvis det brukes en frekvens som ikke støttes, brukes frekvensen **Hver betaling** som standard for beregningen.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-470">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>
...
- <span data-ttu-id="7c6e9-496">SISTIKVART – SISTIKVART</span><span class="sxs-lookup"><span data-stu-id="7c6e9-496">LASTOFQTR – LASTOFQTR</span></span>
...
| <span data-ttu-id="7c6e9-514">Kommune</span><span class="sxs-lookup"><span data-stu-id="7c6e9-514">County</span></span>          | <span data-ttu-id="7c6e9-515">Fylke (kommune)</span><span class="sxs-lookup"><span data-stu-id="7c6e9-515">County (Municipality)</span></span> |
| <span data-ttu-id="7c6e9-516">Gate</span><span class="sxs-lookup"><span data-stu-id="7c6e9-516">Street</span></span>          | <span data-ttu-id="7c6e9-517">Adresselinje 1</span><span class="sxs-lookup"><span data-stu-id="7c6e9-517">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="7c6e9-518">Avgiftsområder</span><span class="sxs-lookup"><span data-stu-id="7c6e9-518">Tax regions</span></span>

<span data-ttu-id="7c6e9-519">Avgiftsområder brukes til å bestemme den gjeldende avgiften som skal brukes ved generering av lønn.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-519">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="7c6e9-520">Avgiftsområder er tilordnet Dayforce som stedsadresser.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-520">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="7c6e9-521">Standard avgiftområde må være knyttet til arbeiderens aktive stilling.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-521">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="7c6e9-522">Avgiftsområde (obligatorisk)</span><span class="sxs-lookup"><span data-stu-id="7c6e9-522">Tax region (required)</span></span>
- <span data-ttu-id="7c6e9-523">Land/område (obligatorisk)</span><span class="sxs-lookup"><span data-stu-id="7c6e9-523">Country/Region (required)</span></span>
- <span data-ttu-id="7c6e9-524">Stat (obligatorisk)</span><span class="sxs-lookup"><span data-stu-id="7c6e9-524">State (required)</span></span>
- <span data-ttu-id="7c6e9-525">Kommune</span><span class="sxs-lookup"><span data-stu-id="7c6e9-525">County</span></span> 
- <span data-ttu-id="7c6e9-526">By (obligatorisk)</span><span class="sxs-lookup"><span data-stu-id="7c6e9-526">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="7c6e9-527">Konfigurere data for å generere lønn i Mexico</span><span class="sxs-lookup"><span data-stu-id="7c6e9-527">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="7c6e9-528">Hvis du skal generere lønn for ansatte i Mexico, konfigureres følgende elementer:</span><span class="sxs-lookup"><span data-stu-id="7c6e9-528">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="7c6e9-529">Avdelinger må oppgis for stillinger.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-529">Departments are required on positions.</span></span>
- <span data-ttu-id="7c6e9-530">Kostnadssentre må være angitt som finansdimensjoner og må være det første elementet i standard finansdimensjonsstreng.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-530">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="7c6e9-531">Jobbtyper</span><span class="sxs-lookup"><span data-stu-id="7c6e9-531">Job types</span></span>

<span data-ttu-id="7c6e9-532">Jobbtyper brukes til å gruppere lignende jobber i kategorier.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-532">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="7c6e9-533">Jobbtype kreves for å kunne behandle lønn i Mexico.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-533">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="7c6e9-534">Eksempler på jobbtyper er heltid og deltid, eller lønn og timelønn.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-534">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="7c6e9-535">Jobbtyper er tilordnet til Dayforce som lønnstyper som angir om en ansatt er hver time eller lønn.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-535">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="7c6e9-536">Følgende jobbtyper og beskrivelser er påkrevd.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-536">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="7c6e9-537">Jobbtype</span><span class="sxs-lookup"><span data-stu-id="7c6e9-537">Job type</span></span>   | <span data-ttu-id="7c6e9-538">beskrivelse</span><span class="sxs-lookup"><span data-stu-id="7c6e9-538">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="7c6e9-539">Per time</span><span class="sxs-lookup"><span data-stu-id="7c6e9-539">Hourly</span></span>     | <span data-ttu-id="7c6e9-540">MX per time</span><span class="sxs-lookup"><span data-stu-id="7c6e9-540">MX Hourly</span></span>   |
| <span data-ttu-id="7c6e9-541">Lønnsbasert</span><span class="sxs-lookup"><span data-stu-id="7c6e9-541">Salaried</span></span>   | <span data-ttu-id="7c6e9-542">MX lønnsbasert</span><span class="sxs-lookup"><span data-stu-id="7c6e9-542">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="7c6e9-543">Stillingstyper</span><span class="sxs-lookup"><span data-stu-id="7c6e9-543">Position types</span></span> 

<span data-ttu-id="7c6e9-544">Du kan bruke stillingstyper til å beskrive om stillingen er heltid, deltid eller et annet navn.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-544">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="7c6e9-545">Posisjonstyper er tilordnet til Dayforce som lønnsklasser som angir om en ansatt er fulltid eller deltid.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-545">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="7c6e9-546">Følgende jobbposisjonstyper og -beskrivelser er påkrevd.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-546">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="7c6e9-547">Stillingstype</span><span class="sxs-lookup"><span data-stu-id="7c6e9-547">Position type</span></span>   | <span data-ttu-id="7c6e9-548">beskrivelse</span><span class="sxs-lookup"><span data-stu-id="7c6e9-548">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="7c6e9-549">Heltid</span><span class="sxs-lookup"><span data-stu-id="7c6e9-549">Full-time</span></span>       | <span data-ttu-id="7c6e9-550">Heltidsansatt</span><span class="sxs-lookup"><span data-stu-id="7c6e9-550">Full time employee</span></span> |
| <span data-ttu-id="7c6e9-551">Deltid</span><span class="sxs-lookup"><span data-stu-id="7c6e9-551">Part-time</span></span>       | <span data-ttu-id="7c6e9-552">Deltidsansatt</span><span class="sxs-lookup"><span data-stu-id="7c6e9-552">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="7c6e9-553">Årsakskoder</span><span class="sxs-lookup"><span data-stu-id="7c6e9-553">Reason codes</span></span>

<span data-ttu-id="7c6e9-554">Årsakskoder inneholder informasjon om statusen for en ansatt.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-554">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="7c6e9-555">Årsakskoder er tilordnet til Dayforce som statusårsaker som angir årsaken til endringer i en ansatts stilling eller status.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-555">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="7c6e9-556">Følgende årsakskoder og beskrivelser er påkrevd.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-556">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="7c6e9-557">Årsakskode</span><span class="sxs-lookup"><span data-stu-id="7c6e9-557">Reason code</span></span>            | <span data-ttu-id="7c6e9-558">beskrivelse</span><span class="sxs-lookup"><span data-stu-id="7c6e9-558">Description</span></span>                    | <span data-ttu-id="7c6e9-559">Gjeldende scenarier</span><span class="sxs-lookup"><span data-stu-id="7c6e9-559">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="7c6e9-560">AVGANGFØRBETALING</span><span class="sxs-lookup"><span data-stu-id="7c6e9-560">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="7c6e9-561">Avgang før første lønn</span><span class="sxs-lookup"><span data-stu-id="7c6e9-561">Departure before first payroll</span></span> | <span data-ttu-id="7c6e9-562">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-562">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-563">OPPSIGELSE</span><span class="sxs-lookup"><span data-stu-id="7c6e9-563">RESIGNATION</span></span>            | <span data-ttu-id="7c6e9-564">Oppsigelse</span><span class="sxs-lookup"><span data-stu-id="7c6e9-564">Resignation</span></span>                    | <span data-ttu-id="7c6e9-565">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-565">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-566">PENSJON</span><span class="sxs-lookup"><span data-stu-id="7c6e9-566">PENSION</span></span>                | <span data-ttu-id="7c6e9-567">Pensjon</span><span class="sxs-lookup"><span data-stu-id="7c6e9-567">Pension</span></span>                        | <span data-ttu-id="7c6e9-568">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-568">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-569">AVSLUTNING</span><span class="sxs-lookup"><span data-stu-id="7c6e9-569">TERMINATION</span></span>            | <span data-ttu-id="7c6e9-570">Avslutning</span><span class="sxs-lookup"><span data-stu-id="7c6e9-570">Termination</span></span>                    | <span data-ttu-id="7c6e9-571">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-571">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-572">AVGANGVEDPENSJON</span><span class="sxs-lookup"><span data-stu-id="7c6e9-572">RETIREMENT</span></span>             | <span data-ttu-id="7c6e9-573">Avgang ved pensjon</span><span class="sxs-lookup"><span data-stu-id="7c6e9-573">Retirement</span></span>                     | <span data-ttu-id="7c6e9-574">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-574">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-575">FRAVÆRENDEPERSON</span><span class="sxs-lookup"><span data-stu-id="7c6e9-575">ABSENTEE</span></span>               | <span data-ttu-id="7c6e9-576">Fraværende person</span><span class="sxs-lookup"><span data-stu-id="7c6e9-576">Absentee</span></span>                       | <span data-ttu-id="7c6e9-577">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-577">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-578">ANNET</span><span class="sxs-lookup"><span data-stu-id="7c6e9-578">OTHER</span></span>                  | <span data-ttu-id="7c6e9-579">Andre årsaker</span><span class="sxs-lookup"><span data-stu-id="7c6e9-579">Other Reasons</span></span>                  | <span data-ttu-id="7c6e9-580">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-580">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-581">STENGNING</span><span class="sxs-lookup"><span data-stu-id="7c6e9-581">CLOSURE</span></span>                | <span data-ttu-id="7c6e9-582">Forretning stenger</span><span class="sxs-lookup"><span data-stu-id="7c6e9-582">Business Closure</span></span>               | <span data-ttu-id="7c6e9-583">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-583">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-584">DØDSFALL</span><span class="sxs-lookup"><span data-stu-id="7c6e9-584">DEATH</span></span>                  | <span data-ttu-id="7c6e9-585">Dødsfall</span><span class="sxs-lookup"><span data-stu-id="7c6e9-585">Death</span></span>                          | <span data-ttu-id="7c6e9-586">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-586">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-587">PERMISJON</span><span class="sxs-lookup"><span data-stu-id="7c6e9-587">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="7c6e9-588">Permisjon</span><span class="sxs-lookup"><span data-stu-id="7c6e9-588">Leave of Absence</span></span>               | <span data-ttu-id="7c6e9-589">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-589">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-590">KONTRAKTSLUTT</span><span class="sxs-lookup"><span data-stu-id="7c6e9-590">CONTRACTEND</span></span>            | <span data-ttu-id="7c6e9-591">Slutt på kontrakt</span><span class="sxs-lookup"><span data-stu-id="7c6e9-591">End of Contract</span></span>                | <span data-ttu-id="7c6e9-592">Avslutt arbeider</span><span class="sxs-lookup"><span data-stu-id="7c6e9-592">Terminate worker</span></span>     |
| <span data-ttu-id="7c6e9-593">LØNNSENDRING</span><span class="sxs-lookup"><span data-stu-id="7c6e9-593">SALARYCHANGE</span></span>           | <span data-ttu-id="7c6e9-594">Lønnsendring</span><span class="sxs-lookup"><span data-stu-id="7c6e9-594">Change of Salary</span></span>               | <span data-ttu-id="7c6e9-595">Kompensasjon</span><span class="sxs-lookup"><span data-stu-id="7c6e9-595">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="7c6e9-596">Ansettelsesbetingelser</span><span class="sxs-lookup"><span data-stu-id="7c6e9-596">Terms of employment</span></span>

<span data-ttu-id="7c6e9-597">Ansettelsesbetingelser brukes til å opprette kategorier for ansettelsesbetingelser.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-597">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="7c6e9-598">Vilkårene tilordnes til Dayforce som ansettelseindikatorverdier.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-598">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="7c6e9-599">Følgende betingelsene for ansettelse og beskrivelser kreves.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-599">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="7c6e9-600">Ansettelsesbetingelser</span><span class="sxs-lookup"><span data-stu-id="7c6e9-600">Terms of employment</span></span>   | <span data-ttu-id="7c6e9-601">beskrivelse</span><span class="sxs-lookup"><span data-stu-id="7c6e9-601">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="7c6e9-602">Vanlig</span><span class="sxs-lookup"><span data-stu-id="7c6e9-602">Regular</span></span>               | <span data-ttu-id="7c6e9-603">Vanlig</span><span class="sxs-lookup"><span data-stu-id="7c6e9-603">Regular</span></span>     |
| <span data-ttu-id="7c6e9-604">Direkte</span><span class="sxs-lookup"><span data-stu-id="7c6e9-604">Direct</span></span>                | <span data-ttu-id="7c6e9-605">Direkte</span><span class="sxs-lookup"><span data-stu-id="7c6e9-605">Direct</span></span>      |
| <span data-ttu-id="7c6e9-606">Praktikantstilling</span><span class="sxs-lookup"><span data-stu-id="7c6e9-606">Internship</span></span>            | <span data-ttu-id="7c6e9-607">Praktikantstilling</span><span class="sxs-lookup"><span data-stu-id="7c6e9-607">Internship</span></span>  |
| <span data-ttu-id="7c6e9-608">Permanent</span><span class="sxs-lookup"><span data-stu-id="7c6e9-608">Permanent</span></span>             | <span data-ttu-id="7c6e9-609">Permanent</span><span class="sxs-lookup"><span data-stu-id="7c6e9-609">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="7c6e9-610">Sivilstand</span><span class="sxs-lookup"><span data-stu-id="7c6e9-610">Marital status</span></span>

<span data-ttu-id="7c6e9-611">Sivilstandverdier tilordnes til Dayforce og oversettes, etter behov, til de godkjente verdiene ved integrering.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-611">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="7c6e9-612">Tabellen nedenfor viser hvordan sivilstandverdiene tilordnes i Dayforce.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-612">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="7c6e9-613">Talent</span><span class="sxs-lookup"><span data-stu-id="7c6e9-613">Talent</span></span>                 | <span data-ttu-id="7c6e9-614">Dayforce</span><span class="sxs-lookup"><span data-stu-id="7c6e9-614">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="7c6e9-615">Gift</span><span class="sxs-lookup"><span data-stu-id="7c6e9-615">Married</span></span>                | <span data-ttu-id="7c6e9-616">Gift</span><span class="sxs-lookup"><span data-stu-id="7c6e9-616">Married</span></span>                   |
| <span data-ttu-id="7c6e9-617">Én</span><span class="sxs-lookup"><span data-stu-id="7c6e9-617">Single</span></span>                 | <span data-ttu-id="7c6e9-618">Én</span><span class="sxs-lookup"><span data-stu-id="7c6e9-618">Single</span></span>                    |
| <span data-ttu-id="7c6e9-619">Enke/enkemann</span><span class="sxs-lookup"><span data-stu-id="7c6e9-619">Widowed</span></span>                | <span data-ttu-id="7c6e9-620">Enke/enkemann</span><span class="sxs-lookup"><span data-stu-id="7c6e9-620">Widowed</span></span>                   |
| <span data-ttu-id="7c6e9-621">Skilt</span><span class="sxs-lookup"><span data-stu-id="7c6e9-621">Divorced</span></span>               | <span data-ttu-id="7c6e9-622">Skilt</span><span class="sxs-lookup"><span data-stu-id="7c6e9-622">Divorced</span></span>                  |
| <span data-ttu-id="7c6e9-623">Registrert ekteskapelig partnerskap</span><span class="sxs-lookup"><span data-stu-id="7c6e9-623">Registered Partnership</span></span> | <span data-ttu-id="7c6e9-624">Ekteskapelig partnerskap</span><span class="sxs-lookup"><span data-stu-id="7c6e9-624">Domestic Partnership</span></span>      |
| <span data-ttu-id="7c6e9-625">None</span><span class="sxs-lookup"><span data-stu-id="7c6e9-625">None</span></span>                   | <span data-ttu-id="7c6e9-626">*Støttes ikke i Mexico*</span><span class="sxs-lookup"><span data-stu-id="7c6e9-626">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="7c6e9-627">Samboer</span><span class="sxs-lookup"><span data-stu-id="7c6e9-627">Cohabiting</span></span>             | <span data-ttu-id="7c6e9-628">*Støttes ikke i Mexico*</span><span class="sxs-lookup"><span data-stu-id="7c6e9-628">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="7c6e9-629">Kjønn</span><span class="sxs-lookup"><span data-stu-id="7c6e9-629">Gender</span></span>

<span data-ttu-id="7c6e9-630">Kjønnsangivelser tilordnes til Dayforce og oversettes, etter behov, til de godkjente verdiene ved integrering.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-630">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="7c6e9-631">Tabellen nedenfor viser hvordan kjønnsangivelser tilordnes i Dayforce.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-631">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="7c6e9-632">Talent</span><span class="sxs-lookup"><span data-stu-id="7c6e9-632">Talent</span></span>       | <span data-ttu-id="7c6e9-633">Dayforce</span><span class="sxs-lookup"><span data-stu-id="7c6e9-633">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="7c6e9-634">Mann</span><span class="sxs-lookup"><span data-stu-id="7c6e9-634">Male</span></span>         | <span data-ttu-id="7c6e9-635">Mann</span><span class="sxs-lookup"><span data-stu-id="7c6e9-635">Male</span></span>                      |
| <span data-ttu-id="7c6e9-636">Kvinne</span><span class="sxs-lookup"><span data-stu-id="7c6e9-636">Female</span></span>       | <span data-ttu-id="7c6e9-637">Kvinne</span><span class="sxs-lookup"><span data-stu-id="7c6e9-637">Female</span></span>                    |
| <span data-ttu-id="7c6e9-638">Ikke spesifikt</span><span class="sxs-lookup"><span data-stu-id="7c6e9-638">Non-specific</span></span> | <span data-ttu-id="7c6e9-639">*Støttes ikke i Mexico*</span><span class="sxs-lookup"><span data-stu-id="7c6e9-639">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="7c6e9-640">Betalingsmetode</span><span class="sxs-lookup"><span data-stu-id="7c6e9-640">Payment method</span></span>

<span data-ttu-id="7c6e9-641">Betalingsmåter gir den ansatte og firmaet en måte å beskrive hvordan ansatte skal betales.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-641">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="7c6e9-642">Betalingsmåter tilordnes til Dayforce og oversettes, etter behov, til de godkjente verdiene ved integrering.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-642">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="7c6e9-643">Tabellen nedenfor viser hvordan betalingsmåter tilordnes i Dayforce.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-643">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="7c6e9-644">Talent</span><span class="sxs-lookup"><span data-stu-id="7c6e9-644">Talent</span></span>             | <span data-ttu-id="7c6e9-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="7c6e9-645">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="7c6e9-646">Kontanter</span><span class="sxs-lookup"><span data-stu-id="7c6e9-646">Cash</span></span>               | <span data-ttu-id="7c6e9-647">Kontanter</span><span class="sxs-lookup"><span data-stu-id="7c6e9-647">Cash</span></span>                      |
| <span data-ttu-id="7c6e9-648">Elektronisk betaling</span><span class="sxs-lookup"><span data-stu-id="7c6e9-648">Electronic Payment</span></span> | <span data-ttu-id="7c6e9-649">Overfør</span><span class="sxs-lookup"><span data-stu-id="7c6e9-649">Transfer</span></span>                  |
| <span data-ttu-id="7c6e9-650">Kontroll</span><span class="sxs-lookup"><span data-stu-id="7c6e9-650">Check</span></span>              | <span data-ttu-id="7c6e9-651">Sjekk</span><span class="sxs-lookup"><span data-stu-id="7c6e9-651">Cheque</span></span>                    |
| <span data-ttu-id="7c6e9-652">Bankoverføring</span><span class="sxs-lookup"><span data-stu-id="7c6e9-652">Bank Draft</span></span>         | <span data-ttu-id="7c6e9-653">*Støttes ikke i Mexico*</span><span class="sxs-lookup"><span data-stu-id="7c6e9-653">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="7c6e9-654">Annet</span><span class="sxs-lookup"><span data-stu-id="7c6e9-654">Other</span></span>              | <span data-ttu-id="7c6e9-655">*Støttes ikke i Mexico*</span><span class="sxs-lookup"><span data-stu-id="7c6e9-655">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="7c6e9-656">Bankkontotype</span><span class="sxs-lookup"><span data-stu-id="7c6e9-656">Bank account type</span></span>

<span data-ttu-id="7c6e9-657">Bankkontotypene brukes for elektroniske betalinger til ansatte.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-657">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="7c6e9-658">Bankkontotypene tilordnes til Dayforce som overføringskontoinformasjon.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-658">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="7c6e9-659">Bankkontotypene oversettes, etter behov, til de godkjente verdiene ved integrering.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-659">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="7c6e9-660">Talent</span><span class="sxs-lookup"><span data-stu-id="7c6e9-660">Talent</span></span>            | <span data-ttu-id="7c6e9-661">Dayforce</span><span class="sxs-lookup"><span data-stu-id="7c6e9-661">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="7c6e9-662">Sjekkonto</span><span class="sxs-lookup"><span data-stu-id="7c6e9-662">Checking Account</span></span>  | <span data-ttu-id="7c6e9-663">Sjekkonto</span><span class="sxs-lookup"><span data-stu-id="7c6e9-663">CheckingAccount</span></span>           |
| <span data-ttu-id="7c6e9-664">Lønnskonto</span><span class="sxs-lookup"><span data-stu-id="7c6e9-664">Payroll Account</span></span>   | <span data-ttu-id="7c6e9-665">Lønnskonto</span><span class="sxs-lookup"><span data-stu-id="7c6e9-665">PayrollAccount</span></span>            |
| <span data-ttu-id="7c6e9-666">Sparekonto</span><span class="sxs-lookup"><span data-stu-id="7c6e9-666">Savings Account</span></span>   | <span data-ttu-id="7c6e9-667">*Støttes ikke i Mexico*</span><span class="sxs-lookup"><span data-stu-id="7c6e9-667">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="7c6e9-668">BankGirot-konto</span><span class="sxs-lookup"><span data-stu-id="7c6e9-668">BankGirot account</span></span> | <span data-ttu-id="7c6e9-669">*Støttes ikke i Mexico*</span><span class="sxs-lookup"><span data-stu-id="7c6e9-669">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="7c6e9-670">PlusGirot-konto</span><span class="sxs-lookup"><span data-stu-id="7c6e9-670">PlusGirot account</span></span> | <span data-ttu-id="7c6e9-671">*Støttes ikke i Mexico*</span><span class="sxs-lookup"><span data-stu-id="7c6e9-671">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="7c6e9-672">Inntektskoder</span><span class="sxs-lookup"><span data-stu-id="7c6e9-672">Earning codes</span></span>

<span data-ttu-id="7c6e9-673">Inntektskoder sørger for unik identifisering av alle typer inntekter som ansatte mottar.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-673">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="7c6e9-674">Kodene dekker flere parametere som er knyttet til inntekter, for eksempel regnskapsregler, skattelover, rapporteringkrav og bruttofunksjon.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-674">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="7c6e9-675">Hvis det brukes en frekvens som ikke støttes, brukes frekvensen **Hver betaling** som standard for beregningen.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-675">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="7c6e9-676">Støttede frekvenser</span><span class="sxs-lookup"><span data-stu-id="7c6e9-676">Supported frequencies</span></span>

- <span data-ttu-id="7c6e9-677">Alle</span><span class="sxs-lookup"><span data-stu-id="7c6e9-677">All</span></span>
- <span data-ttu-id="7c6e9-678">HVERBET</span><span class="sxs-lookup"><span data-stu-id="7c6e9-678">EVERYPAY</span></span>
- <span data-ttu-id="7c6e9-679">HVERBETPERIODE</span><span class="sxs-lookup"><span data-stu-id="7c6e9-679">EACHPAYPERIOD</span></span>
- <span data-ttu-id="7c6e9-680">ANNENHVBETODD</span><span class="sxs-lookup"><span data-stu-id="7c6e9-680">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="7c6e9-681">ANNENHVBETPAR</span><span class="sxs-lookup"><span data-stu-id="7c6e9-681">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="7c6e9-682">1IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-682">1OFMTH</span></span>
- <span data-ttu-id="7c6e9-683">SISTEIMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-683">LASTOFMTH</span></span>
- <span data-ttu-id="7c6e9-684">2IMDN</span><span class="sxs-lookup"><span data-stu-id="7c6e9-684">2OFMTH</span></span>
- <span data-ttu-id="7c6e9-685">3IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-685">3OFMTH</span></span>
- <span data-ttu-id="7c6e9-686">4IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-686">4OFMTH</span></span>
- <span data-ttu-id="7c6e9-687">5IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-687">5OFMTH</span></span>
- <span data-ttu-id="7c6e9-688">1OG2IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-688">1N2OFMTH</span></span>
- <span data-ttu-id="7c6e9-689">3OG4IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-689">3N4OFMTH</span></span>
- <span data-ttu-id="7c6e9-690">1OG3IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-690">1N3OFMTH</span></span>
- <span data-ttu-id="7c6e9-691">1OG4IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-691">1N4OFMTH</span></span>
- <span data-ttu-id="7c6e9-692">2OG3IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-692">2N3OFMTH</span></span>
- <span data-ttu-id="7c6e9-693">2OG4IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-693">2N4OFMTH</span></span>
- <span data-ttu-id="7c6e9-694">1OG2OG3IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-694">1N2N3OFMTH</span></span>
- <span data-ttu-id="7c6e9-695">1OG2OG4IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-695">1N2N4OFMTH</span></span>
- <span data-ttu-id="7c6e9-696">1OG3OG4IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-696">1N3N4OFMTH</span></span>
- <span data-ttu-id="7c6e9-697">2OG3OG4IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-697">2N3N4OFMTH</span></span>
- <span data-ttu-id="7c6e9-698">1OG2OG3OG4IMND - 1OG2OG3OG4IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-698">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="7c6e9-699">2OG3OG4OG5IMND - 2OG3OG4OG5IMND</span><span class="sxs-lookup"><span data-stu-id="7c6e9-699">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="7c6e9-700">1IKVRT - 1IKVRT</span><span class="sxs-lookup"><span data-stu-id="7c6e9-700">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="7c6e9-701">SISTIKVART – SISTIKVART</span><span class="sxs-lookup"><span data-stu-id="7c6e9-701">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="7c6e9-702">SISTEMNDIKVRT – SISTEMNDIKVRT</span><span class="sxs-lookup"><span data-stu-id="7c6e9-702">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="7c6e9-703">1IÅR - 1IÅR</span><span class="sxs-lookup"><span data-stu-id="7c6e9-703">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="7c6e9-704">SISTEIÅR – SISTEIÅR</span><span class="sxs-lookup"><span data-stu-id="7c6e9-704">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="7c6e9-705">NOVOGDESIÅR - NOVOGDESIÅR</span><span class="sxs-lookup"><span data-stu-id="7c6e9-705">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="7c6e9-706">Adresser</span><span class="sxs-lookup"><span data-stu-id="7c6e9-706">Addresses</span></span>

<span data-ttu-id="7c6e9-707">Identifikasjon av bestemte koder for land eller område, delstat og fylke (kommune) krever spesifikke formater som Dayforce og leverandører i landet/området kan gjenkjenne.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-707">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="7c6e9-708">Selv om formatet for byer er fleksibelt, må hver by være knyttet en stat.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-708">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="7c6e9-709">Talent</span><span class="sxs-lookup"><span data-stu-id="7c6e9-709">Talent</span></span>              | <span data-ttu-id="7c6e9-710">Dayforce</span><span class="sxs-lookup"><span data-stu-id="7c6e9-710">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="7c6e9-711">Land/område</span><span class="sxs-lookup"><span data-stu-id="7c6e9-711">Country/Region</span></span>      | <span data-ttu-id="7c6e9-712">Landskode</span><span class="sxs-lookup"><span data-stu-id="7c6e9-712">Country Code</span></span>          |
| <span data-ttu-id="7c6e9-713">Postnummer</span><span class="sxs-lookup"><span data-stu-id="7c6e9-713">Zip/Postal Code</span></span>     | <span data-ttu-id="7c6e9-714">Postnummer</span><span class="sxs-lookup"><span data-stu-id="7c6e9-714">Postal Code</span></span>           |
| <span data-ttu-id="7c6e9-715">Delstat</span><span class="sxs-lookup"><span data-stu-id="7c6e9-715">State</span></span>               | <span data-ttu-id="7c6e9-716">Statskode</span><span class="sxs-lookup"><span data-stu-id="7c6e9-716">State Code</span></span>            |
| <span data-ttu-id="7c6e9-717">By</span><span class="sxs-lookup"><span data-stu-id="7c6e9-717">City</span></span>                | <span data-ttu-id="7c6e9-718">By</span><span class="sxs-lookup"><span data-stu-id="7c6e9-718">City</span></span>                  |
| <span data-ttu-id="7c6e9-719">Kommune</span><span class="sxs-lookup"><span data-stu-id="7c6e9-719">County</span></span>              | <span data-ttu-id="7c6e9-720">Fylke (kommune)</span><span class="sxs-lookup"><span data-stu-id="7c6e9-720">County (Municipality)</span></span> |
| <span data-ttu-id="7c6e9-721">Gate</span><span class="sxs-lookup"><span data-stu-id="7c6e9-721">Street</span></span>              | <span data-ttu-id="7c6e9-722">Adresselinje 1</span><span class="sxs-lookup"><span data-stu-id="7c6e9-722">Address Line 1</span></span>        |
| <span data-ttu-id="7c6e9-723">Gatenummer</span><span class="sxs-lookup"><span data-stu-id="7c6e9-723">Street Number</span></span>       | <span data-ttu-id="7c6e9-724">Adresselinje 2</span><span class="sxs-lookup"><span data-stu-id="7c6e9-724">Address Line 2</span></span>        |
| <span data-ttu-id="7c6e9-725">Bygningsnavn</span><span class="sxs-lookup"><span data-stu-id="7c6e9-725">Building Complement</span></span> | <span data-ttu-id="7c6e9-726">Adresselinje 5</span><span class="sxs-lookup"><span data-stu-id="7c6e9-726">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="7c6e9-727">Passnummer</span><span class="sxs-lookup"><span data-stu-id="7c6e9-727">Passport number</span></span>

<span data-ttu-id="7c6e9-728">Ansatte kan deklarere passinformasjon.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-728">Employees can declare passport information.</span></span> <span data-ttu-id="7c6e9-729">Denne informasjonen er av **Pass**-identifikasjonstypen og er integrert i Dayforce som en del av en ansatts Mexico-spesifikke informasjon.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-729">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="7c6e9-730">Identifikasjonstype = "Pass"</span><span class="sxs-lookup"><span data-stu-id="7c6e9-730">Identification Type = "Passport"</span></span>
- <span data-ttu-id="7c6e9-731">Utstedelsesdato</span><span class="sxs-lookup"><span data-stu-id="7c6e9-731">Issued Date</span></span>
- <span data-ttu-id="7c6e9-732">Utløpsdato</span><span class="sxs-lookup"><span data-stu-id="7c6e9-732">Expiration Date</span></span>

<span data-ttu-id="7c6e9-733">Ansatte kan angi flere identifikasjonsnumre for identifikasjonstypen **Pass**.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-733">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="7c6e9-734">Men bare den gjeldende aktive passoppføringen er integrert i Dayforce.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-734">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="7c6e9-735">Hvis alle passoppføringer er utløpt, er passet som sist ble utstedt, integrert i Dayforce.</span><span class="sxs-lookup"><span data-stu-id="7c6e9-735">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
