...
ms.locfileid: "4462150"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Hva er nytt eller endret i Dynamics 365 Talent (12. november 2019)
...
Endringer som er beskrevet i denne delen, gjelder build nummer 8.1.2604. Tallene i parentes i noen overskrifter refererer til støttenumre i Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Kontoradresse oppdateres ikke via Excel-arbeidsbok (369727)

Med denne endringen kan du nå oppdatere kontoradressen ved hjelp av Office-arbeidsboken.
