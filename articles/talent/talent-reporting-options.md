...
- Core HR-dataene som flyter til Common Data Service for Apps, kan rapporteres via PowerApps CDS-koblingen til Power BI Desktop. Legg merke til at Common Data Service for Apps inneholder et delsett med Core HR-data. Hvis du vil ha mer informasjon om Power BI og instrumentbord, kan du se [Opprette Power BI-rapporter og -instrumentbord med PowerApps Common Data Service](https://powerapps.microsoft.com/en-us/blog/cdsconnectortopowerbi).
...
Flere Power BI-alternativer er tilgjengelige, og mer data og enheter vil være en del av Common Data Service for Apps.
