...
---
# <a name="troubleshoot-integration-with-linkedin-and-attract"></a>Feilsøke integrering med LinkedIn og Attract
...
Hvis du har problemer med å logge på LinkedIn fra Attract, kan du prøve disse trinnene:

1. Kontroller at LinkedIn-legitimasjonen du har angitt i Attract, er gyldig og korrekt.
2. Hvis legitimasjonen er gyldig og korrekt, kan du kontakte [LinkedIn-støtten](https://www.linkedin.com/help/linkedin).
3. Hvis problemet vedvarer, kontakter du [Microsoft Kundestøtte](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Jobbposteringer fra Attract vises ikke på LinkedIn
