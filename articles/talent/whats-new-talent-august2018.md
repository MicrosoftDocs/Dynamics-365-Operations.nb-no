...
Dette emnet beskriver funksjoner som enten er nye eller endret i Dynamics 365 for Talent Core HR.

## <a name="view-expiring-records-in-manager-self-service"></a>Vise utløpende poster i Lederselvbetjening

Du kan nå vise utløpende poster i Lederselvbetjening. Nye alternativer er at du kan konfigurere hva slags informasjon som skal være tilgjengelige for prosjektledere å vise. Disse omfatter:
...
Ledere som ber om overføringer av ansatte, har for eksempel ikke tilgang til å foreslå eller angi kompensasjonsbeløp eller velge oppgavelistene som skal være knyttet til overføringen. I dette tilfellet kan ledere opprette og sende forespørsler for overføring, men er ikke tillatt for å angi kompensasjon eller aktivitetstildelinger i listen. I denne samme konfigurasjonen kan Personale tilordne de nye verdiene for kompensasjon, i tillegg til å tilordne en ekstra sjekklister fullføres som et resultat av overføringen er fullført.
...
Med denne funksjonen kan du angi grunnlaget for den påløpte perioden på plannivået der du vil bruke datoer for ansatte. Dette gjør at andre datoer enn startdatoen for planen kan brukes under avsetning av lønn. Alternativene for spesifikke datoer for ansatte omfatter følgende verdier:
...
Mer informasjon om denne funksjonen er tilgjengelig i [Opplæring i Office-integrering](https://docs.microsoft.com/en-us/dynamics365/unified-operations/dev-itpro/office-integration/office-integration-tutorial?toc=/dynamics365/unified-operations/talent/toc.json).
