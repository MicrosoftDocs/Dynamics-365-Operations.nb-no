...
-   [Konfigurere og filtrere arbeidsområder](../fin-and-ops/get-started/configure-filter-workspaces.md) – Dette emnet forklarer hvordan du kan endre utseendet og virkemåten for arbeidsområder.

-   [Vise sider side ved side ved å bruke ikonet Åpne i nytt vindu](../fin-and-ops/get-started/display-pages-side-by-side.md) – I noen tilfeller er det effektivt å vise flere sider side ved side, noe som kan gjøre det enklere å utføre oppgaver raskt. Dette emnet forklarer hvordan du viser sider side ved side. 
