...
-   **Kilde** – Denne komponenten er der brukeren angir kildedata for tildelingen. Fordelingen kan være basert på finanssaldoer (**datakilden** = **Finans**) eller fast beløp (**datakilden** = **fast verdi**). Når **Datakilde** er satt til **Finans**, må kildefilterkriterier defineres for finansfordelingsregelen (for eksempel for reklameutgiftene).
