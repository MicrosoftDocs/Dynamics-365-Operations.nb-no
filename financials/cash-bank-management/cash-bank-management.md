...
-   [Purringer og importinkassoer](letters-of-credit-import-collections.md)
...
-   [Konfigurere sentralisert betaling](set-up-centralized-payments.md)
...
-   [Opprett leverandørfakturaer ved hjelp av et betalingsforslag](../accounts-payable/create-vendor-payments-payment-proposal.md)
...
-   [Scenario: Håndtering av kontantrabatt for overbetalinger](../cash-bank-management/cash-discount-handling-overpayments.md)
