...
| **Felt**                             | **Beskrivelse**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Minste timeantall for kostgodtgjørelse**           | Angi minste antall timer som en ansatt må arbeide i en dag for å kunne ta imot kostgodtgjørelse for reiserelaterte utgifter.                                                                                      |
