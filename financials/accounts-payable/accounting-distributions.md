...
> [!Note] 
> Noen dokumenter har også støtte for hodet dokumentet monetære beløp, for eksempel tillegg for bestillinger og fakturaer. 
...
-   **Fordel beløp** – Vis og endre regnskapsdistribusjonene for et enkelt dokumenthode eller en enkelt linje og eventuelle underordnede linjer, for eksempel avgifter eller gebyrer.
    ...
    -   Alle underordnede distribusjoner, for eksempel rabatt, tillegg og merverdiavgift, følger alltid den overordnede distribusjonen. Du kan vise overordnet/underordnet-relasjonen ved **referanse**&gt;**overordnet informasjon**.
    ...
    -   Avviksdistribusjoner kan genereres i samsvarsscenarier, for eksempel samsvar mellom en leverandørfaktura og en bestilling. Du kan vise samsvarende relasjonene mellom Regnskapsdistribusjonen på **referanse**&gt;**informasjon om**.
    -   **Rett**-knappen vises og er aktivert for dokumenter som støtter rettelser. **Riktige** oppretter nye distribusjoner. Først opprettes distribusjoner som tilbakefører opprinnelige distribusjoner. Disse distribusjonene kan ikke endres. Neste, nye riktig regnskapsdistribusjoner er opprettet. Disse distribusjonene kan endres hvis de opprinnelige distribusjonene kan endres.
    ...
    -   Du kan vise gjeldende status for regnskap dokumentet i **referanse**. Statusen for hele dokumentet, og angir om dokumentet er i arbeid eller fullført.
-   ** Vise distribusjoner ** – Vis regnskapsdistribusjonene for alle linjene og pengebeløp i dokumentet. Du kan ikke endre regnskapsdistribusjonene fra denne visningen.


Hvis du vil ha mer informasjon, se [regnskapsdistribusjoner og underfinansjournaloppføringer for fritekstfakturaer](accounting-distributions-subledger-journal-entries-vendor-invoices.md).
