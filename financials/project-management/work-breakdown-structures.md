...
**Beregning av arbeidskostnader** For hver bladnodeoppgave tilordner du en arbeidsinnsats i timer og en standardkategori. Når du definerer en tidsplan for en oppgave, blir derfor arbeidskostnadsestimatet automatisk lagt til i standardkategorien for arbeid. Dette kostnadsestimatet vises i fanen **Estimerte kostnader og omsetning** i rutenettet **Linjedetaljer** for denne oppgaven. Hvis du trenger flere arbeidskostnadsestimater, kan du legge dem til i denne fanen. Hvis du øker eller reduserer timer på arbeidskostnadsestimatet, beregnes tidsplanen for oppgaven automatisk på nytt. 
