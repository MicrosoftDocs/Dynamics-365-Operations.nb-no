...
# Hva er nytt eller endret i Dynamics 365 for Operations-versjon 1611 (november 2016)
...
<td>Tyskland krever DTAZV med utenlandsk formatspesifisering, som representerer en kredittoverføringsmelding (leverandørbetaling) i henhold til spesifikasjonen for betalinger over grenser fra Tyskland til en konto i en utenlandsk bank eller en innenlands bank i en fremmed valuta. 
</td>
</tr>
</tbody>
</table>
...
### Avansert lagerstyring i en butikk
...
### Aktiver sømløse omnikanalhandelsfunksjoner
...
### Oppgaveregistrering for salgssted
...
### Butikksystem: Gir en sømløs, lokal butikkopplevelse
...
### Universal Windows Platform-app for moderne salgssted for detaljhandel
...
| Få mer informasjon om støtte for forsendelse i Dynamics 365 for Operations                                                                                                         | Hvis du vil ha mer informasjon om støtte for forsendelsesprosesser, kan du se [Forsendelse](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Definere forsendelse](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Opprette en etterfyllingsordre for forsendelse (oppgaveveiledning)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) og [Endre eierskap for forsendelseslager basert på produksjonsbehov (oppgaveveiledning)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

### Leverandørsamarbeid (tidligere kjent som leverandørportalen)
...
<tbody>
<tr class="odd">
<td>Direkte på salgsordrelinjer definerer du der behovet skal hentes fra, og hvordan det skal hentes. <strong>Eksempel</strong> Opprett en salgsordrelinje, og angi direktelevering som leveringstype. Hovedleverandøren legges til på salgsordrelinjen som det kildepunktet.</td>
...
<tr class="even">
<td>Opprett et ordreløfte direkte fra salgsordrelinjer. <strong>Eksempel</strong> Opprett en salgsordrelinje som hentes fra en konsernintern leverandør. Forlat linjen. Leveringsdatoer beregnes i henhold til tilgjengeligheten i kildefirmaet.</td>
...
### Forbedringer i lageret for distribusjonssentre med store volumer
...
### Små funksjonsforbedringer i forsyningskjedeadministrasjonen
