---
title: Hva er ny eller endret i Dynamics AX 7.0 (februar 2016)
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Hva er ny eller endret i Dynamics AX 7.0 (februar 2016)
...
| Automatiser bygging, testing og distribusjon.                                                                            | Delvis tilgjengelig                                                                                                                                                                                | Distribuere utviklertopologien ved hjelp av Utvikler og Bygg VM. Automatisk konfigurasjon av Bygg VM for å finne, bygge moduler fra Visual Studio Online (VSO) og kjør tester. C\# og kompilering av X ++-modul og referanser støttes. | Det øker produktiviteten til utviklere ved å redusere kostnader og arbeid for testing og valideringer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
<td>Rapportalternativene er lagt slik at forskjellige filtre kan brukes når en bruker viser en rapport. En ny rapport blir deretter generert basert på disse filtrene.</td>
...
<td>Analysere økonomiske data ved hjelp av "Overvåke økonomiske resultater" Power BI-innhold.</td>
<td>Ikke tilgjengelig</td>
...
<td>Hjelpesystemet i den gjeldende versjonen av Dynamics AX viser oppgaveveiledninger som er lagret i Microsoft Dynamics Lifecycle Services (LCS) BPM. Hjelpesystemet viser også emner fra Microsoft wiki. Hvis du vil ha mer informasjon, se [hjelp for Dynamics AX - komme i gang](help-overview.md) og [ny oppgave veiledninger som er tilgjengelige (februar 2016)](new-task-guides-available-february-2016.md).</td>
...
<td>Funksjonen er implementert som en elektronisk rapportering konfigurasjon. Denne funksjonen er tilgjengelig for Tyskland og Australia.</td>
...
<td>Saldoliste med totalkontoer grupperapport implementeres som SSRS-rapporten (LedgerAccountSum\_FR).</td>
...
<td>Egen liste over Intrastat-varekoder er slått sammen med produkthierarki av typen Varekode.</td>
...
<td>Intrastat varekoden som har et tekstfelt til å identifisere flere enheter og ** produktet ** kortet har et felt til å identifisere Antall tilleggsenheter angitt i kilo.</td>
...
<tr class="odd">
<td>Analysere salgsdata for retail-kanalen ved hjelp av "Performance Monitor-kanal for detaljhandel" Power BI-innhold.</td>
<td>Ikke tilgjengelig</td>
...
<li>Den tilbyr "ferdig" alternativ levering pakker, for eksempel en kombinasjon området/lager/variant/transportmodus, basert på det raskeste levering (tidligste tilgjengelige dato) vilkåret som brukeren kan velge blant.</li>
