...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Hva kan du gjøre?**                                                | **Hvorfor er dette viktig?**                                                                                                                                                                                                                                                                                         |
| Bygg data for finansrapportering på nytt.                          | Når du flytter databasene for Dynamics AX mellom miljøer eller gjør andre invaderende endringer i miljøet, kan den økonomiske rapporteringsdatabasen må bygges. Et Windows PowerShell-skript leveres nå for å bygge databasen for deg.                                                                |
| Du kan ikke lenger velge alternativer for rapportutforming som ikke er gyldige. | Flere alternativer for rapportutforming som ble brukt i markedsversjoner av Management reporter, gjelder ikke for denne versjonen av Dynamics AX. Disse alternativene er knyttet til økonomiske rapportutforming, utdata og koble. Disse alternativene er fjernet fra financial report designer til å hindre at brukerfeil. |
...
| Beregne separate stykklistenivå for materialressursen planlegging og koster beregning: • stykklistenivåer er beregnet For materialressursen planlegging, i det nye **ReqItemLevel** tabellen. Avsluttede produksjonsordrer ignoreres i beregningen. • For beregning av produksjonskostnader, beregnes stykklistenivåer i **InventTable**. Avsluttede produksjonsordrer inkluderes i beregningen. | • Når du kjører planlegging av materialressurser, for eksempel hovedplanlegging, planlegging og nedbryting, må bare stykklistenivåer for planlegging av materialressurs beregnes på nytt. Det er med andre ord ikke nødvendig å beregne stykklistenivåer som brukes for etterkalkulering av produksjon. • Når du kjører etterkalkuleringsoperasjoner, for eksempel lageravslutning, må bare stykklistenivåer som brukes for etterkalkulering av produksjonen beregnes på nytt. |
...
[Nye eller oppdaterte oppgaven støttelinjer (mai 2016)](new-updated-task-guides-available-may-2016.md)
