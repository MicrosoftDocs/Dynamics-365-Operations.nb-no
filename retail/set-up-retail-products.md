...
description: Denne artikkelen beskriver hvordan du konfigurerer retail produkter i Microsoft Dynamics 365 for operasjoner - handel.
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Denne artikkelen beskriver hvordan du konfigurerer retail produkter i Microsoft Dynamics 365 for operasjoner - handel.

Før du kan tilby produkter for videresalg i retail-kanaler, må du opprette og konfigurere produktene i Dynamics 365 for operasjoner AX - handel. Detaljhandel bruker produktfunksjonene i Dynamics 365 for operasjoner for å opprette organisasjonsomfattende produkter i produktstandarden. Du kan opprette produktene, definere produktegenskaper og -attributter og tilordne produktene til detaljhandelskategorihierarkier. Hvis du vil gjøre varene tilgjengelig for kanaler for detaljhandel og legge dem til et aktivt sortiment, må du frigi produkter til juridiske enheter der de er tilgjengelige. Hvis du vil definere produktene som selges ved hjelp av kanaler for detaljhandel, kan du utføre følgende oppgaver.

1.  Definer et detaljprodukthierarki. Ved hjelp av funksjonene for kategori-hierarkiet i Dynamics 365 for operasjoner, kan du definere detaljhandelshierarkier for kategorien for å gruppere og kategorisere produktene som distribueres til retail-kanaler. Brukerdefinerte attributter og systemattributter kan defineres på kategorinivå. Deretter arver alle produkter som er tilordnet til kategorien, disse attributtene. Du kan definere flere kategorihierarkier, og hvert produkt kan tilordnes flere hierarkier. Men i et enkelt hierarki kan hvert produkt tilordnes bare én kategori.
...
5.  Legge til produkter i navigasjonshierarkier. Før du kan bla gjennom produkter online eller innpunktet salg (POS), må de bli kategorisert i et hierarki for navigering.
6.  Legge til produkter i kataloger. Selv om dette trinnet er valgfritt for POS, nettbutikker, til å kreve at varer skal inkluderes i minst én katalog.
