...
# Oversikt over detaljhandelsenheter
...
## Distribusjonsalternativer for maskinvarestasjon
...
#### Cloud POS, Modern POS for iOS og Modern POS for Android
...
### Installasjon av maskinvarestasjon
...
### Oppsett og konfigurasjon av Modern POS for Windows
...
### Oppsett og konfigurasjon av OPOS-enhet
...
## Scenarier som støttes etter maskinvarestasjonstype
<a id="supported-scenarios-by-hardware-station-type" class="xliff"></a>
### Klientstøtte – IPC-maskinvarestasjon kontra IIS maskinvarestasjon
...
## Enhetstyper som støttes av maskinvarestasjonstype
<a id="supported-device-types-by-hardware-station-type" class="xliff"></a>
### Moderne POS for Windows med en IPC-maskinvarestasjon (innebygd)
...
### Alle Modern POS-klienter som har en dedikert IIS-maskinvarestasjon
...
### Alle Modern POS-klienter som har en delt IIS-maskinvarestasjon
...
## Konfigurasjon for scenarier som støttes
...
## Microsoft-testede eksterne enheter
<a id="microsofttested-peripheral-devices" class="xliff"></a>
### IPC-maskinvarestasjon (innebygd)
...
### Dedikert IIS-maskinvarestasjon
...
### Modern POS kan gjenkjenne maskinvarestasjonen i listen for valg, men kan ikke fullføre sammenkoblingen
...
### Modern POS gjenkjenner ikke maskinvarstasjonen i listen over valg
...
### Modern POS gjenspeiler ikke nye innstillinger for kassaskuff
...
### Modern POS rapporterer et problem med en ekstern enhet for detaljhandel
