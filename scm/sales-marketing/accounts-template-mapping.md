...
- **CustomerGroupId** må oppdateres til en gyldig verdi i Finance and Operations. Du kan angi en standardverdi, eller du kan angi verdien ved hjelp av en verditilordningen. Standardmalverdien er **10**.
- **Kode for adresse, land og område** er obligatorisk i Finance and Operations. Hvis du vil unngå synkroniseringsfeil, kan du angi en standardverdi. Den standardverdien brukes deretter hvis feltet er tomt i Sales.
