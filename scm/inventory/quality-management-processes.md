...
[![Quality management-prosessen](./media/quality-management-process-diagram.png)](./media/quality-management-process-diagram.png)  
...
Avvik er knyttet til en problemtype. Problemtyper som er definert på **Problemtyper**-siden, der du kan angi problemtypene som kan knyttes til hver avvikstype. For eksempel problemtyper for avvik av den **serviceforespørsel** type kan reflektere en klassifisering av kundeklager, mens problemet skriver for avvik av den ** internt ** type kan representere en klassifisering av feilkoder. 
...
[Definer kvalitetsordrer (aktivitet guide)](http://ax.help.dynamics.com/en/wiki/set-up-quality-orders/)
