---
title: Hovedplanlegging for sitedekning, lager obligatorisk
...
# <a name="master-planning-for-site-coverage-mandatory-warehouse"></a>Hovedplanlegging for sitedekning, lager obligatorisk
...
-   Standard ordretype er satt til Produksjon, Bestilling eller Kanban. Klikk **produktinformasjonsbehandling &gt;produkter&gt; utgitt produkter**. Velg varen, og klikk deretter **planlegger &gt;Standard ordreinnstillinger**. I **Standard ordreinnstillinger**-skjemaet kan du se **Standard ordretype**.
...
[Master planlegging - området dekning. lager obligatorisk](master-plan-site-coverage-warehouse-mandatory.md)
