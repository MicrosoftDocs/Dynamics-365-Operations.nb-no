---
title: "Oversettelser av produktrelaterte vanlige spørsmål"
...
# <a name="product-related-translations-faq"></a>Oversettelser av produktrelaterte vanlige spørsmål
...
## <a name="how-do-i-create-translations-for-productrelated-information"></a>Hvordan oppretter oversettelser for informasjon om productrelated?
Hvis du vil opprette transaksjoner for et produkt, gjør du følgende:
1.  Klikk **produktinformasjonsbehandling**&gt;**vanlige**&gt;**utgitt produkter**.
2.  Velg et produkt, og i handlingsruten, i den **språk** gruppen, klikker du **oversettelser av**.
3.  På siden **Tekstoversettelse**, i **Språk**-feltet, velger du et språk. Hvis du vil legge til flere språk, kan du utvide den **språk** feltet, og klikk deretter **OK**.
...
4.  På siden **Tekstoversettelse**, i **Språk**-feltet, velger du et språk. Hvis du vil legge til flere språk, kan du utvide den **språk** feltet, og klikk deretter **OK**.
...
5.  På siden **Tekstoversettelse**, i **Språk**-feltet, velger du et språk. Hvis du vil legge til flere språk, kan du utvide den **språk** feltet, og klikk deretter **OK**.
6.  I den **oversatt tekst** gruppen, angi oversettelser i den **navnet** og **beskrivelse** felt.
...
Navnet på en produktvariant som er basert på dimensjonen verdier liten og rød er **\#3:Small:Red**.  

En kunde ønsker å kjøpe noen små, røde t-skjorter, og navnet på t-skjorten må vises på fransk på fakturaen. Du oversette dimensjonsverdiene, liten og rødt, til fransk, og navnet på en produktvariant av er **\#3: Petit: Rouge**.
<table>
<colgroup>
<col width="100%" />
</colgroup>
...
<ol>  
<li>Klikk <strong>salg og markedsføring</strong>&gt;<strong>vanlige</strong>&gt;<strong>kunder</strong>&gt;<strong>alle</strong> <strong>kunder</strong>.</li>
...
1.  Klikk **produktinformasjonsbehandling**&gt;**oppsett**&gt;**Variantgrupper**.
2.  Velg **Størrelse** **grupper**, **Fargegrupper** eller **Stilgrupper**.
3.  Klikk **ny**, og skriv deretter inn et navn for gruppen i den **størrelse****gruppen**, **fargegruppe**, eller **stil** feltet. Klikk **Størrelser**, **Farger** eller **Stiler** for å opprette linjer for gruppene.
4.  I den **størrelse****gruppen** linjer, **farge****gruppen****linjer**, eller **stil gruppelinjer** klikker du **ny**, og deretter opprette den størrelser, farger og stiler for grupper.
...
2.  Klikk **Tekstoversettelse**. I den **Tekstoversettelse** side i den **oversatt tekst** gruppen, angi oversettelser i den **navnet** og **beskrivelse** felt.

## <a name="when-can-translations-of-productrelated-information-be-managed"></a>Når kan oversettelser av productrelated informasjonen behandles?
