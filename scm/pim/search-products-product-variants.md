...
Noen ganger å ha for mye av noe er ikke den beste situasjonen i, og dette er spesielt viktig hvis du selger en rekke produkter som er like, og du prøver å huske varenumre eller navn på søk for å finne det riktige produktet til å sette i en ordre. Du kan bruke den **varenummer** på en salgsordrelinje, eller en bestillingslinje som et søkefelt. Du kan angi en del av et produktnavn, tall eller dimensjon og få et oppslag som viser alle elementene som samsvarer med søkeordet.
...
Følgende eksempler bruker produkter og produktvarianter som illustrerer hvordan søk skal håndteres i ulike scenarier. **Forutsetning:** Under **salg og markedsføring &gt;Setup &gt;Søk &gt;søkeparametere**&gt;**søke type**, velger du **fullstendig samsvar** alternativet.
...
Du kan begrense antallet søkeresultater ved hjelp av den **antall resultater** på den **salg og markedsføring &gt;Setup &gt;Søk &gt;søkeparametere** siden. Hvis du setter dette feltet til 0, returneres alle søkeresultatene. Hvis du setter det til 10, returneres det for eksempel maksimalt 10 søkeresultater.
...
Gå til **salg og markedsføring &gt;Setup &gt;Søk &gt;søkevilkår** siden. På siden **Søkekriterier** kan du definere kriterier for kunde, kundeemne og produktsøk. Sørg for at du filtrerer siden ved å bruke produktsøkekriterier. Du kan gjøre dette ved å bytte til **Produkt** på menyen på siden.  

For å legge til Vis produktnummeret søkekriteriene, klikker du **ny** på side-menyen. Dette legger til en ny post i den **søkevilkår** rutenett. Åpne kolonneoppslaget **Feltnavn** og velg **Visningsproduktnummer**. Hvis du vil legge til produktkonfigurasjon søkekriteriene, kan du opprette en ny post i den ** søkevilkår ** rutenett og velger **configId** i den **feltnavn** kolonnen. På samme måte kan du opprette en post med **InventColorId** i **Feltnavn** for fargedimensjonen, **InventSizeId** for størrelsesdimensjonen og **InventStyleId** for stildimensjonen.
...
På siden **Søkekriterier** klikker du knappen **Oppdater søkedata**. I dialogboksen **Oppdater søkedata** kontrollerer du at **Kilde** er satt til **Produkt** og klikker deretter **OK**. Systemet vil samle i én tabell alle de merkede søkevilkårene angitt i trinn 1. Hvis du har mange produkter og produktvarianter, denne operasjonen kan ta ganske lang, og du kan få en advarsel. Det anbefales at du planlegger utfylling av søketabellen på den satsvise serveren på et tidspunkt da serveren ikke er for opptatt.  
...
Du kan aktivere denne funksjonaliteten ved å gå til **salg og markedsføring &gt;oppsett &gt;Søk &gt;søkeparametere** og **Aktiver oppslag for Søk** til **Ja** på den **Generelt** kategorien.  
