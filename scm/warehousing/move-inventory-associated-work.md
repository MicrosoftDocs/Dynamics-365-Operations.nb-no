...
### <a name="set-up-the-permission-to-move-reserved-inventory-for-individual-workers"></a>Definere tillatelse til å flytte reservert beholdning for individuelle arbeidere
