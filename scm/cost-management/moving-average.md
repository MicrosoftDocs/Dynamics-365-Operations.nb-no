...
1.  På siden **Varemodellgrupper** kan du definere en varemodellgruppe som har glidende gjennomsnitt valgt i feltet **Lagermodell**.
    | **Obs! **                                                                                                                                |
    |-----------------------------------------------------------------------------------------------------------------------------------------|
    | Som standard når det er merket av for glidende gjennomsnitt, velges også feltet **Poster aktuell beholdning** og **Poster økonomisk lager**. |

2.  På **Postering**-siden kan du tilordne kontoer til kontoen **Prisdifferanse for glidende gjennomsnitt** og **Revaluering av kostnad for glidende gjennomsnitt** i kategorien **Lager**. Du bruker kontoen **Prisdifferanse for glidende gjennomsnitt** når en kostnad må utgiftsføres proporsjonalt. Dette skjer på grunn av en forskjell i kostnad mellom et kjøpsmottak og innkjøpsfakturaen og på grunn av en forskjell mellom det opprinnelige lagerantallet og den gjeldende beholdningsantallet. Bruk kontoen **Revaluering av kostnad for glidende gjennomsnitt** når du vil justere den glidende gjennomsnittskostnaden for et produkt til en ny enhetspris.
3.  På **Frigitte produkter**-siden kan du tilordne varemodellgruppen for glidende gjennomsnitt til produktet.
...
| **Obs! **                                                                      |
|-------------------------------------------------------------------------------|
| Konvertering fra standard kost til glidende avveid gjennomsnitt er en manuell prosess. |
...
Produktkostnaden bestemmes av kjøpsmottaket med glidende gjennomsnitt. Når innkjøpsfakturaen posteres, hvis det er en forskjell i kostnad mellom kjøpsmottaket og innkjøpsfakturaen, justeres forskjellen proporsjonalt for de gjeldende produktene på lager, og eventuelle gjenstående beløp utgiftsføres. I dette eksemplet opprettes og mottas en bestilling med én kostnad, og innkjøpsfakturaen posteres med en annen kostnad.
