...
Den gjeldende versjonen bruker det samme prinsippet for direkte utligning som ble brukt for avveid gjennomsnitt i tidligere versjoner. Systemet bruker direkte utligning mellom mottak og avganger. Systemet bruker dette prinsippet for direkte utligning i bestemte situasjoner:
...
I det følgende scenariet er økonomisk oppdaterte avganger og tilganger postert. Under lagerlukkingen systemet utligner tilganger direkte mot problemet, og Ingen justering til kostprisen som er nødvendig på problemet. Illustrasjonen nedenfor viser disse transaksjonene:
...
![Direkte utligning med dato for avveid gjennomsnitt når alternativet Ta med fysisk verdi ikke brukes](./media/weightedaveragedatedirectsettlementwithoutincludephysicalvalue.gif) **Nøkkel til illustrasjonen:**
...
-   Over eller under hver loddrett pil, verdien for lagertransaksjonen er angitt i skjemaet *antallet*@*salgspris*.
...
Systemet vil bruke direkte utligning for dag 1. **Dag 2:**
...
Systemet vil bruke direkte utligning for dag 2. **Dag 3:**
...
Systemet genererer og bokfører den summerte lageroverføringstransaksjonen. I tillegg utligner systemet alle tilganger for dagen og lagerbeholdning på tidligere dager mot den summerte lageroverføringstransaksjonen for problemet. Alle avganger for dagen utlignes mot den summerte tilgangstransaksjonen for lageroverføring. Det avveide gjennomsnittet av kostprisen beregnes til USD 16,00. Avgangen justeres med USD 1,00 for å justere den til det avveide gjennomsnittet av kostprisen. Det nye glidende gjennomsnittet av kostprisen er USD 16,00. Illustrasjonen nedenfor viser denne serien av transaksjoner og virkningen av å bruke lagermodellen for avveid gjennomsnitt og prinsippet for summert utligning, men uten å bruke alternativet **Ta med fysisk verdi**. ![Summert utligning med dato for avveid gjennomsnitt når alternativet Ta med fysisk verdi ikke brukes](./media/weightedaveragedatesummarizedsettlementwithoutincludephysicalvalue.gif) **Nøkkel til illustrasjonen:**
...
Den gjeldende versjonen bruker det samme prinsippet for direkte utligning for avveid gjennomsnitt dato som brukes i tidligere versjoner. Systemet bruker direkte utligning mellom mottak og avganger. Systemet bruker dette prinsippet for direkte utligning i bestemte situasjoner:

-   Når én tilgang og én eller flere avganger er postert i perioden.
-   Når bare avganger er postert i perioden, og beholdningen inneholder en lagerbeholdning fra en tidligere lagerlukking.

Hvis du velger den **ta med fysisk verdi** merket for et element på den **varemodellgruppe** siden, bruker systemet fysisk oppdaterte tilganger når den estimerte kostprisen, eller glidende gjennomsnitt beregnes. Avganger posteres på grunnlag av denne estimerte kostprisen for perioden. Under lagerlukkingen tas det bare hensyn til økonomisk oppdaterte tilganger når avveid gjennomsnitt beregnes.
...
Det nye glidende gjennomsnittet av kostprisen gjenspeiler gjennomsnittet av de økonomisk og fysisk oppdaterte transaksjonene med USD 27,50. Diagrammet nedenfor viser denne serien av transaksjoner og virkningen av å bruke lagermodellen med dato for avveid gjennomsnitt og merking. ![Dato for avveid gjennomsnitt med merking](./media/weightedaveragedatewithmarking.gif) **Nøkkel til illustrasjonen:**
