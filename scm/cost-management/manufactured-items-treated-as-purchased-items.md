---
title: Definer varer som kan produseres eller fremskaffet
description: "Produkter som kan være kilde på forskjellige måter – de kan produseres (produsert) eller fremskaffet (kjøpt). Denne artikkelen beskriver noen vanlige poeng som må vurderes når du konfigurerer produkter som støtter flere leverandører."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>Definer varer som kan produseres eller fremskaffet

Produkter som kan være kilde på forskjellige måter – de kan produseres (produsert) eller fremskaffet (kjøpt). Denne artikkelen beskriver noen vanlige poeng som må vurderes når du konfigurerer produkter som støtter flere leverandører. 
