...
Operasjonsressurser som har samme funksjoner, kan tilordnes en prioritet. Hvis flere ressurser har funksjoner som tilfredsstiller kravene til planlegging på det nødvendige nivået, og har ledig kapasitet, kan deretter planleggingsmotoren velger blant ressursene. Hvis **prioritet** er valgt i den **primærressurs** på den **planleggingsparametere** side, ressurs som har høyest prioritet (den laveste numeriske verdien i den **prioritet** felt) er valgt første under planlegging.
...
-   Opprett to separate funksjoner: lav hastighet drilling og høy hastighet drilling. Definer lav hastighet drilling som drilling som har en behandlingstid på én til ni enheter per time. Definer høy hastighet drilling som drilling som har en drillingsbehandlingstid på 10 til 19 enheter per time. Deretter tilordne M1 maskinen Low-speed drilling muligheten, og tilordne M2-maskin den høyhastighets drilling funksjonen. Til slutt, endre muligheten ressursbehov på ruten til høyhastighets boring. Planleggingsmotoren velger deretter den riktige maskinen (M2).
-   Bruk funksjonsnivået til å kvalifisere Drilling funksjonen som tilordnes til drilling maskiner. Angi at maskinen M1 har Drilling-funksjonen på et nivå av 2.0, og at M2 maskinen har Drilling-funksjonen på et nivå av 11.0. Angi deretter at 10.0 er minste tillatelsesnivå som kreves for funksjonen Drilling behov på ruten. Planleggingsmotoren fastslår deretter at bare M2 maskinen oppfyller ressursbehovene.

## <a name="competencies-for-human-resources"></a>Kompetanser for Personale
Når du har operasjonsressurser av typen **Personale** som er knyttet til arbeidere i Personale, du kan også dra nytte av kompetansetypene for arbeidere når du definerer hvilke ressurser som kreves for en produksjonsrute. Med andre ord, kan du også angi krav for en bestemte ferdigheter, kurs, sertifikater eller titler. Planleggingsmotoren kan deretter velge ressurser som er knyttet til arbeidere, og valget vil baseres på kompetansetypene for disse arbeiderne. Kompetansetypene defineres i Personale, ikke på siden **Ressursfunksjoner**. Når du definerer ferdigheter, kurs, sertifikater eller titler som ressurskrav, må du bruke Personale-funksjonaliteten og kobler hver ressurs av den **Personale** type til en tilsvarende arbeider. Hvis du ikke bruker Personale-funksjonaliteten, kan du definere muligheter på den **ressursfunksjoner** side som ligner på eller duplisere kompetanse fra personaladministrasjonen. Siden **Ressursfunksjoner** inneholder imidlertid ikke funksjonaliteten som kreves for å opprettholde ferdigheter, kurs, sertifisering eller titler.
