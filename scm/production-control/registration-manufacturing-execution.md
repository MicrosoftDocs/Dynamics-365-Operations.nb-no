...
description: "Dette emnet beskriver viktige begreper og termer du må forstå for å kunne konfigurere og bruke kjøring av produksjonen."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Dette emnet beskriver viktige begreper og termer du må forstå for å kunne konfigurere og bruke kjøring av produksjonen. 

Produksjonsutførelse er tiltenkt brukt hovedsakelig av produksjonsselskaper. Arbeidere kan registrere tids- og vareforbruk for produksjonsjobber ved hjelp av **Jobbregistrering**-siden. Alle registreringer er godkjent, og senere overføres til relevante moduler. Fortløpende godkjenning og overføring av registreringer lar ledere enkelt spore faktiske kostnader på produksjonsordrer.
...
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Produksjonsutførelse       | En funksjon som brukes til å registrere tid, materialforbruk, kostnadene på produksjonsjobber, prosjekter og indirekte aktiviteter. Registrering utføres i en registreringsklient for produksjonsutførelse.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   **Registrere prosjektgebyrer og Prosjektvarer** (tilgjengelig med tid og fremmøte) – ansatte kan registrere prosjektgebyrer (utgifter) som er knyttet til et prosjekt i en prosjektgebyrjournal, for eksempel kjøregodtgjørelse eller bro avgift. Arbeidere kan også registrere vareforbruk på prosjekter. Dette gjøres i en prosjektvarejournal.
