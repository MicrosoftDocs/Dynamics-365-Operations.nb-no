...
<li>Når prinsippet er satt til <strong>valgte/aktive eller utvalgte</strong>, kan du velge en Stykkliste eller ruteversjon ved å klikke <strong>BOM</strong>&gt;<strong>stykklisteversjoner</strong> eller <strong>Route</strong>&gt;<strong>ruteversjoner</strong>.</li>
</ul></td>
</tr>
<tr class="even">
<td>Versjonsdato</td>
...
Når du bruker stykklisteutformingen for å se gjennom eller redigere stykklister som består av én eller flere nivåer av fantomer, vil ruten som er knyttet til den øverste varen vanligvis strekke seg over hele stykklistehierarkiet. For å forenkle oversikten, kan du låse den øverste ruten i visningen ved å klikke **Vis**&gt;**Lås rute**. Hvis du vil låse opp ruten, klikker du **Vis**&gt;**Unlock rute**.

## <a name="adding-and-editing-boms-and-bom-lines"></a>Legge til og redigere stykklister og stykklistelinjer
Bruk den ** stykklistelinjer ** eller **BOM** funksjoner til å endre stykklistelinjer eller Stykkliste. Når du velger en node i treet, bestemmer nodetypen funksjonene som er tilgjengelige.
...
| Stykklistelinjer &gt;slette               | Slett en stykklistelinje fra den valgte stykklisten.                                                                  | Denne funksjonen er tilgjengelig når det velges en node for stykklistelinje og stykklisten ikke er låst for redigering.                                                                                                                                                                                             |
...
| Stykklistelinjer &gt;legge til komponenten Stykkliste | Åpne en dialogboks der du kan velge en produktvariant ha på slutten av den valgte stykklisten.       | Denne funksjonen er tilgjengelig når noden som er valgt, har en valgt stykkliste. Hvis denne funksjonen ikke er tilgjengelig, kan det hende en stykklisteversjon mangler for den valgte varevarianten. I dette tilfellet kan du klikke **BOM**&gt;**opprette versjon** til å opprette de manglende versjonen for den valgte noden. |
...
| Stykkliste &gt;sjekk                      | Valider og kontroller den valgte stykklisten.                                                                      | Denne funksjonen er tilgjengelig når noden som er valgt, er knyttet til en stykklisteversjon.                                                                                                                                                                                                         |
