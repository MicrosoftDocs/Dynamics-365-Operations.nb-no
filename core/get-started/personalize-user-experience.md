...
description: Denne artikkelen forklarer hvordan du kan tilpasse Microsoft Dynamics 365 for operasjoner.
author: RobinARH
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Denne artikkelen forklarer hvordan du kan tilpasse Microsoft Dynamics 365 for operasjoner.

Det finnes mange typer tilpasninger i Microsoft Dynamics 365 for operasjoner. Noen tilpasninger er valgene du gjør i en liste over alternativer på en konfigurasjonsside. Noen personlige tilpasninger som er implisitt, for eksempel Dynamics 365 for operasjoner holder oversikt over bredden på rutenettkolonnene Hvis du justerer dem, og for vist/skjult tilstand av hurtigfaner. Andre tilpasninger er eksplisitt. For eksplisitte tilpasninger, angir du en interaktiv tilpassingsmodus og endrer utseendet på en side ved å direkte styre hvordan elementer vises eller fungerer på siden. 

Alle personlige innstillinger, av en hvilken som helst type, som en bruker gjør i Dynamics 365 for operasjoner er for denne brukeren, uansett firmaet som brukeren samhandler med. Endringer som en bruker gjør på en side, påvirker ikke andre brukere i systemet.

## <a name="systemwide-options-for-the-current-user"></a>Systemomfattende alternativene for gjeldende bruker
...
-   **Innstillinger:** Her kan du velge standardinnstillingene for hver gang du åpner Dynamics 365 for operasjoner, blant annet firma, startside og Vis/Rediger standardmodus (som avgjør om en side er låst for visning eller åpnet for redigering hver gang du åpner den). Du finner også alternativer for språk, tidssone og dato, klokkeslett og nummerformat. Til slutt inneholder denne siden en rekke diverse innstillinger som vil være forskjellig fra versjon til versjon.
...
**Rutenettkolonner:** Du kan justere bredden på en kolonne i en liste ved å velge størrelseslinjen til venstre eller høyre for kolonneoverskriften og dra den til venstre eller høyre til ønsket bredde. Dynamics 365 for operasjoner lagrer bredden som du ønsker og Vis kolonnen med denne bredden beholdes hver gang du åpner siden med listen. 

**Hurtigfaner:** noen sider har utvidbare deler kalt hurtigfaner. Dynamics 365 for operasjoner lagrer hvilke hurtigfaner du har utvidet, og hvilke hurtigfaner du har skjult. Hver gang du går tilbake til siden, blir de samme hurtigfanene vist eller skjult basert på siste gang de er brukt. Vi skal forklare hvordan du endrer rekkefølgen på hurtigfane inndelingene dine i denne artikkelen. I noen tilfeller kan kan skjule en hurtigfane forbedre ytelsen fordi Dynamics 365 for operasjoner, ikke trenger å hente informasjon for denne hurtigfanen før hurtigfanen er utvidet. 

**Faktabokser:** noen sider har en del kalt en faktaboksrute. Denne ruten inneholder skrivebeskyttet informasjon knyttet til gjeldende emne på siden. Hver del i faktaboksruten, kalles en faktaboks. Du kan vise eller skjule en boks for faktum og Dynamics 365 for operasjoner vil lagre dine preferanser. I noen tilfeller kan kan skjule en boks for faktum forbedre ytelsen fordi Dynamics 365 for operasjoner, ikke trenger å hente informasjon for faktum boksen til boksen faktum er utvidet.
...
[![Tilpasse et Elements egenskaper](./media/personalization-element-properties.jpg)](./media/personalization-element-properties.jpg) 
...
[![Tilpassing av verktøylinje](./media/personalization-personalizationtoolbar.jpg)](./media/personalization-personalizationtoolbar.jpg)

Tilpassing av verktøylinjen har en rekke tilpassede handlinger. Velg **Velg**-verktøyet når du vil merke og endre egenskapene for mange elementer, ett om gangen. Først klikker du markeringsverktøyet, og klikk deretter elementet du vil endre egenskapene for. Når du velger et element, åpnes vinduet for elementets egenskaper, og du kan endre egenskapene for det elementet. Du kan gjenta prosessen for andre elementer i skjemaet som kan tilpasses. I noen tilfeller vil du merke et element og ser at noen av egenskapene ikke kan endres. Dette betyr at basert på måten det gjeldende elementet brukes, Dynamics 365 for operasjoner kan ikke lar deg ikke endre denne egenskapen. Du kan for eksempel ikke skjule et felt som er nødvendig. 

Velg **flytte**-verktøyet når du vil merke og flytte et element til et annet sted i gjeldende gruppe med elementer. (Du kan ikke flytte et element utenfor den overordnede gruppen). Først klikker du flytteverktøyet, og deretter klikker du elementet du vil flytte. Når du klikker elementet som du vil flytte, skanner Dynamics 365 for operasjoner-skjemaet for å forstå hvor dette elementet kan flyttes og opprette en serie med "drop zones" som vises som en farget, fet linje ved siden av området hvor elementet kan bli fjernet når du drar elementet rundt i gjeldende gruppe. 

Velg **Skjul**-verktøyet for å velge og skjule et element. Hvis du vil skjule et element, velger du bare Skjul-verktøyet og klikker elementet du vil skjule. Når du velger verktøyet Skjul, gjøres alle gjeldende skjulte elementer synlig og vises i en nedtonet container slik at du kan velge elementet for å vise det. Velg markeringsverktøyet for å se hvordan siden vil se ut med de valgte elementene skjult. Velg **sammendrag**-verktøyet når du vil vise et numerisk felt eller et strengfelt i sammendragsområdet for hurtigkategorien. Verktøyet Sammendrag gjelder bare for feltene som finnes i en inndeling i hurtigfanen. Når du velger verktøyet sammendrag, vises alle feltene som er valgt som sammendragsfelt ved å plassere dem i en skyggelagt beholder Dynamics 365 for operasjoner. Interaktivt kan du legge til og fjerne felt fra en hurtigfane for sammendrag ved å klikke feltet. 

Velg den **Hopp over** verktøy for å fjerne et element fra sidens tastatursekvens-kategorien. Når du velger verktøyet Skip, alle elementer som er hoppet over, som skal vises i en skyggelagt beholder slik at du kan velge dem på nytt for å gjøre dem en del av kategorien sekvensen ved å velge et element som er hoppet over. 
...
Velg den **behandle** for å se en liste over alternativer for fargehåndtering relatert til alle tilpasninger for den gjeldende siden. 
