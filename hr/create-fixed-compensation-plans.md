...
# Opprette faste kompensasjonsplaner
...
## Komponenter i fast kompensasjon
...
## Fast kompensasjonsregistrering
<a id="fixed-compensation-enrollment" class="xliff"></a>
### Avgjøre hvem som har rett til planen
...
### Definere handlinger for fast kompensasjon
